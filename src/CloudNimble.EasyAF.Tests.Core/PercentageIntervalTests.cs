...
namespace CloudNimble.EasyAF.Tests.Core
{
    ...
    [TestClass]
    public class PercentageIntervalTests
    {
        ...
        public void Constructor_WithValueAndType_ShouldInitializeProperties()
        {
            ...
            var interval = new PercentageInterval<int>(value, type);
        ...
        [TestMethod]
        public void Constructor_WithRateValueAndType_ShouldInitializeAllProperties()
        {
            var rate = 0.05m;
            var value = 12;
            var type = IntervalType.Months;

            var interval = new PercentageInterval<int>(rate, value, type);

            interval.Value.Should().Be(value);
            interval.Type.Should().Be(type);
            interval.Rate.Should().Be(rate);
        }

        #endregion

        #region RatePerMinute Tests
        ...
        public void RatePerMinute_ShouldReturnCorrectValue(double intervalValue, IntervalType intervalType, double expected)
        {
            var interval = new PercentageInterval<double>(1.0m, intervalValue, intervalType);

            var result = interval.RatePerMinute();
        ...
        public void RatePerHour_ShouldReturnCorrectValue(double intervalValue, IntervalType intervalType, double expected)
        {
            var interval = new PercentageInterval<double>(1.0m, intervalValue, intervalType);

            var result = interval.RatePerHour();
        ...
        public void RatePerDay_ShouldReturnCorrectValue(double intervalValue, IntervalType intervalType, double expected)
        {
            var interval = new PercentageInterval<double>(1.0m, intervalValue, intervalType);

            var result = interval.RatePerDay();
        ...
        [DataRow(4D, IntervalType.Months, 0.92054795D)]
        ...
        public void RatePerWeek_ShouldReturnCorrectValue(double intervalValue, IntervalType intervalType, double expected)
        {
            var interval = new PercentageInterval<double>(1.0m, intervalValue, intervalType);

            var result = interval.RatePerWeek();
        ...
        public void RatePerMonth_ShouldReturnCorrectValue(double intervalValue, IntervalType intervalType, double expected)
        {
            var interval = new PercentageInterval<double>(1.0m, intervalValue, intervalType);

            var result = interval.RatePerMonth();
        ...
        public void RatePerYear_ShouldReturnCorrectValue(double intervalValue, IntervalType intervalType, double expected)
        {
            var interval = new PercentageInterval<double>(1.0m, intervalValue, intervalType);

            var result = interval.RatePerYear();
        ...
        public void ToString_WithCustomValues_ShouldReturnFormattedString()
        {
            var interval = new PercentageInterval<int>();
            interval.Value = 3;
            interval.Type = IntervalType.Months;
            interval.ToString().Should().Be("3 Months");
        }
        ...
        public void ToString_WithSingularValue_ShouldReturnSingularForm()
        {
            ...
            interval.Value = 1;
            interval.Type = IntervalType.Months;
            interval.ToString().Should().Be("1 Month");
        }

        [TestMethod]
        public void ToString_WithDecimalValue_ShouldFormatCorrectly()
        {
            var interval = new PercentageInterval<int>(0.05m, 12, IntervalType.Months);

            interval.ToString().Should().Be("12 Months");
        }
