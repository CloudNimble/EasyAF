...
namespace CloudNimble.EasyAF.Tests.Core
{
    ...
    [TestClass]
    public class MoneyIntervalTests
    {
        ...
        //[DataRow(2D,    IntervalType.Days,      0.08333333)]
        ...
        //[DataRow(2D,    IntervalType.Weeks,     0.01190476)]
        ...
        [DataRow(1000, 1D,    IntervalType.Months,    12000D)]
        [DataRow(1000, 1.5D,  IntervalType.Months,    8000D)]
        [DataRow(1000, 2D,    IntervalType.Months,    6000D)]
        [DataRow(1000, 3D,    IntervalType.Months,    4000D)]
        [DataRow(1000, 4D,    IntervalType.Months,    3000D)]
        ...
        public void PerYearTests(double money, double input, IntervalType intervalType, double output)
        {
            var interval = new MoneyInterval<decimal>(Convert.ToDecimal(money), Convert.ToDecimal(input), intervalType);
        ...
        [TestMethod]
        [DataRow(1000,  1D,    IntervalType.Minutes,   "$1,000.00 / 1 minute")]
        [DataRow(1000,  1.5D,  IntervalType.Minutes,   "$1,000.00 / 1.5 minutes")]
        [DataRow(1000,  2D,    IntervalType.Minutes,   "$1,000.00 / 2 minutes")]
        [DataRow(1000,  3D,    IntervalType.Minutes,   "$1,000.00 / 3 minutes")]
        [DataRow(1000,  4D,    IntervalType.Minutes,   "$1,000.00 / 4 minutes")]

        [DataRow(1000,  1D,    IntervalType.Hours,     "$1,000.00 / 1 hour")]
        [DataRow(1000,  1.5D,  IntervalType.Hours,     "$1,000.00 / 1.5 hours")]
        [DataRow(1000,  2D,    IntervalType.Hours,     "$1,000.00 / 2 hours")]
        [DataRow(1000,  3D,    IntervalType.Hours,     "$1,000.00 / 3 hours")]
        [DataRow(1000,  4D,    IntervalType.Hours,     "$1,000.00 / 4 hours")]

        [DataRow(1000,  1D,    IntervalType.Days,      "$1,000.00 / 1 day")]
        [DataRow(1000,  1.5D,  IntervalType.Days,      "$1,000.00 / 1.5 days")]
        [DataRow(1000,  2D,    IntervalType.Days,      "$1,000.00 / 2 days")]
        [DataRow(1000,  3D,    IntervalType.Days,      "$1,000.00 / 3 days")]
        [DataRow(1000,  4D,    IntervalType.Days,      "$1,000.00 / 4 days")]

        [DataRow(1000,  1D,    IntervalType.Weeks,     "$1,000.00 / 1 week")]
        [DataRow(1000,  1.5D,  IntervalType.Weeks,     "$1,000.00 / 1.5 weeks")]
        [DataRow(1000,  2D,    IntervalType.Weeks,     "$1,000.00 / 2 weeks")]
        [DataRow(1000,  3D,    IntervalType.Weeks,     "$1,000.00 / 3 weeks")]
        [DataRow(1000,  4D,    IntervalType.Weeks,     "$1,000.00 / 4 weeks")]

        [DataRow(1000,  1D,    IntervalType.Months,    "$1,000.00 / 1 month")]
        [DataRow(1000,  1.5D,  IntervalType.Months,    "$1,000.00 / 1.5 months")]
        [DataRow(1000,  2D,    IntervalType.Months,    "$1,000.00 / 2 months")]
        [DataRow(1000,  3D,    IntervalType.Months,    "$1,000.00 / 3 months")]
        [DataRow(1000,  4D,    IntervalType.Months,    "$1,000.00 / 4 months")]

        [DataRow(1000,  1D,    IntervalType.Years,     "$1,000.00 / 1 year")]
        [DataRow(1000,  1.5D,  IntervalType.Years,     "$1,000.00 / 1.5 years")]
        [DataRow(1000,  2D,    IntervalType.Years,     "$1,000.00 / 2 years")]
        [DataRow(1000,  3D,    IntervalType.Years,     "$1,000.00 / 3 years")]
        [DataRow(1000,  4D,    IntervalType.Years,     "$1,000.00 / 4 years")]
        public void ToString_CurrencyDefault(double money, double input, IntervalType intervalType, string output)
        {
            var interval = new MoneyInterval<decimal>(Convert.ToDecimal(money), Convert.ToDecimal(input), intervalType);
            interval.ToString().Should().BeEquivalentTo(output);
        }

        [TestMethod]
        [DataRow(1000,  1D,    IntervalType.Minutes,   "$1,000 / 1 minute")]
        [DataRow(1000,  1.5D,  IntervalType.Minutes,   "$1,000 / 1.5 minutes")]
        [DataRow(1000,  2D,    IntervalType.Minutes,   "$1,000 / 2 minutes")]
        [DataRow(1000,  3D,    IntervalType.Minutes,   "$1,000 / 3 minutes")]
        [DataRow(1000,  4D,    IntervalType.Minutes,   "$1,000 / 4 minutes")]

        [DataRow(1000,  1D,    IntervalType.Hours,     "$1,000 / 1 hour")]
        [DataRow(1000,  1.5D,  IntervalType.Hours,     "$1,000 / 1.5 hours")]
        [DataRow(1000,  2D,    IntervalType.Hours,     "$1,000 / 2 hours")]
        [DataRow(1000,  3D,    IntervalType.Hours,     "$1,000 / 3 hours")]
        [DataRow(1000,  4D,    IntervalType.Hours,     "$1,000 / 4 hours")]

        [DataRow(1000,  1D,    IntervalType.Days,      "$1,000 / 1 day")]
        [DataRow(1000,  1.5D,  IntervalType.Days,      "$1,000 / 1.5 days")]
        [DataRow(1000,  2D,    IntervalType.Days,      "$1,000 / 2 days")]
        [DataRow(1000,  3D,    IntervalType.Days,      "$1,000 / 3 days")]
        [DataRow(1000,  4D,    IntervalType.Days,      "$1,000 / 4 days")]

        [DataRow(1000,  1D,    IntervalType.Weeks,     "$1,000 / 1 week")]
        [DataRow(1000,  1.5D,  IntervalType.Weeks,     "$1,000 / 1.5 weeks")]
        [DataRow(1000,  2D,    IntervalType.Weeks,     "$1,000 / 2 weeks")]
        [DataRow(1000,  3D,    IntervalType.Weeks,     "$1,000 / 3 weeks")]
        [DataRow(1000,  4D,    IntervalType.Weeks,     "$1,000 / 4 weeks")]

        [DataRow(1000,  1D,    IntervalType.Months,    "$1,000 / 1 month")]
        [DataRow(1000,  1.5D,  IntervalType.Months,    "$1,000 / 1.5 months")]
        [DataRow(1000,  2D,    IntervalType.Months,    "$1,000 / 2 months")]
        [DataRow(1000,  3D,    IntervalType.Months,    "$1,000 / 3 months")]
        [DataRow(1000,  4D,    IntervalType.Months,    "$1,000 / 4 months")]

        [DataRow(1000,  1D,    IntervalType.Years,     "$1,000 / 1 year")]
        [DataRow(1000,  1.5D,  IntervalType.Years,     "$1,000 / 1.5 years")]
        [DataRow(1000,  2D,    IntervalType.Years,     "$1,000 / 2 years")]
        [DataRow(1000,  3D,    IntervalType.Years,     "$1,000 / 3 years")]
        [DataRow(1000,  4D,    IntervalType.Years,     "$1,000 / 4 years")]
        public void ToString_NoDecimals(double money, double input, IntervalType intervalType, string output)
        {
            var interval = new MoneyInterval<decimal>(Convert.ToDecimal(money), Convert.ToDecimal(input), intervalType);
            interval.ToString(0).Should().BeEquivalentTo(output);
        }
