...
namespace CloudNimble.EasyAF.Tests.Core
{
    ...
    public class IntervalTests
    {
        ...
        [TestMethod]
        [DataRow(1D,    IntervalType.Minutes,   "1 minute")]
        [DataRow(1.5D,  IntervalType.Minutes,   "1.5 minutes")]
        [DataRow(2D,    IntervalType.Minutes,   "2 minutes")]
        [DataRow(3D,    IntervalType.Minutes,   "3 minutes")]
        [DataRow(4D,    IntervalType.Minutes,   "4 minutes")]

        [DataRow(1D,    IntervalType.Hours,     "1 hour")]
        [DataRow(1.5D,  IntervalType.Hours,     "1.5 hours")]
        [DataRow(2D,    IntervalType.Hours,     "2 hours")]
        [DataRow(3D,    IntervalType.Hours,     "3 hours")]
        [DataRow(4D,    IntervalType.Hours,     "4 hours")]

        [DataRow(1D,    IntervalType.Days,      "1 day")]
        [DataRow(1.5D,  IntervalType.Days,      "1.5 days")]
        [DataRow(2D,    IntervalType.Days,      "2 days")]
        [DataRow(3D,    IntervalType.Days,      "3 days")]
        [DataRow(4D,    IntervalType.Days,      "4 days")]

        [DataRow(1D,    IntervalType.Weeks,     "1 week")]
        [DataRow(1.5D,  IntervalType.Weeks,     "1.5 weeks")]
        [DataRow(2D,    IntervalType.Weeks,     "2 weeks")]
        [DataRow(3D,    IntervalType.Weeks,     "3 weeks")]
        [DataRow(4D,    IntervalType.Weeks,     "4 weeks")]

        [DataRow(1D,    IntervalType.Months,    "1 month")]
        [DataRow(1.5D,  IntervalType.Months,    "1.5 months")]
        [DataRow(2D,    IntervalType.Months,    "2 months")]
        [DataRow(3D,    IntervalType.Months,    "3 months")]
        [DataRow(4D,    IntervalType.Months,    "4 months")]

        [DataRow(1D,    IntervalType.Years,     "1 year")]
        [DataRow(1.5D,  IntervalType.Years,     "1.5 years")]
        [DataRow(2D,    IntervalType.Years,     "2 years")]
        [DataRow(3D,    IntervalType.Years,     "3 years")]
        [DataRow(4D,    IntervalType.Years,     "4 years")]
        public void ToStringTests(double input, IntervalType intervalType, string output)
        {
            var interval = new Interval<decimal>(Convert.ToDecimal(input), intervalType);
