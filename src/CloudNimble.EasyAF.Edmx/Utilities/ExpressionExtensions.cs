...
namespace System.Data.Entity.Utilities
{
    internal static class ExpressionExtensions
    {
            ...
            this LambdaExpression lambdaExpression, Func<Expression, Expression, PropertyPath> propertyMatcher)
        {
            ...
            Debug.Assert(lambdaExpression.Body is not null);
            ...
            return (propertyPath is not null) ? new[] { propertyPath } : null;
        }
            ...
            this Expression parameterExpression, Expression propertyAccessExpression)
        {
            ...
            return propertyPath is not null && propertyPath.Count == 1 ? propertyPath : null;
        }
        ...
        public static bool IsStringAddExpression(this Expression expression)
        {
            ...
            if (linq.Method is null || linq.NodeType != ExpressionType.Add)
            {
                return false;
            }
