...
#endif
{
    internal static class PropertyInfoExtensions
    {
        ...
        public static bool IsValidEdmNavigationProperty(this PropertyInfo propertyInfo)
        {
            ...
            return IsValidInterfaceStructuralProperty(propertyInfo)
                   && ((propertyInfo.PropertyType.IsCollection(out var elementType) && elementType.IsValidStructuralType())
        ...
        public static EdmProperty AsEdmPrimitiveProperty(this PropertyInfo propertyInfo)
        {
            ...
            if (propertyType.IsPrimitiveType(out var primitiveType))
            {
        ...
        public static bool CanWriteExtended(this PropertyInfo propertyInfo)
        {
            ...
            return declaredProperty is not null && declaredProperty.CanWrite;
        }
        ...
        {
            Debug.Assert(propertyInfo.DeclaringType is not null);
        ...
        private static void FindNextProperty(PropertyInfo property, IList<PropertyInfo> collection, bool getter)
        {
            ...
            if (method is not null)
            {
                ...
                if (nextType is not null && nextType != typeof(object))
                {
                    ...
                    var nextProperty =
                        (from p in nextType.GetInstanceProperties()
                         ...
                         where candidateMethod is not null && candidateMethod.GetBaseDefinition() == baseMethod
        ...
        public static bool IsPublic(this PropertyInfo property)
        {
            ...
            var getterAccess = getter is null ? MethodAttributes.Private : (getter.Attributes & MethodAttributes.MemberAccessMask);

            var setter = property.Setter();
            var setterAccess = setter is null ? MethodAttributes.Private : (setter.Attributes & MethodAttributes.MemberAccessMask);
