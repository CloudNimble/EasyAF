...
, IDbAsyncEnumerable<TResult>
#endif
    {
        ...
        public virtual DbQuery<TResult> Include(string path)
        {
            ...
            return _internalQuery is null ? this : new DbQuery<TResult>(_internalQuery.Include(path));
        }
        ...
        {
            return _internalQuery is null ? this : new DbQuery<TResult>(_internalQuery.AsNoTracking());
        }
        ...
        {
            return _internalQuery is null ? this : new DbQuery<TResult>(_internalQuery.AsStreaming());
        }
        ...
        {
            return _internalQuery is null ? this : new DbQuery<TResult>(_internalQuery.WithExecutionStrategy(executionStrategy));
        }
        ...
        IQueryProvider IQueryable.Provider
        {
            get
            {
                return _provider ??= new DbQueryProvider(
        ...
        {
            return _internalQuery is null ? base.ToString() : _internalQuery.ToTraceString();
        }
        ...
        {
            if (entry._internalQuery is null)
            {
