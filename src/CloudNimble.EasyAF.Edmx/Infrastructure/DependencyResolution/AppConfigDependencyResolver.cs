    ...
    internal class AppConfigDependencyResolver : IDbDependencyResolver
    {
        ...
        public IEnumerable<object> GetServices(Type type, object key)
        {
            return _servicesFactories.GetOrAdd(
                Tuple.Create(type, key),
                t => GetServicesFactory(type, key)).Select(f => f()).Where(s => s is not null).ToList();
        }
...
#pragma warning restore 612,618
        ...
        private void RegisterSqlServerProvider()
        {
            var providerTypeName = string.Format(
                    ...
                    "System.Data.Entity.SqlServer.SqlProviderServices, EasyAF.Edmx.SqlServer, Version={0}, Culture=neutral, PublicKeyToken=afc61983f100d280",
