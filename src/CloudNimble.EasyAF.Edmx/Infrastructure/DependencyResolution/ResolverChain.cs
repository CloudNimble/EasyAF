...
namespace System.Data.Entity.Infrastructure.DependencyResolution
{
    ...
    internal class ResolverChain : IDbDependencyResolver
    {
        ...
        private readonly ConcurrentStack<IDbDependencyResolver> _resolvers = new();
        private volatile IDbDependencyResolver[] _resolversSnapshot = [];
        ...
        {
            get { return Enumerable.Reverse(_resolversSnapshot); }
        }
