...
, IDbAsyncEnumerable<TElement>
#endif
    {
        ...
        {
            return _internalQuery is null ? this : new DbRawSqlQuery<TElement>(_internalQuery.AsStreaming());
        }
        ...
        {
            return _internalQuery is null ? base.ToString() : _internalQuery.ToString();
        }
