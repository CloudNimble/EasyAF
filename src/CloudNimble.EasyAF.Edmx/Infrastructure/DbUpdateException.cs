        ...
        public IEnumerable<DbEntityEntry> Entries
        {
            get
            {
                ...
                if (_state.InvolvesIndependentAssociations
                    || _internalContext is null
                    || innerAsUpdateException is null
                    || innerAsUpdateException.StateEntries is null)
                {
                    return Enumerable.Empty<DbEntityEntry>();
                }

                Debug.Assert(
                    !innerAsUpdateException.StateEntries.Any(e => e.Entity is null),
