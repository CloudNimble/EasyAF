...
namespace System.Data.Entity.Infrastructure
{
        ...
        where TEntity : class
    {
        ...
        {
            return InternalQuery is null ? this : new DbSqlQuery<TEntity>(InternalQuery.AsNoTracking());
        }
        ...
        {
            return InternalQuery is null ? this : new DbSqlQuery<TEntity>(InternalQuery.AsStreaming());
        }
