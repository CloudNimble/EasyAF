...
namespace System.Data.Entity.Infrastructure
{
    ...
    public class DbContextInfo
    {
        ...
        public DbContextInfo(Type contextType, Config config)
        ...
        /// <param name="config"> An object representing the config file. </param>
        /// <param name="connectionInfo"> Connection information for the database to be used. </param>
        public DbContextInfo(Type contextType, Config config, DbConnectionInfo connectionInfo)
            : this(
        ...
        /// A <see cref="DbProviderInfo" /> specifying the underlying ADO.NET provider to target.
        /// </param>
        public DbContextInfo(Type contextType, Config config, DbProviderInfo modelProviderInfo)
            : this(
        ...
        public virtual DbContext CreateInstance()
        {
            ...
            try
            {
                try
                {
                    context = _activator is null ? null : _activator();
                }
        ...
        internal void ConfigureContext(DbContext context)
        {
            ...
            if (_modelProviderInfo is not null)
            {
            ...
            else if (_modelProviderInfo is not null
                     && _appConfig == AppConfig.DefaultInstance)
            {
            ...
            if (_onModelCreating is not null)
            {
        ...
        private Func<DbContext> CreateActivator()
        {
            ...
            if (factoryType.GetPublicConstructor() is null)
            {
