...
namespace System.Data.Entity.Infrastructure.Interception
{
    ...
    {
        private readonly DbCommandTreeDispatcher _commandTreeDispatcher = new();
        private readonly DbCommandDispatcher _commandDispatcher = new();
        private readonly DbTransactionDispatcher _transactionDispatcher = new();
        private readonly DbConnectionDispatcher _dbConnectionDispatcher = new();
        private readonly DbConfigurationDispatcher _configurationDispatcher = new();

        private readonly CancelableEntityConnectionDispatcher _cancelableEntityConnectionDispatcher =
            new();

        private readonly CancelableDbCommandDispatcher _cancelableCommandDispatcher = new();
