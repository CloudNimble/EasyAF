...
namespace System.Data.Entity.Infrastructure
{
    ...
    public abstract class TransactionHandler : IDbTransactionInterceptor, IDbConnectionInterceptor, IDisposable
    {
        ...
        public ObjectContext ObjectContext
        {
            get
            {
                return _objectContext is not null && _objectContext.IsAlive
        ...
        public DbContext DbContext
        {
            get
            {
                return _dbContext is not null && _dbContext.IsAlive
        ...
        public DbConnection Connection
        {
            get
            {
                return _connection is not null && _connection.IsAlive
