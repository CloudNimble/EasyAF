...
namespace System.Data.Entity.Infrastructure
{
    ...
    {
        private readonly HashSet<TransactionRow> _rowsToDelete = [];
        ...
        protected override void Dispose(bool disposing)
        {
            if (!IsDisposed
                && disposing
                && TransactionContext is not null)
            {
        ...
        public override void BeganTransaction(DbConnection connection, BeginTransactionInterceptionContext interceptionContext)
        {
            if (TransactionContext is null
                ...
                || interceptionContext.Result is null)
            {
                return;
            }
        ...
        public override void Committed(DbTransaction transaction, DbTransactionInterceptionContext interceptionContext)
        {
            if (TransactionContext is null
                ...
                || !Transactions.TryGetValue(transaction, out var transactionRow))
            {
                return;
            }
            ...
            if (interceptionContext.Exception is not null)
            {
                ...
                if (existingTransactionRow is not null)
                {
