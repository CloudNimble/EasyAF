...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        private static ConcurrentDictionary<string, ProviderRegistration> _registeredFactories = new();
        ...
        public static DataTable GetFactoryClasses()
        {
            ...
            toReturn.Columns.AddRange([nameColumn, descriptionColumn, invariantNameColumn, assemblyQualifiedNameColumn]);
            toReturn.PrimaryKey = [invariantNameColumn];
        ...
        private static DbProviderFactory GetFactoryInstance(Type providerFactoryClass)
        {
            ...
            return factory is null ? throw ADP.InvalidOperation("SR.ADP_DbProviderFactories_NoInstance") : (DbProviderFactory)factory;
        }
