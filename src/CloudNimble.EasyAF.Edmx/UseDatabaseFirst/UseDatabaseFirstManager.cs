...
namespace EasyAF.Edmx
{
    ...
    internal static class UseDatabaseFirstManager
    {
        ...
        internal static void Execute(string modelName)
        {
            ...
            {
                // GET model element
                EntityDesignerUtils.ExtractConceptualMappingAndStorageNodes(reader, out var conceptualSchemaElement, out var mappingElement, out var storageSchemaElement, out var processingValue);
