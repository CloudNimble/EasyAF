...
namespace System.Data.Entity.Migrations.Design
{
    ...
    public class ToolingFacade : IDisposable
    {
        ...
        private readonly string _configurationFile = null;
        ...
        {
            if (disposing && _appDomain is not null)
            {
        ...
        private class ToolLogger : MigrationsLogger
        {
            ...
            {
                if (_facade.LogInfoDelegate is not null)
                {
            ...
            {
                if (_facade.LogWarningDelegate is not null)
                {
            ...
            {
                if (_facade.LogVerboseDelegate is not null)
                {
        ...
        private abstract class BaseRunner
        {
            ...
            {
                if (ConnectionStringInfo is not null)
                {
