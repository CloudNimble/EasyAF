...
namespace System.Data.Entity.Migrations.Design
{
    ...
    public abstract class MigrationCodeGenerator
    {
        ...
        protected virtual IEnumerable<string> GetNamespaces(IEnumerable<MigrationOperation> operations)
        {
            ...
            {
                namespaces = namespaces.Concat(["System.Data.Entity.Spatial"]);
            }

            if (AnnotationsExist(operationsArray))
            {
                namespaces = namespaces.Concat(["System.Collections.Generic", "System.Data.Entity.Infrastructure.Annotations"]);
                namespaces = AnnotationGenerators.Select(a => a.Value).Where(g => g is not null)
