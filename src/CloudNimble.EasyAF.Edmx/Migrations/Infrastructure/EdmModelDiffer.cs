...
namespace System.Data.Entity.Migrations.Infrastructure
{
    ...
    internal class EdmModelDiffer
    {
        ...
        private static readonly DynamicEqualityComparer<ForeignKeyOperation> _foreignKeyEqualityComparer
            = new((fk1, fk2) => fk1.Name.EqualsOrdinal(fk2.Name));
            ...
            string targetModelVersion = null)
        {
            ...
            var storageMappingItemCollection
                = sourceModel.GetStorageMappingItemCollection(out var providerInfo);
        ...
        private static bool FuzzyMatchEntities(EntityType entityType1, EntityType entityType2)
        {
            ...
            if ((entityType1.BaseType is not null && entityType2.BaseType is null)
                || (entityType1.BaseType is null && entityType2.BaseType is not null))
            {
        ...
        {
            if (sourceEntityTypeMapping.EntityType is not null
                && targetEntityTypeMapping.EntityType is not null)
            {
            ...
            else
            {
                ...
                if (sourceTypes.Contains(sourceEntityType))
                {
                    ...
                    {
                        var sourceTypeNames = sourceTypes.Except([sourceEntityType]).Select(et => et.Name);
                        var targetTypeNames = targetTypes.Except([targetEntityType]).Select(et => et.Name);
            ...
            return storeAssociationTypePairs
                .Concat(
                    ...
                    where (at1.Name.EqualsIgnoreCase(at2.Name)
                           || (at1.Constraint is not null
                               && at2.Constraint is not null
            ...
            where T : class
        {
            ...
            for (var i = 0; i < renameOperations.Count; i++)
            {
                ...
                if (dependentRename is not null)
                {
                ...
                (from esm1 in _source.EntityContainerMapping.EntitySetMappings
                 ...
                 select o)
                    .Concat(
                        ...
                        where asm1.ModificationFunctionMapping is not null
                        from asm2 in _target.EntityContainerMapping.AssociationSetMappings
                        where asm2.ModificationFunctionMapping is not null
            ...
            where TCommandTree : DbModificationCommandTree
        {
            ...
            if (modificationCommandTreeGenerator is not null)
            {
        ...
        private string GenerateFunctionBody<TCommandTree>(
            ...
            where TCommandTree : DbModificationCommandTree
        {
            if (migrationSqlGenerator is null)
            {
                return null;
            }
            ...
            ModelMetadata modelMetadata)
        {
            ...
            if (edmTypeUsage.Facets.TryGetValue(DbProviderManifest.MaxLengthFacetName, true, out var facet)
                && facet.Value is not null)
            {
        ...
        private IEnumerable<MigrationOperation> BuildChangePrimaryKeyOperations(Tuple<EntitySet, EntitySet> tablePair)
        {
            ...
            if (sourcePrimaryKeyIndexAttribute is not null)
            {
            ...
            if (targetPrimaryKeyIndexAttribute is not null)
            {
        ...
        private IEnumerable<ConsolidatedIndex> FindSourceIndexes(ICollection<Tuple<EntitySet, EntitySet>> tablePairs)
        {
            ...
            return
                ...
                let t = GetSchemaQualifiedName(p is not null ? p.Item2 : es)
        ...
        private static CreateTableOperation BuildCreateTableOperation(EntitySet entitySet, ModelMetadata modelMetadata)
        {
            ...
            if (primaryKeyIndexAttribute is not null)
            {
            ...
            IDictionary<string, AnnotationValues> annotations)
        {
            ...
            if (property.TypeUsage.Facets.TryGetValue(DbProviderManifest.MaxLengthFacetName, true, out var facet)
                && !facet.IsUnbounded
