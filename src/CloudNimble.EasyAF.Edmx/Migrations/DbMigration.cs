    ...
    public abstract class DbMigration : IDbMigration
    {
            ...
            object anonymousArguments = null)
        {
            ...
            AddForeignKey(
                ...
                [dependentColumn],
                principalTable,
                principalColumn is not null ? [principalColumn] : null,
                cascadeDelete,
                name,
                anonymousArguments);
        }
            ...
            object anonymousArguments = null)
        {
            ...
            if (principalColumns is not null)
            {
            ...
            object anonymousArguments = null)
        {
            ...
            AddPrimaryKey(table, [column], name, clustered, anonymousArguments);
        }
            ...
            object anonymousArguments = null)
        {
            ...
            CreateIndex(table, [column], unique, name, clustered, anonymousArguments);
        }
