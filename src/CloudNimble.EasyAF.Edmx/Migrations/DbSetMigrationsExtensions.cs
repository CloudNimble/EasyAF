...
namespace System.Data.Entity.Migrations
{
    ...
    public static class DbSetMigrationsExtensions
    {
            ...
            where TEntity : class
        {
            ...
            method.Invoke(set, [identifierExpression, entities]);
        }
            ...
            where TEntity : class
        {
            ...
            foreach (var entity in entities)
            {
                ...
                var existing
                    = set.SingleOrDefault(Expression.Lambda<Func<TEntity, bool>>(matchExpression, [parameter]));
