...
namespace System.Data.Entity.ModelConfiguration.Configuration
{
    ...
    public partial class ConventionsConfiguration
    {
        ...
        internal ConventionsConfiguration(ConventionSet conventionSet)
        {
            ...
            Debug.Assert(
                conventionSet.ConfigurationConventions.All(c => c is not null && ConventionsTypeFilter.IsConfigurationConvention(c.GetType())));
            Debug.Assert(
                conventionSet.ConceptualModelConventions.All(
                    c => c is not null && ConventionsTypeFilter.IsConceptualModelConvention(c.GetType())));
            Debug.Assert(
                conventionSet.ConceptualToStoreMappingConventions.All(
                    c => c is not null && ConventionsTypeFilter.IsConceptualToStoreMappingConvention(c.GetType())));
            Debug.Assert(
                conventionSet.StoreModelConventions.All(c => c is not null && ConventionsTypeFilter.IsStoreModelConvention(c.GetType())));
        ...
        public void Add(params IConvention[] conventions)
        {
            ...
            Debug.Assert(conventions.All(c => c is not null));
        ...
        internal void ApplyMapping(DbDatabaseMapping databaseMapping)
        {
            ...
            foreach (var convention in _conceptualToStoreMappingConventions)
            {
                ...
                if (mappingConvention is not null)
                {
        ...
        internal virtual void ApplyModelConfiguration(ModelConfiguration modelConfiguration)
        {
            ...
            for (var i = _configurationConventions.Count - 1; i >= 0; --i)
            {
                ...
                if (configurationConvention is not null)
                {
                ...
                if (lightweightConfigurationConvention is not null)
                {
        ...
        internal virtual void ApplyModelConfiguration(Type type, ModelConfiguration modelConfiguration)
        {
            ...
            for (var i = _configurationConventions.Count - 1; i >= 0; --i)
            {
                ...
                if (modelConfigurationConvention is not null)
                {
            ...
            where TStructuralTypeConfiguration : StructuralTypeConfiguration
        {
            ...
            for (var i = _configurationConventions.Count - 1; i >= 0; --i)
            {
                ...
                if (propertyTypeConfigurationConvention is not null)
                {
                ...
                if (structuralTypeConfigurationConvention is not null)
                {
        ...
        internal virtual void ApplyPropertyConfiguration(PropertyInfo propertyInfo, ModelConfiguration modelConfiguration)
        {
            ...
            for (var i = _configurationConventions.Count - 1; i >= 0; --i)
            {
                ...
                if (propertyConfigurationConvention is not null)
                {
