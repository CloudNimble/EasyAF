...
namespace System.Data.Entity.ModelConfiguration.Configuration.Types
{
    ...
    internal class EntityTypeConfiguration : StructuralTypeConfiguration
    {
        ...
        private readonly List<EntityMappingConfiguration> _nonCloneableMappings = [];
            ...
            : base(source)
        {
            ...
            if (source._modificationStoredProceduresConfiguration is not null)
            {
        ...
        {
            get { return _keyConfiguration is not null; }
        }
            ...
            ModificationStoredProceduresConfiguration modificationStoredProceduresConfiguration, bool allowOverride)
        {
            ...
            if (_modificationStoredProceduresConfiguration is null)
            {
        ...
        private void UpdateTableNameForSubTypes()
        {
            _entitySubTypesMappingConfigurations
                .Where(stmc => stmc.Value.TableName is null)
        ...
        internal void AddMappingConfiguration(EntityMappingConfiguration mappingConfiguration, bool cloneable = true)
        {
            ...
            if (tableName is not null)
            {
                ...
                if (existingMappingConfiguration is not null)
                {
            ...
            if (_entityMappingConfigurations.Count > 1
                && _entityMappingConfigurations.Any(mc => mc.TableName is null))
            {
                throw Error.InvalidTableMapping_NoTableName(ClrType.Name);
            }

            IsTableNameConfigured |= tableName is not null;
        ...
        internal NavigationPropertyConfiguration Navigation(PropertyInfo propertyInfo)
        {
            ...
            if (!_navigationPropertyConfigurations.TryGetValue(propertyInfo, out var navigationPropertyConfiguration))
            {
        ...
        private void ConfigureEntitySetName(EntityType entityType, EdmModel model)
        {
            ...
            Debug.Assert(entitySet is not null);

            entitySet.Name
                = model.GetEntitySets().Except([entitySet]).UniquifyName(EntitySetName);
        ...
        private void ConfigureIndexes(DbDatabaseMapping mapping, EntityType entityType)
        {
            ...
            if (_keyConfiguration is not null)
            {
                entityTypeMappings
            ...
            foreach (var configuration in _navigationPropertyConfigurations)
            {
                ...
                if (navigationProperty is null)
                {
                    ...
                    if (property is not null
                        && property.ComplexType is not null)
                    {
            ...
            DbProviderManifest providerManifest)
        {
            ...
            if (entityTypeMapping is not null)
            {
            ...
            DbDatabaseMapping databaseMapping, EntityType entityType, DbProviderManifest providerManifest)
        {
            ...
            if (_modificationStoredProceduresConfiguration is not null)
            {
                ...
                if (modificationStoredProcedureMapping is not null)
                {
            ...
            DbDatabaseMapping databaseMapping, EntityType entityType, DbProviderManifest providerManifest)
        {
            ...
            foreach (var configuration in _navigationPropertyConfigurations)
            {
                ...
                if (associationSetMapping is not null)
                {
                ...
                ++entityTypesListIterator)
            {
                    ...
                    ++foreignKeyBuildersIterator)
                {
                    ...
                    for (var i = 0; i < dependentColumnsList.Count; ++i)
                    {
                        ...
                        if ((primitivePropertyConfiguration is not null)
                            && (primitivePropertyConfiguration.ColumnType is not null))
                        {
                            continue;
                        }
