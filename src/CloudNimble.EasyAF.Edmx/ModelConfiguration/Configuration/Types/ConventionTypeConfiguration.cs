...
namespace System.Data.Entity.ModelConfiguration.Configuration
{
    ...
    public class ConventionTypeConfiguration
    {
        ...
        public ConventionTypeConfiguration HasEntitySetName(string entitySetName)
        {
            ...
            if (_entityTypeConfiguration is not null
                && _entityTypeConfiguration().EntitySetName is null)
            {
        ...
        public ConventionTypeConfiguration Ignore()
        {
            ...
            if (_entityTypeConfiguration is null
                && _complexTypeConfiguration is null)
            {
        ...
        public ConventionTypeConfiguration Ignore(PropertyInfo propertyInfo)
        {
            ...
            if (propertyInfo is not null)
            {
                ...
                if (_complexTypeConfiguration is not null)
                {
        ...
        internal ConventionPrimitivePropertyConfiguration Property(PropertyPath propertyPath)
        {
            ...
            var propertyConfiguration = _entityTypeConfiguration is not null
                                            ? _entityTypeConfiguration().Property(propertyPath)
                                            : _complexTypeConfiguration is not null
        ...
        private static readonly List<ConfigurationAspect> ConfigurationAspectsConflictingWithIgnoreType =
        [
        ...
        private static readonly List<ConfigurationAspect> ConfigurationAspectsConflictingWithComplexType =
        [
                ConfigurationAspect.HasEntitySetName,
                ConfigurationAspect.HasKey,
                ConfigurationAspect.MapToStoredProcedures,
