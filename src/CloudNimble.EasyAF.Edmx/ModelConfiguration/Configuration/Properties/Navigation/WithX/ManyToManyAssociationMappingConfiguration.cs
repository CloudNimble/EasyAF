...
namespace System.Data.Entity.ModelConfiguration.Configuration
{
    ...
    {
        private readonly List<string> _leftKeyColumnNames = [];
        private readonly List<string> _rightKeyColumnNames = [];
        ...
        public override int GetHashCode()
        {
            unchecked
            {
                var hashCode = (_tableName is not null ? _tableName.GetHashCode() : 0) * 397;
