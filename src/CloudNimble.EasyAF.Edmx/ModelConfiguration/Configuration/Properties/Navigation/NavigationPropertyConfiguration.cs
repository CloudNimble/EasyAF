...
namespace System.Data.Entity.ModelConfiguration.Configuration.Properties.Navigation
{
    ...
    internal class NavigationPropertyConfiguration : PropertyConfiguration
    {
        ...
        private NavigationPropertyConfiguration(NavigationPropertyConfiguration source)
        {
            ...
            _constraint = source._constraint is null
                              ? null
                              : source._constraint.Clone();

            _associationMappingConfiguration
                = source._associationMappingConfiguration is null
                      ? null
            ...
            _modificationStoredProceduresConfiguration
                = source._modificationStoredProceduresConfiguration is null
                      ? null
            ...
            DbProviderManifest providerManifest)
        {
            ...
            if (AssociationMappingConfiguration is not null)
            {
            ...
            if (_modificationStoredProceduresConfiguration is not null)
            {
                if (associationSetMapping.ModificationFunctionMapping is null)
                {
        ...
        private void ConfigureInverse(AssociationType associationType, EdmModel model)
        {
            ...
            if (_inverseNavigationProperty is null)
            {
                return;
            }
            ...
            if ((inverseNavigationProperty is not null)
                && (inverseNavigationProperty.Association != associationType))
            {
                ...
                if ((associationType.Constraint is null)
                    && (_constraint is null)
                    && (inverseNavigationProperty.Association.Constraint is not null))
                {
        ...
        private void EnsureConsistency(NavigationPropertyConfiguration navigationPropertyConfiguration)
        {
            ...
            if (RelationshipMultiplicity is not null)
            {
                if (navigationPropertyConfiguration.InverseEndKind is null)
                {
            ...
            if (InverseEndKind is not null)
            {
                if (navigationPropertyConfiguration.RelationshipMultiplicity is null)
                {
                ...
                {
                    if (InverseNavigationProperty is null)
                    {
            ...
            {
                if (navigationPropertyConfiguration.DeleteAction is null)
                {
            ...
            {
                if (navigationPropertyConfiguration.Constraint is null)
                {
            ...
            if (IsNavigationPropertyDeclaringTypePrincipal is not null)
            {
                if (navigationPropertyConfiguration.IsNavigationPropertyDeclaringTypePrincipal is null)
                {
            ...
            if (AssociationMappingConfiguration is not null)
            {
                if (navigationPropertyConfiguration.AssociationMappingConfiguration is null)
                {
            ...
            if (ModificationStoredProceduresConfiguration is not null)
            {
                if (navigationPropertyConfiguration.ModificationStoredProceduresConfiguration is null)
                {
            ...
            EntityTypeConfiguration entityTypeConfiguration)
        {
            ...
            if (_constraint is not null)
            {
                ...
                if ((associationConstraint is not null)
