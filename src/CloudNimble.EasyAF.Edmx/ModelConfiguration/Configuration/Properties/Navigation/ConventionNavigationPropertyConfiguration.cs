    ...
    internal class ConventionNavigationPropertyConfiguration
    {
            ...
            where T : ConstraintConfiguration
        {
                ...
                && !HasConfiguredConstraint())
            {
                ...
                if (_configuration.Constraint is null)
                {
                ...
                if (constraintConfigurationAction is not null)
                {
        ...
        {
            if (_configuration is not null
                && _configuration.Constraint is not null
            ...
            if (_configuration is not null
                && _configuration.InverseNavigationProperty is not null)
            {
            ...
            Func<PropertyInfo, PropertyInfo> inverseNavigationPropertyGetter)
        {
            ...
            if (_configuration is not null
                && _configuration.InverseNavigationProperty is null)
            {
        ...
        {
            if (_configuration is not null
                && _configuration.InverseEndKind is null)
            {
                if (_configuration.InverseNavigationProperty is not null)
                {
        ...
        {
            if (_configuration is not null
                && _configuration.IsNavigationPropertyDeclaringTypePrincipal is null)
            {
        ...
        {
            if (_configuration is not null
                && _configuration.DeleteAction is null)
            {
        ...
        {
            if (_configuration is not null
                && _configuration.RelationshipMultiplicity is null)
            {
