...
namespace System.Data.Entity.ModelConfiguration.Configuration.Properties.Primitive
{
    ...
    internal class PrimitivePropertyConfiguration : PropertyConfiguration
    {
        ...
        internal virtual void Configure(EdmProperty property)
        {
            ...
            Debug.Assert(property.TypeUsage is not null);
            ...
            var mergedConfiguration = clone.MergeWithExistingConfiguration(
                ...
                errorMessage =>
                {
                    ...
                    var declaringTypeName = propertyInfo is null
                        ? string.Empty
            ...
            EdmProperty property, Func<string, Exception> getConflictException, bool inCSpace, bool fillFromExistingConfiguration)
        {
            ...
            if (existingConfiguration is not null)
            {
                ...
                if (OverridableConfigurationParts.HasFlag(space)
                    || existingConfiguration.IsCompatible(this, inCSpace, errorMessage: out var errorMessage))
                {
        ...
        protected virtual void ConfigureProperty(EdmProperty property)
        {
            ...
            if (ConcurrencyMode is not null)
            {
                property.ConcurrencyMode = ConcurrencyMode.Value;
            }

            if (DatabaseGeneratedOption is not null)
            {
            ...
            var pendingRenames
                = from p in parameter.DeclaringFunction.Parameters
                  ...
                  where (p != parameter)
                        ...
                        && ((configuration is null) || (configuration.ParameterName is null))
                  select p;
            ...
            var pendingRenames
                = from c in table.Properties
                  ...
                  where (c != column)
                        ...
                        && ((configuration is null) || (configuration.ColumnName is null))
                  select c;
            ...
            else
            {
                ...
                foreach (var annotation in other._annotations)
                {
                    if (_annotations.ContainsKey(annotation.Key))
                    {
                        ...
                        if (mergeableAnnotation is not null)
                        {
        ...
        internal virtual void MakeCompatibleWith(PrimitivePropertyConfiguration other, bool inCSpace)
        {
            ...
            if (inCSpace)
            {
                if (other.ConcurrencyMode is not null)
                {
                    ConcurrencyMode = null;
                }
                if (other.DatabaseGeneratedOption is not null)
                {
                    DatabaseGeneratedOption = null;
                }
                if (other.IsNullable is not null)
                {
                    IsNullable = null;
                }
            }
            ...
            {
                if (other.ColumnName is not null)
                {
                    ColumnName = null;
                }
                if (other.ParameterName is not null)
                {
                    ParameterName = null;
                }
                if (other.ColumnOrder is not null)
                {
                    ColumnOrder = null;
                }
                if (other.ColumnType is not null)
                {
                    ColumnType = null;
                }
                ...
                foreach (var annotationName in other._annotations.Keys)
                {
                    if (_annotations.ContainsKey(annotationName))
                    {
                        ...
                        if (mergeableAnnotation is null
        ...
        {
            if (thisConfiguration is not null)
            {
