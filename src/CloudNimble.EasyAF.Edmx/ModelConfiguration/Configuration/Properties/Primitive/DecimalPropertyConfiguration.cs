...
namespace System.Data.Entity.ModelConfiguration.Configuration.Properties.Primitive
{
    ...
    internal class DecimalPropertyConfiguration : PrimitivePropertyConfiguration
    {
        ...
        internal override void MakeCompatibleWith(PrimitivePropertyConfiguration other, bool inCSpace)
        {
            ...
            if (decimalPropertyConfiguration is null) return;
            if (decimalPropertyConfiguration.Precision is not null) Precision = null;
            if (decimalPropertyConfiguration.Scale is not null) Scale = null;
        }
        ...
        internal override bool IsCompatible(PrimitivePropertyConfiguration other, bool inCSpace, out string errorMessage)
        {
            ...
            var precisionIsCompatible = decRhs is null || IsCompatible(c => c.Precision, decRhs, ref errorMessage);
            var scaleIsCompatible = decRhs is null || IsCompatible(c => c.Scale, decRhs, ref errorMessage);
