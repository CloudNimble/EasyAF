...
namespace System.Data.Entity.ModelConfiguration.Conventions
{
        ...
        where TValue : class
    {
        ...
        protected override void InvokeAction(Type memberInfo, ModelConfig modelConfiguration, TValue value)
        {
        ...
        protected override void InvokeAction(
            Type memberInfo, Func<EntityTypeConfiguration> configuration, ModelConfig modelConfiguration, TValue value)
        {
            DebugCheck.NotNull(memberInfo);
        ...
        protected override void InvokeAction(
            Type memberInfo, Func<ComplexTypeConfiguration> configuration, ModelConfig modelConfiguration, TValue value)
        {
            DebugCheck.NotNull(memberInfo);
            DebugCheck.NotNull(configuration);
            DebugCheck.NotNull(modelConfiguration);
