    ...
    public class ForeignKeyAssociationMultiplicityConvention : IConceptualModelConvention<AssociationType>
    {
        ...
        public virtual void Apply(AssociationType item, DbModel model)
        {
            ...
            if (constraint.ToProperties.All(p => !p.Nullable))
            {
                ...
                if (navigationPropertyConfiguration is not null
                    && navigationProperty is not null
                    && ((propertyInfo = navigationProperty.Annotations.GetClrPropertyInfo()) is not null)
