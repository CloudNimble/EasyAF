        ...
        public virtual void Apply(EdmModel item, DbModel model)
        {
            ...
            var associationPairs
                = (from a1 in item.AssociationTypes
                   ...
                   where (((a1Configuration is null)
                           || ((a1Configuration.InverseEndKind is null)
                               && (a1Configuration.InverseNavigationProperty is null)))
                          && ((a2Configuration is null)
                              || ((a2Configuration.InverseEndKind is null)
                                  && (a2Configuration.InverseNavigationProperty is null))))
                   select new
                       {
                           a1,
                           a2
            ...
            {
                var unifiedAssociation = pair.a2.GetConfiguration() is not null ? pair.a2 : pair.a1;
                ...
                if (redundantAssociation.Constraint is not null)
                {
                ...
                if (sourceEndClrProperty is not null)
                {
