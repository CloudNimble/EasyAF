...
//[assembly: AssemblyTitle("EasyAF.Edmx")]
//[assembly: AssemblyDescription("EasyAF.Edmx.dll")]
[assembly: AssemblyDefaultAlias("EasyAF.Edmx.dll")]

#if !NET40

// In EF 4.1-4.3, these attributes were all in the System.ComponentModel.DataAnnotations
// namespace of EasyAF.Edmx.dll.
//
// In EF 5+ for .NET 4, all but MaxLength and MinLength were moved to the
// System.ComponentModel.DataAnnotations.Schema namespace and remained in EasyAF.Edmx.dll.
//
...
// the type forwarding below forwards from the EasyAF.Edmx.dll for EF 5+ on .NET 4 to
