...
namespace System.Data.Entity.Internal.Validation
{
    ...
    internal class ValidationProvider
    {
        ...
        public virtual EntityValidator GetEntityValidator(InternalEntityEntry entityEntry)
        {
            ...
            if (_entityValidators.TryGetValue(entityType, out var validator))
            {
                return validator;
            }
            else
            ...
            InternalEntityEntry owningEntity, InternalMemberEntry property)
        {
            ...
            return entityValidator is not null ? GetValidatorForProperty(entityValidator, property) : null;
        }
            ...
            EntityValidator entityValidator, InternalMemberEntry memberEntry)
        {
            ...
            if (complexPropertyEntry is not null)
            {
                ...
                return propertyValidator is not null && propertyValidator.ComplexTypeValidator is not null
