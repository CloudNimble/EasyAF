...
namespace System.Data.Entity.Internal.Validation
{
    ...
    internal class ValidatableObjectValidator : IValidator
    {
            ...
            EntityValidationContext entityValidationContext, InternalMemberEntry property)
        {
            ...
            Debug.Assert(
                (property is null && entityValidationContext.InternalEntity.Entity is IValidatableObject) ||
                (property is not null && (property.CurrentValue is null || property.CurrentValue is IValidatableObject)),
            ...
            var validatableObject = (IValidatableObject)(property is null
