...
namespace System.Data.Entity.Internal
{
    ...
    internal abstract class InternalContext : IDisposable
    {
        ...
        private readonly ValidationProvider _validationProvider = new(
        ...
        {
            get { return _tempObjectContext is null ? null : _tempObjectContext.ObjectContext; }
        }
        ...
        public virtual void DisposeTempObjectContext()
        {
            ...
            {
                if (--_tempObjectContextCount == 0
                    && _tempObjectContext is not null)
                {
        ...
        {
            string _;
            var lastModel = CreateHistoryRepository(existenceState).GetLastModel(out _, out var productVersion);

            return lastModel is not null ? new VersionedModel(lastModel, productVersion) : null;
        }
        ...
        private HistoryRepository CreateHistoryRepository(DatabaseExistenceState existenceState = DatabaseExistenceState.Unknown)
        {
            ...
            return new HistoryRepository(
                ...
                schemas: DefaultSchema is not null ? [DefaultSchema] : Enumerable.Empty<string>(),
        ...
        public virtual DbTransaction TryGetCurrentStoreTransaction()
        {
            ...
            return entityTransaction is not null ? entityTransaction.StoreTransaction : null;
        }
        ...
        {
            return ObjectContext.ObjectStateManager.TryGetObjectStateEntry(entity, out var stateEntry) &&
        ...
        public void PerformDatabaseInitialization()
        {
            ...
            var initializerAction =
                (Action)CreateInitializationActionMethod.MakeGenericMethod(Owner.GetType()).Invoke(this, [initializer]);
        ...
        public virtual void DisposeContext(bool disposing)
        {
            ...
            {
                if (disposing
                    && OnDisposing is not null)
                {
                    OnDisposing(this, new EventArgs());
                    OnDisposing = null;
                }

                if (_tempObjectContext is not null)
                {
                    _tempObjectContext.Dispose();
                }
        ...
        public virtual IDbSet<TEntity> Set<TEntity>() where TEntity : class
        {
            ...
            if (!_genericSets.TryGetValue(typeof(TEntity), out var set))
            {
        ...
        public virtual IInternalSetAdapter Set(Type entityType)
        {
            ...
            if (!_nonGenericSets.TryGetValue(entityType, out var set))
            {
        ...
        {
            if (!_setFactories.TryGetValue(entityType, out var factory))
            {
        ...
        public virtual IEnumerator ExecuteSqlQuery(Type elementType, string sql, bool? streaming, object[] parameters)
        {
            ...
            if (!_queryExecutors.TryGetValue(elementType, out var executor))
            {
        ...
        public virtual IDbAsyncEnumerator ExecuteSqlQueryAsync(Type elementType, string sql, bool? streaming, object[] parameters)
        {
            ...
            // forced to use MakeGenericMethod.  We compile this into a delegate so that we
            // only take the hit once.
            if (!_asyncQueryExecutors.TryGetValue(elementType, out var executor))
            {
        ...
        {
            return GetStateEntries(e => e.Entity is not null);
        }
        ...
        public virtual DbUpdateException WrapUpdateException(UpdateException updateException)
        {
            ...
            if (updateException.StateEntries is not null && updateException.StateEntries.Any(e => e.Entity is null))
            {
            ...
            return asOptimisticConcurrencyException is not null
        ...
        {
            if (!_entityFactories.TryGetValue(type, out var entityFactory))
            {
        ...
        {
            get { return _providerFactory ??= DbProviderServices.GetProviderFactory(Connection); }
        }
        ...
        public void ApplyContextInfo(DbContextInfo info)
        {
            ...
            Debug.Assert(_contextInfo is null || ReferenceEquals(_contextInfo, info));

            if (_contextInfo is not null)
            {
                return;
            }
        ...
        private void DiscoverMigrationsConfiguration()
        {
            if (!_migrationsConfigurationDiscovered.HasValue)
            {
                ...
                if (discoveredConfig is not null)
                {
        ...
        {
            get { return _logFormatter is not null ? _logFormatter.WriteAction : null; }
            set
            {
                if (_logFormatter is null || _logFormatter.WriteAction != value)
                {
                    if (_logFormatter is not null)
                    {
