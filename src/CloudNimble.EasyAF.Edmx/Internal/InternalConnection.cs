...
namespace System.Data.Entity.Internal
{
    ...
    internal abstract class InternalConnection : IInternalConnection
    {
        ...
        public virtual DbConnection Connection
        {
            get
            {
                Debug.Assert(UnderlyingConnection is not null, "UnderlyingConnection should have been initialized before getting here.");

                var asEntityConnection = UnderlyingConnection as EntityConnection;
                return asEntityConnection is not null ? asEntityConnection.StoreConnection : UnderlyingConnection;
            }
        }
        ...
        public virtual string ProviderName
        {
            get
            {
                return _providerName ??= UnderlyingConnection is null ? null : Connection.GetProviderInvariantName();
            }
        ...
        public virtual string OriginalConnectionString
        {
            get
            {
                Debug.Assert(UnderlyingConnection is not null);
        ...
        public static string GetStoreConnectionString(DbConnection connection)
        {
            ...
            if (entityConnection is not null)
            {
                connection = entityConnection.StoreConnection;
                connectionString = (connection is not null)
