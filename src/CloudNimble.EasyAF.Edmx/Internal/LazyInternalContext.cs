...
namespace System.Data.Entity.Internal
{
    ...
    internal class LazyInternalContext : InternalContext
    {
            ...
            : base(owner, dispatchers)
        {
            ...
            _createdWithExistingModel = model is not null;
        ...
        {
            return ObjectContextInUse is null ? 0 : base.SaveChanges();
        }
        ...
        public override Task<int> SaveChangesAsync(CancellationToken cancellationToken)
        {
            ...
            return ObjectContextInUse is null ? Task.FromResult(0) : base.SaveChangesAsync(cancellationToken);
        }
        ...
        public override DbConnection Connection
        {
            get
            {
                ...
                if (TempObjectContext is not null)
                {
        ...
        public override void OverrideConnection(IInternalConnection connection)
        {
            ...
            Debug.Assert(_objectContext is null);
        ...
        public static DbCompiledModel CreateModel(LazyInternalContext internalContext)
        {
            ...
            var model
                = (internalContext._modelProviderInfo is null)
        ...
        public DbModelBuilder CreateModelBuilder()
        {
            var versionAttribute = _attributeProvider.GetAttributes(Owner.GetType())
                                                     ...
                                                     .FirstOrDefault();
            var version = versionAttribute is not null ? versionAttribute.Version : DbModelBuilderVersion.Latest;
        ...
        {
            get { return _model is not null ? _defaultCodeFirstInitializer : null; }
        }
        ...
        public override bool LazyLoadingEnabled
        {
            ...
            {
                var objectContext = ObjectContextInUse;
                return objectContext is not null
