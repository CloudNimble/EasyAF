    ...
    internal class SortableBindingList<T> : BindingList<T>
    {
        ...
        internal class PropertyComparer : Comparer<T>
        {
            ...
            public PropertyComparer(PropertyDescriptor prop, ListSortDirection direction)
            {
                ...
                {
                    var property = typeof(Comparer<>).MakeGenericType([prop.PropertyType]).GetDeclaredProperty("Default");
            ...
            public override int Compare(T left, T right)
            {
                ...
                if (_useToString)
                {
                    leftValue = leftValue is not null ? leftValue.ToString() : null;
                    rightValue = rightValue is not null ? rightValue.ToString() : null;
                }
            ...
            {
                return type.GetInterface("IComparable") is not null ||
