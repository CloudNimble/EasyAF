...
namespace System.Data.Entity.Internal
{
    ...
    internal class PropertyEntryMetadata : MemberEntryMetadata
    {
            ...
            InternalContext internalContext, Type declaringType, Type requestedType, string propertyName)
        {
            ...
            DbHelpers.GetPropertyTypes(declaringType).TryGetValue(propertyName, out var propertyType);
            ...
            edmType.Members.TryGetValue(propertyName, false, out var member);
            ...
            else
            {
                ...
                Debug.Assert(propertyType is not null, "If the property has a getter or setter, then it must exist and have a type.");
            }
        ...
        {
            return parentPropertyEntry is null
