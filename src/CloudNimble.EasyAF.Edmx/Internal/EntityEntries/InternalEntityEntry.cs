...
namespace System.Data.Entity.Internal
{
    ...
    internal class InternalEntityEntry
    {
        ...
        public InternalEntityEntry(InternalContext internalContext, IEntityStateEntry stateEntry)
        {
            ...
            Debug.Assert(stateEntry.Entity is not null);
                ...
                else
                {
                    switch (value)
                    {
                        ...
                        case EntityState.Deleted:
                            ...
                            Debug.Assert(_stateEntry is not null, "_stateEntry should not be null after Attach.");
                            _stateEntry.ChangeState(value);
                            break;
                    }
                }
        ...
        public virtual InternalPropertyValues GetDatabaseValues()
        {
            ...
            return dataRecord is null ? null : new ClonedPropertyValues(OriginalValues, dataRecord);
        }
            ...
            bool requireComplex)
        {
            ...
            var declaringType = parentProperty is not null ? parentProperty.EntryMetadata.ElementType : EntityType;
        ...
        {
            EdmEntityType.Members.TryGetValue(propertyName, false, out var member);

            var asNavProperty = member as NavigationProperty;
            return asNavProperty is null
                       ? null
        ...
        {
            EdmEntityType.Members.TryGetValue(navigationProperty, false, out var member);
        ...
        public IEntityStateEntry ObjectStateEntry
        {
            get
            {
                Debug.Assert(_stateEntry is not null, "ObjectStateEntry is not available from entries for detached entities.");
        ...
        public virtual DbEntityValidationResult GetValidationResult(IDictionary<object, object> items)
        {
            ...
            try
            {
                result = entityValidator is not null
