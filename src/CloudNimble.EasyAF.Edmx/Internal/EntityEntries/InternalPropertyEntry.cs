    ...
    internal abstract class InternalPropertyEntry : InternalMemberEntry
    {
        ...
        public virtual object OriginalValue
        {
            get
            {
                ...
                var value = parentOriginalValues is null ? null : parentOriginalValues[Name];

                var asValues = value as InternalPropertyValues;
                if (asValues is not null)
                {
            ...
            set
            {
                ...
                var parentOriginalValues = ParentOriginalValues;
                if (parentOriginalValues is null)
                {
                    Debug.Assert(ParentPropertyEntry is not null, "Should only have null parent original values for nested properties.");
        ...
        public override object CurrentValue
        {
            get
            {
                    ...
                    && EntryMetadata.IsMapped)
                {
                    ...
                    var value = parentCurrentValues is null ? null : parentCurrentValues[Name];
            ...
            set
            {
                ...
                else
                {
                    ...
                    var parentCurrentValues = ParentCurrentValues;
                    if (parentCurrentValues is null)
                    {
                        Debug.Assert(ParentPropertyEntry is not null, "Should only have null parent original values for nested properties.");
        ...
        private void SetPropertyValueUsingValues(InternalPropertyValues internalValues, object value)
        {
            ...
            if (nestedValues is not null)
            {
                Debug.Assert(value is not null, "Should already have thrown if complex object is null.");
