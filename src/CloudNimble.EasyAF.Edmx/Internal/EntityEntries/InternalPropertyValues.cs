    ...
    internal abstract class InternalPropertyValues
    {
        ...
        public object ToObject()
        {
            ...
            foreach (var propertyName in PropertyNames)
            {
                ...
                if (setters.TryGetValue(propertyName, out var setterDelegate))
                {
        ...
        private object CreateObject()
        {
            ...
            if (!_nonEntityFactories.TryGetValue(_type, out var nonEntityFactory))
            {
        ...
        public void SetValues(object value)
        {
            ...
            foreach (var propertyName in PropertyNames)
            {
                // If the CLR type doesn't have a property with the given name, then we simply ignore it.
                // This cannot happen currently but will be possible when we have shadow state.
                if (getters.TryGetValue(propertyName, out var getterDelegate))
                {
        ...
        public object this[string propertyName]
        {
            ...
            set
            {
                ...
                if (asPropertyValues is not null)
                {
