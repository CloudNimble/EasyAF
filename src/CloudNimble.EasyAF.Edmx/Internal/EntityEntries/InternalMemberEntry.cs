...
namespace System.Data.Entity.Internal
{
    ...
    internal abstract class InternalMemberEntry
    {
        ...
        {
            Debug.Assert(
                InternalEntityEntry.InternalContext.ValidationProvider is not null,
                "_internalEntityEntry.InternalContext.ValidatorProvider is not null");
            ...
            return propertyValidator is not null
