...
namespace System.Data.Entity.Internal
{
    ...
    internal class InternalEntityPropertyEntry : InternalPropertyEntry
    {
        ...
        {
            DbHelpers.GetPropertyGetters(InternalEntityEntry.EntityType).TryGetValue(Name, out var getter);
        ...
        {
            DbHelpers.GetPropertySetters(InternalEntityEntry.EntityType).TryGetValue(Name, out var setter);
