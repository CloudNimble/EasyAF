    ...
    internal class InternalNestedPropertyEntry : InternalPropertyEntry
    {
        ...
        public override InternalPropertyValues ParentCurrentValues
        {
            get
            {
                ...
                var nestedValues = parentCurrentValues is null ? null : parentCurrentValues[_parentPropertyEntry.Name];

                Debug.Assert(
                    nestedValues is null || nestedValues is InternalPropertyValues,
        ...
        public override InternalPropertyValues ParentOriginalValues
        {
            get
            {
                ...
                var nestedValues = parentOriginalValues is null ? null : parentOriginalValues[_parentPropertyEntry.Name];
        ...
        protected override Func<object, object> CreateGetter()
        {
            ...
            if (!DbHelpers.GetPropertyGetters(EntryMetadata.DeclaringType).TryGetValue(Name, out var getter))
            {
                return null;
            }
            ...
            return o =>
                {
                    ...
                    return parent is null ? null : getter(parent);
                };
        }
        ...
        protected override Action<object, object> CreateSetter()
        {
            ...
            if (!DbHelpers.GetPropertySetters(EntryMetadata.DeclaringType).TryGetValue(Name, out var setter))
            {
                return null;
            }
