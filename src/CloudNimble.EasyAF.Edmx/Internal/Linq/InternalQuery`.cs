...
namespace System.Data.Entity.Internal.Linq
{
    ...
    internal class InternalQuery<TElement> : IInternalQuery<TElement>
    {
        ...
        public virtual ObjectQuery<TElement> ObjectQuery
        {
            get
            {
                Debug.Assert(_objectQuery is not null, "InternalQuery should have been initialized.");
        ...
        {
            Debug.Assert(_objectQuery is null, "InternalQuery should not be initialized twice.");
