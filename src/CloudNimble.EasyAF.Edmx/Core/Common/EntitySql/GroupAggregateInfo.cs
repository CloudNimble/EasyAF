...
namespace System.Data.Entity.Core.Common.EntitySql
{
    ...
    internal abstract class GroupAggregateInfo
    {
        ...
        protected void AttachToAstNode(string aggregateName, TypeUsage resultType)
        {
            ...
            Debug.Assert(AstNode is not null, "AstNode must be set.");
            Debug.Assert(AggregateName is null && AggregateStubExpression is null, "Cannot reattach.");
        ...
        {
            Debug.Assert(
                _evaluatingScopeRegion is null, "Can not update referenced scope index after _evaluatingScopeRegion have been computed.");

            var referencedScopeRegion = sr.GetDefiningScopeRegion(referencedScopeIndex);

            if (_innermostReferencedScopeRegion is null
                ||
        ...
        internal ScopeRegion InnermostReferencedScopeRegion
        {
            ...
            {
                Debug.Assert(
                    _evaluatingScopeRegion is null,
        ...
        {
            Debug.Assert(_evaluatingScopeRegion is null, "_evaluatingScopeRegion has already been initialized");
            //
            ...
            if (!_evaluatingScopeRegion.IsAggregating)
            {
                ...
                if (_evaluatingScopeRegion is null)
                {
        ...
        {
            if (_containedAggregates is not null)
            {
        ...
        {
            if (_containingAggregate is not null)
            {
                //
        ...
        {
            Debug.Assert(_evaluatingScopeRegion is null, "Can not add contained aggregate after _evaluatingScopeRegion have been computed.");
        ...
        {
            Debug.Assert(
                _containedAggregates is not null && _containedAggregates.Contains(containedAggregate),
        ...
        internal ScopeRegion EvaluatingScopeRegion
        {
            get
            {
                ...
                //
                Debug.Assert(_evaluatingScopeRegion is not null, "_evaluatingScopeRegion is not initialized");
