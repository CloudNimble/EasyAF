...
namespace System.Data.Entity.Core.Common.EntitySql
{
    ...
    internal sealed class SourceScopeEntry : ScopeEntry, IGroupExpressionExtendedInfo, IGetAlternativeName
    {
        ...
        internal SourceScopeEntry AddParentVar(DbVariableReferenceExpression parentVarRef)
        {
            ...
            //
            Debug.Assert(_groupVarBasedExpression is null, "_groupVarBasedExpression is null");
            Debug.Assert(_groupAggBasedExpression is null, "_groupAggBasedExpression is null");

            if (_propRefs is null)
            {
                ...
                {
                    ((DbVariableReferenceExpression)_varBasedExpression).VariableName
                };
            }
