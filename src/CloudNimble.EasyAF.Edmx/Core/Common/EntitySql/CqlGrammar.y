...
command             : optNamespaceImportList queryStatement
                    {
                        ...
                        SetErrCtx(AstNode($$), ($1 is not null) ? AstNodePos($1) : AstNodePos($2), EntityRes.CtxCommandExpression);
                    }
                    ;
...
queryStatement      : optQueryDefList generalExpr optSemiColon
                    {
                        ...
                        SetErrCtx(AstNode($$), ($1 is not null) ? AstNodePos($1) : AstNodePos($2), EntityRes.CtxQueryStatement);
                    }
                    ;
...
builtInExpr         //
                    ...
                    | MINUS Expr %prec UNARYMINUS
                    {
                        ...
                        if ( literal is not null && literal.IsNumber && !literal.IsSignedNumber )
                        {
