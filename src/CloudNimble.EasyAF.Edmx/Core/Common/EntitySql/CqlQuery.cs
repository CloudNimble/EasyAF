            ...
            IEnumerable<DbParameterReferenceExpression> parameters)
        {
            var result = CompileCommon(
                ...
                (astCommand, validatedParserOptions) =>
                {
                    ...
                    Debug.Assert(parseResultInternal is not null, "parseResultInternal is not null post-condition FAILED");
                    Debug.Assert(
                        parseResultInternal.CommandTree is not null, "parseResultInternal.CommandTree is not null post-condition FAILED");
                ...
                queryCommandText, parserOptions, (astCommand, validatedParserOptions) =>
                    {
                        ...
                        Debug.Assert(lambda is not null, "lambda is not null post-condition FAILED");
