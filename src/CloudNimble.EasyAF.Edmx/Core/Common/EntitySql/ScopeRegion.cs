...
namespace System.Data.Entity.Core.Common.EntitySql
{
    internal sealed class ScopeRegion
    {
        ...
        {
            get { return _groupAggregateBinding is not null; }
        }
        ...
        private readonly List<GroupAggregateInfo> _groupAggregateInfos = [];
        ...
        private readonly HashSet<string> _groupAggregateNames = [];
        ...
        internal void ApplyToScopeEntries(Func<ScopeEntry, ScopeEntry> action)
        {
            ...
            for (var i = FirstScopeIndex; i <= _scopeManager.CurrentScopeIndex; ++i)
            {
                ...
                foreach (var scopeEntry in scope)
                {
                    ...
                    Debug.Assert(newScopeEntry is not null, "newScopeEntry is not null");
