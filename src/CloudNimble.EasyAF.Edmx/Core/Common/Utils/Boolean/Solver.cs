...
using System.Linq;
using IfThenElseKey = System.Data.Entity.Core.Common.Utils.Boolean.Triple<System.Data.Entity.Core.Common.Utils.Boolean.Vertex, System.Data.Entity.Core.Common.Utils.Boolean.Vertex, System.Data.Entity.Core.Common.Utils.Boolean.Vertex>;
...
namespace System.Data.Entity.Core.Common.Utils.Boolean
{
    ...
    internal sealed class Solver
    {
        ...
        private readonly Dictionary<Vertex, Vertex> _knownVertices =
            new(VertexValueComparer.Instance);

        private int _variableCount;
        // a standard Boolean variable has children '1' and '0'
        internal static readonly Vertex[] BooleanVariableChildren = [Vertex.One, Vertex.Zero];
        ...
        internal Vertex CreateLeafVertex(int variable, Vertex[] children)
        {
            ...
            Debug.Assert(children.All(child => child is not null), "children must not be null");
        ...
        private Vertex GetUniqueVertex(int variable, Vertex[] children)
        {
            ...
            if (_knownVertices.TryGetValue(result, out var canonicalResult))
            {
        ...
        private Vertex IfThenElse(Vertex condition, Vertex then, Vertex @else)
        {
            ...
            if (_computedIfThenElseValues.TryGetValue(key, out var result))
            {
                return result;
            }

            var topVariable = DetermineTopVariable(condition, then, @else, out var topVariableDomainCount);
        ...
        {
            Debug.Assert(vertex is not null, "vertex must not be null");
            ...
            if (!vertex.IsSink())
            {
                ...
                Debug.Assert(
                    _knownVertices.TryGetValue(vertex, out var comparisonVertex) &&
