...
namespace System.Data.Entity.Core.Common.CommandTrees.Internal
{
    internal sealed class DbExpressionValidator : DbExpressionRebinder
    {
        ...
        private readonly Stack<Dictionary<string, TypeUsage>> variableScopes = new();
            ...
            : base(metadata)
        {
            ...
            allowedFunctionSpaces = [DataSpace.CSpace, DataSpace.SSpace];
            if (expectedDataSpace == DataSpace.SSpace)
            {
                allowedMetadataSpaces = [DataSpace.SSpace, DataSpace.CSpace];
            }
            else
            {
                allowedMetadataSpaces = [DataSpace.CSpace];
            }
        }
        ...
        public override DbExpression Visit(DbParameterReferenceExpression expression)
        {
                ...
                == DbExpressionKind.ParameterReference)
            {
                ...
                if (paramMappings.TryGetValue(paramRef.ParameterName, out var foundParam))
                {
