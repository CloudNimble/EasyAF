...
namespace System.Data.Entity.Core.Common.CommandTrees.Internal
{
    ...
    /// </summary>
        ...
        {
            return (elems => elems.FirstOrDefault(e => !elementPattern(e)) is null);
        }
    ...
    /// </summary>
        ...
        {
            return (elems => elems.FirstOrDefault(e => elementPattern(e)) is not null);
        }
#endif
    ...
    /// </summary>
        ...
        {
            return (e => { DbBinaryExpression binEx = (e as DbBinaryExpression); return (binEx is not null && leftPattern(binEx.Left) && rightPattern(binEx.Right)); });
        }
#endif
