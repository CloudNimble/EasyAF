...
namespace System.Data.Entity.Core.Common.CommandTrees.Internal
{
    ...
    {
        private readonly PrinterVisitor _visitor = new();
        ...
        internal string Print(DbUpdateCommandTree tree)
        {
            ...
            Debug.Assert(tree is not null && tree.Predicate is not null, "Invalid DbUpdateCommandTree");
            ...
            public override TreeNode Visit(DbGroupByExpression e)
            {
                ...
                for (var idx = e.Keys.Count; idx < outputType.Properties.Count; idx++)
                {
                    ...
                    else
                    {
                        ...
                        Debug.Assert(groupAgg is not null, "Invalid DbAggregate");
