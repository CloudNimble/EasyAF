...
namespace System.Data.Entity.Core.Common
{
    ...
    internal static class TypeHelpers
    {
        ...
        {
            boolValue = false;
            if (type.Facets.TryGetValue(facetName, false, out var boolFacet)
                && boolFacet.Value is not null)
            {
        ...
        {
            byteValue = 0;
            if (type.Facets.TryGetValue(facetName, false, out var byteFacet)
                && byteFacet.Value is not null
        ...
        {
            intValue = 0;
            if (type.Facets.TryGetValue(facetName, false, out var intFacet)
                && intFacet.Value is not null
        ...
        {
            if (tvf.ReturnParameter is not null
        ...
        {
            if (TryGetEdmType(type, out CollectionType collectionType))
            {
        ...
        {
            if (TryGetEdmType(type, out RefType refType)
                &&
