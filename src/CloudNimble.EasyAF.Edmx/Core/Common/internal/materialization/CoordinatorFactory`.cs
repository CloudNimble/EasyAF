...
namespace System.Data.Entity.Core.Common.Internal.Materialization
{
    ...
    internal class CoordinatorFactory<TElement> : CoordinatorFactory
    {
                ...
                recordStateFactories)
        {
            ...
            Debug.Assert((element is null) != (wrappedElement is null));
            ...
            WrappedElement = wrappedElement is null ? null : wrappedElement.Compile();
            Element = element is null ? null : element.Compile();
            ...
            Description = new StringBuilder()
                ...
                .Append("Element: ")
                .AppendLine(element is null ? DescribeExpression(wrappedElement) : DescribeExpression(element))
