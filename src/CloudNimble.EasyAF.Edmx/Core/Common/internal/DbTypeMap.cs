...
namespace System.Data.Entity.Core.Common.Internal
{
    ...
    internal static class DbTypeMap
    {
        ...
        internal static readonly TypeUsage DateOnly = CreateType(PrimitiveTypeKind.DateOnly);
        internal static readonly TypeUsage TimeOnly = CreateType(
            PrimitiveTypeKind.TimeOnly, new FacetValues
                {
                    Precision = (byte?)null
                });
        ...
        internal static bool TryGetModelTypeUsage(DbType dbType, out TypeUsage modelType)
        {
            switch (dbType)
            {
                ...
                case DbType.Date:
                    // Map DbType.Date to DateOnly when available
                    modelType = DateOnly;
                    break;
                ...
                case DbType.Time:
                    // Map DbType.Time to TimeOnly when available
                    modelType = TimeOnly;
                    break;
