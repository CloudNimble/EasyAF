...
namespace System.Data.Entity.Core.SchemaObjectModel
{
    ...
    internal class Function : SchemaType
    {
        ...
        private static readonly Regex _typeParser = new(
        ...
        {
            DebugCheck.NotNull(reader);
            Debug.Assert(UnresolvedReturnType is null);
            ...
            RemoveTypeModifier(ref type, out var typeModifier, out _isRefType);
