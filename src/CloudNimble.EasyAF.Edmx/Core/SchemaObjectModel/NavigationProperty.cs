...
namespace System.Data.Entity.Core.SchemaObjectModel
{
    ...
    internal sealed class NavigationProperty : Property
    {
        ...
        internal override void ResolveTopLevelNames()
        {
            ...
            if (!Schema.ResolveTypeName(this, _unresolvedRelationshipName, out var element))
            {
                return;
            }
        ...
        internal override void Validate()
        {
            ...
            Debug.Assert(
                _fromEnd is not null && _toEnd is not null,
        ...
        {
            Debug.Assert(
                _unresolvedRelationshipName is null, string.Format(CultureInfo.CurrentCulture, "{0} is already defined", reader.Name));

            if (!Utils.GetDottedName(Schema, reader, out var association))
            {
                return;
            }
