...
namespace System.Data.Entity.Core.SchemaObjectModel
{
    ...
    internal class SchemaManager
    {
        ...
        private readonly HashSet<string> _namespaceLookUpTable = new(StringComparer.Ordinal);
            ...
            bool checkForSystemNamespace, out Schema schema)
        {
            ...
            var errors = ParseAndValidate(
                [xmlReader],
                [location], SchemaDataModelOption.ProviderManifestModel,
            ...
            out IList<Schema> schemaCollection)
        {
            ...
            if (sourceFilePaths is not null)
            {
        ...
        public void AddSchema(Schema schema)
        {
                ...
                && schema.DataModel != SchemaDataModelOption.ProviderManifestModel)
            {
                ...
                if (PrimitiveSchema.Namespace is not null)
                {
