...
namespace System.Data.Entity.Core.SchemaObjectModel
{
    ...
    internal sealed class EntityKeyElement : SchemaElement
    {
        ...
        {
            Debug.Assert(_keyProperties is not null, "xsd should have verified that there should be atleast one property ref element");
        ...
        internal override void Validate()
        {
            ...
            foreach (var keyProperty in _keyProperties)
            {
                ...
                {
                    Debug.Assert(property.TypeUsage is not null, "For scalar type, typeusage must be initialized");
