...
namespace System.Data.Entity.Core.SchemaObjectModel
{
    ...
    internal class Schema : SchemaElement
    {
        ...
        {
            // We don't Assert (sourceReader is not null) here any more because third-party
        ...
        public bool IsParseableXmlNamespace(string xmlNamespaceUri, bool isAttribute)
        {
            ...
            if (_parseableXmlNamespaces is null)
            {
                _parseableXmlNamespaces = [];
        ...
        public bool IsValidateableXmlNamespace(string xmlNamespaceUri, bool isAttribute)
        {
            ...
            if (_validatableXmlNamespaces is null)
            {
        ...
        internal override void Validate()
        {
            ...
            if (ProviderManifest is not null
                &&
        ...
        internal MetadataProperty SchemaSource
        {
            get
            {
                ...
                _schemaSourceProperty ??= new MetadataProperty(
                    ...
                    false, // IsCollection
                    _location is not null ? _location : string.Empty);
        ...
        internal bool ResolveTypeName(SchemaElement usingElement, string typeName, out SchemaType type)
        {
            ...
            Utils.ExtractNamespaceAndName(typeName, out var actualQualification, out var unqualifiedTypeName);
            var definingQualification = actualQualification;

            definingQualification ??= ProviderManifest is null ? _namespaceName : ProviderManifest.NamespaceName;
            ...
            if (actualQualification is null
                || !AliasResolver.TryResolveAlias(definingQualification, out var namespaceName))
            {
        ...
        private static class SomSchemaSetHelper
        {
            private static readonly Memoizer<SchemaDataModelOption, XmlSchemaSet> _cachedSchemaSets =
                new(ComputeSchemaSet, EqualityComparer<SchemaDataModelOption>.Default);
