...
namespace System.Data.Entity.Core.SchemaObjectModel
{
    ...
    internal abstract class SchemaElement
    {
        ...
        internal SchemaElement(SchemaElement parentElement, IDbDependencyResolver resolver = null)
        {
            ...
            if (parentElement is not null)
            {
                ...
                for (var element = parentElement; element is not null; element = element.ParentElement)
                {
        ...
        protected ReturnValue<string> HandleDottedNameAttribute(XmlReader reader, string field)
        {
            ...
            if (!Utils.GetDottedName(Schema, reader, out var value))
            {
                return returnValue;
            }
    ...
    // the attribute value is schema invalid, just skip it; this avoids some duplicate errors at the expense of better error messages...
            if ( reader.SchemaInfo is not null && reader.SchemaInfo.Validity == System.Xml.Schema.XmlSchemaValidity.Invalid )
                continue;
#endif
            ...
            else if (reader.SchemaInfo is null
        ...
        {
            Debug.Assert(reader.NamespaceURI is not null);
            ...
            string xmlNamespaceUri, string attributeName, string value)
        {
            ...
            var parsedValue = serializer is null ? value : serializer().Deserialize(attributeName, value);
        ...
        private void ParseText(XmlReader reader)
        {
            ...
            else if (reader.Value is not null
