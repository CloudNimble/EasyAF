...
namespace System.Data.Entity.Core.SchemaObjectModel
{
    internal class RowTypePropertyElement : ModelFunctionTypeElement
    {
        ...
        {
            if (_typeUsage is not null)
            {
                return _typeUsage;
            }
            Debug.Assert(_typeSubElement is not null, "For attributes typeusage should have been resolved");
            ...
            Converter.ConversionCache convertedItemCache, Dictionary<SchemaElement, GlobalItem> newGlobalItems)
        {
            ...
            {
                if (_typeSubElement is not null) //Has sub-elements
                {
