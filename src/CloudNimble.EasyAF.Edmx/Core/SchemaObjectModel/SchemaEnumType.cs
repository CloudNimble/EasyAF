...
namespace System.Data.Entity.Core.SchemaObjectModel
{
    ...
    internal class SchemaEnumType : SchemaType
    {
        ...
        // </summary>
        private readonly IList<SchemaEnumMember> _enumMembers = [];
        ...
        public SchemaType UnderlyingType
        {
            get
            {
                Debug.Assert(_underlyingType is not null, "The type has not been resolved yet");
        ...
        internal override void ResolveTopLevelNames()
        {
            ...
            if (_unresolvedUnderlyingTypeName is null)
            {
