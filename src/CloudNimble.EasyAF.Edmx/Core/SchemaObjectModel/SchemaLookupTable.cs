...
namespace System.Data.Entity.Core.SchemaObjectModel
{
    ...
    internal sealed class AliasResolver
    {
        ...
        private readonly Dictionary<string, string> _aliasToNamespaceMap = new(StringComparer.Ordinal);
        private readonly List<UsingElement> _usingElementCollection = [];
        ...
        {
            Debug.Assert(
                _definingSchema.ProviderManifest is not null,
