...
namespace System.Data.Entity.Core.SchemaObjectModel
{
    ...
    internal sealed class ScalarType : SchemaType
    {
        ...
        private static readonly Regex _binaryValueValidator = new("^0[xX][0-9a-fA-F]+$", RegexOptions.Compiled);

        private static readonly Regex _guidValueValidator = new(
        ...
        public bool TryParse(string text, out object value)
        {
            switch (_primitiveType.PrimitiveTypeKind)
            {
                ...
                case PrimitiveTypeKind.DateOnly:
                    return TryParseDateOnly(text, out value);
                case PrimitiveTypeKind.TimeOnly:
                    return TryParseTimeOnly(text, out value);
                default:
        ...
        {
            if (!Boolean.TryParse(text, out var temp))
            {
                value = null;
                return false;
            }
        ...
        {
            if (!Byte.TryParse(text, NumberStyles.Integer, CultureInfo.InvariantCulture, out var temp))
            {
                value = null;
                return false;
            }
        ...
        {
            if (!SByte.TryParse(text, NumberStyles.Integer, CultureInfo.InvariantCulture, out var temp))
            {
                value = null;
                return false;
            }
        ...
        {
            if (!Int16.TryParse(text, NumberStyles.Integer, CultureInfo.InvariantCulture, out var temp))
            {
                value = null;
                return false;
            }
        ...
        {
            if (!Int32.TryParse(text, NumberStyles.Integer, CultureInfo.InvariantCulture, out var temp))
            {
                value = null;
                return false;
            }
        ...
        {
            if (!Int64.TryParse(text, NumberStyles.Integer, CultureInfo.InvariantCulture, out var temp))
            {
                value = null;
                return false;
            }
        ...
        {
            if (!Double.TryParse(text, NumberStyles.Float, CultureInfo.InvariantCulture, out var temp))
            {
                value = null;
                return false;
            }
        ...
        {
            if (!Decimal.TryParse(text, NumberStyles.Float, CultureInfo.InvariantCulture, out var temp))
            {
                value = null;
                return false;
            }
        ...
        private static bool TryParseTime(string text, out object value)
        {
            if (
                !DateTime.TryParseExact(
                    ...
                    DateTimeStyles.AssumeUniversal | DateTimeStyles.AdjustToUniversal | DateTimeStyles.NoCurrentDateDefault, out var temp))
            {
                value = null;
                return false;
            }
        ...
        {
            if (!DateTimeOffset.TryParse(text, out var temp))
            {
                value = null;
                return false;
            }
        ...
        {
            if (!Single.TryParse(text, NumberStyles.Float, CultureInfo.InvariantCulture, out var temp))
            {
                value = null;
                return false;
            }
        ...
        private static bool TryParseDateOnly(string text, out object value)
        {
            if (!DateOnly.TryParse(text, CultureInfo.InvariantCulture, out var temp))
            {
                value = null;
                return false;
            }
        ...
        private static bool TryParseTimeOnly(string text, out object value)
        {
            if (!TimeOnly.TryParse(text, CultureInfo.InvariantCulture, out var temp))
            {
                value = null;
                return false;
            }
