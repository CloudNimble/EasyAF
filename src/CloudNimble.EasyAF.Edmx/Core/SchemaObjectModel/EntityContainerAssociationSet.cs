...
namespace System.Data.Entity.Core.SchemaObjectModel
{
    ...
    internal sealed class EntityContainerAssociationSet : EntityContainerRelationshipSet
    {
        ...
        private readonly List<EntityContainerAssociationSetEnd> _rolelessEnds = [];
        ...
        internal override void ResolveTopLevelNames()
        {
            ...
            Debug.Assert(
                Relationship is null || Relationship.RelationshipKind == RelationshipKind.Association,
                string.Format(
