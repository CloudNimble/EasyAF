...
namespace System.Data.Entity.Core.Objects
{
    ...
    internal sealed class ObjectViewQueryResultData<TElement> : IObjectViewData<TElement>
    {
            ...
            IEnumerable queryResults, ObjectContext objectContext, bool forceReadOnlyList, EntitySet entitySet)
        {
            ...
            _canModifyList = !forceReadOnlyList && canTrackItemChanges && _objectContext is not null;

            _bindingList = (from TElement element in queryResults
        ...
        {
            get { return _canModifyList && _entitySet is not null; }
        }
        ...
        public int Add(TElement item, bool isAddNew)
        {
            ...
            Debug.Assert(_objectContext is not null, "ObjectContext is null.");
