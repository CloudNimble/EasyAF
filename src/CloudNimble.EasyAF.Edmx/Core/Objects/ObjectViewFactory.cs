...
namespace System.Data.Entity.Core.Objects
{
    ...
    internal static class ObjectViewFactory
    {
            ...
            EntitySet singleEntitySet)
        {
            ...
            if (ospaceElementTypeUsage is null)
            {
            ...
            else if (clrElementType is null)
            {
            ...
            else
            {
                ...
                Debug.Assert(
                    viewDataConstructor is not null,
                ...
                var viewData = viewDataConstructor.Invoke([queryResults, objectContext, forceReadOnly, singleEntitySet]);
        ...
        {
            Type clrElementType = null;
            var entityTypeUsage = entityType is null ? null : TypeUsage.Create(entityType);
            ...
            else
            {
                ...
                Debug.Assert(clrElementType is not null, "clrElementType has unexpected value of null.");
            ...
            else
            {
                ...
                var viewData = viewDataConstructor.Invoke([entityCollection]);
        ...
        private static IBindingList CreateObjectView(Type clrElementType, Type objectViewDataType, object viewData, object eventDataSource)
        {
            ...
            Debug.Assert(viewConstructor is not null, "ObjectView constructor not found. Please ensure constructor signature is correct.");

            // Create ObjectView instance
            return (IBindingList)viewConstructor.Invoke([viewData, eventDataSource]);
        }
        ...
        private static TypeUsage GetOSpaceTypeUsage(TypeUsage typeUsage, ObjectContext objectContext)
        {
            ...
            if (typeUsage is null
                || typeUsage.EdmType is null)
            {
        ...
        private static Type GetClrType<TElement>(EdmType ospaceEdmType)
        {
                ...
                == BuiltInTypeKind.RowType)
            {
                ...
                if (itemRowType.InitializerMetadata is not null
                    && itemRowType.InitializerMetadata.ClrType is not null)
                {
