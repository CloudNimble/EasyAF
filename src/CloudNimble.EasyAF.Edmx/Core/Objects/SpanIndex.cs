...
namespace System.Data.Entity.Core.Objects.Internal
{
    ...
    internal sealed class SpanIndex
    {
        ...
        private sealed class RowTypeEqualityComparer : IEqualityComparer<RowType>
        {
            ...
            internal static readonly RowTypeEqualityComparer Instance = new();
        ...
        internal TypeUsage GetSpannedRowType(RowType spannedRowType)
        {
            if (_rowMap is not null
                && _rowMap.TryGetValue(spannedRowType, out var retType))
            {
                return retType;
            }
            return null;
        ...
        {
            if (_spanMap is not null
                && _spanMap.TryGetValue(rowType, out var retMap))
            {
                return retMap;
            }
