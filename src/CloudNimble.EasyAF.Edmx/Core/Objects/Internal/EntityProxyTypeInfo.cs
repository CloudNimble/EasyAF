...
namespace System.Data.Entity.Core.Objects.Internal
{
    ...
    internal sealed class EntityProxyTypeInfo
    {
        ...
        private readonly Dictionary<string, AssociationType> _navigationPropertyAssociationTypes = [];
            ...
            MetadataWorkspace workspace)
        {
            ...
            Debug.Assert(entityWrapperField is not null, "entityWrapperField does not exist");
            ...
            if (baseGetterMethod is not null)
            {
            ...
            if (baseSetterMethod is not null)
            {
        ...
        private static bool IsEndMemberForType(AssociationEndMember end, Type clrType)
        {
            ...
            return referenceType is not null && referenceType.ElementType.ClrType.IsAssignableFrom(clrType);
        }
        ...
        {
            return BaseGetter is not null && _propertiesWithBaseGetter.Contains(propertyName);
        }

        public bool ContainsBaseSetter(string propertyName)
        {
            return BaseSetter is not null && _propertiesWithBaseSetter.Contains(propertyName);
        }
