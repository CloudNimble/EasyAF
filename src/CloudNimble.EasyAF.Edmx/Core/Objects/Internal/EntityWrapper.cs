...
namespace System.Data.Entity.Core.Objects.Internal
{
        ...
        where TEntity : class
    {
            ...
            : base(entity, relationshipManager, overridesEquals)
        {
            ...
            Debug.Assert(_changeTrackingStrategy is not null, "Change tracking strategy cannot be null.");
            Debug.Assert(_keyStrategy is not null, "Key strategy cannot be null.");
        }
        ...
        {
            if (_propertyStrategy is not null)
            {
        ...
        {
            return _propertyStrategy is not null ? _propertyStrategy.CollectionRemove(relatedEnd, value) : false;
        }
        ...
        {
            return _propertyStrategy is not null ? _propertyStrategy.GetNavigationPropertyValue(relatedEnd) : null;
        }
