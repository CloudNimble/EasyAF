...
namespace System.Data.Entity.Core.Objects.Internal
{
    ...
    internal sealed class DataContractImplementor
    {
        ...
        internal static readonly PropertyInfo[] DataContractProperties =
            [
        ...
        internal void Implement(TypeBuilder typeBuilder)
        {
            if (_dataContract is not null)
            {
                ...
                var attributeBuilder = new CustomAttributeBuilder(
                    DataContractAttributeConstructor, [], DataContractProperties, propertyValues);
