...
namespace System.Data.Entity.Core.Objects.Internal
{
    internal class TransactionManager
    {
        ...
        internal MergeOption? OriginalMergeOption
        {
            get
            {
                Debug.Assert(_originalMergeOption is not null, "OriginalMergeOption used before being initialized");
        ...
        internal void BeginAddTracking()
        {
            ...
            Debug.Assert(PopulatedEntityReferences is null, "Expected promotion index to be null when begining tracking.");
            Debug.Assert(AlignedEntityReferences is null, "Expected promotion index to be null when begining tracking.");
            IsAddTracking = true;
        ...
        {
            Debug.Assert(ProcessedEntities is not null, "ProcessedEntities should not be null");
