    ...
    internal sealed class EntitySqlQueryState : ObjectQueryState
    {
        ...
        internal override ObjectQueryExecutionPlan GetExecutionPlan(MergeOption? forMergeOption)
        {
            ...
            if (plan is null)
            {
                ...
                Debug.Assert(queryExpression is not null, "EntitySqlQueryState.Parse returned null expression?");
        ...
        {
            if (_queryExpression is not null)
            {
            ...
            if (Parameters is not null)
            {
                ...
                foreach (var parameter in Parameters)
                {
                    ...
                    Debug.Assert(typeUsage is not null, "typeUsage is not null");
            ...
            Debug.Assert(lambda.Variables is null || lambda.Variables.Count == 0, "lambda.Variables must be empty");
