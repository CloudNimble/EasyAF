...
namespace System.Data.Entity.Core.Objects.Internal
{
    ...
    internal abstract class ObjectQueryState
    {
        ...
        {
            Debug.Assert(CreateObjectQueryMethod is not null, "Unable to retrieve ObjectQueryState.CreateObjectQuery<> method");

            var genericObjectQueryMethod = CreateObjectQueryMethod.MakeGenericMethod(_elementType);
            return (ObjectQuery)genericObjectQueryMethod.Invoke(this, []);
        }
