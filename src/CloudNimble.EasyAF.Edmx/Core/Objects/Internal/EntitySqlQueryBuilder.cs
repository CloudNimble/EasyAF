...
namespace System.Data.Entity.Core.Objects.Internal
{
    ...
    internal static class EntitySqlQueryBuilder
    {
        ...
        {
            if (!query.TryGetCommandText(out var commandText))
            {
        ...
        {
            if (query1Params is null
                && query2Params is null)
            {
                return null;
            }
...
[";
        ...
        {
            Debug.Assert(newType is not null, "OfType cannot be null");
