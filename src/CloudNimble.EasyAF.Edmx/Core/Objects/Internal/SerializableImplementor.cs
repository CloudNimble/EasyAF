                ...
                if (canOverrideMethod)
                {
                    ...
                    _serializationConstructor =
                        _baseClrType.GetDeclaredConstructor(
                            ...
                            [typeof(SerializationInfo), typeof(object)],
                            [typeof(object), typeof(StreamingContext)],
                            [typeof(object), typeof(object)]);

                    _canOverride = _serializationConstructor is not null;
                }

                Debug.Assert(
                    !(_canOverride && (_getObjectDataMethod is null || _serializationConstructor is null)),
            ...
            if (_baseImplementsISerializable && _canOverride)
            {
                ...
                proxyGetObjectData.SetCustomAttribute(
                    new CustomAttributeBuilder(
                        typeof(SecurityCriticalAttribute).GetDeclaredConstructor(), []));
