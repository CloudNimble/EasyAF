...
namespace System.Data.Entity.Core.Objects.Internal
{
    ...
    internal class EntityWrapperFactory
    {
        ...
        private static readonly Memoizer<Type, Func<object, IEntityWrapper>> _delegateCache =
            new(CreateWrapperDelegate, null);
        ...
        internal static IEntityWrapper CreateNewWrapper(object entity, EntityKey key)
        {
            ...
            if ((object)key is not null
                && (object)wrappedEntity.EntityKey is null)
            {
        ...
        private static Func<object, IEntityWrapper> CreateWrapperDelegate(Type entityType)
        {
            ...
            return (Func<object, IEntityWrapper>)createDelegate.Invoke(null, []);
        }
        ...
        {
            return WrapEntityUsingStateManagerGettingEntry(entity, context is null ? null : context.ObjectStateManager, out var existingEntry);
        }
        ...
        {
            return WrapEntityUsingStateManagerGettingEntry(entity, context is null ? null : context.ObjectStateManager, out existingEntry);
        }
        ...
        {
            return WrapEntityUsingStateManagerGettingEntry(entity, stateManager, out var existingEntry);
        }
            ...
            object entity, ObjectStateManager stateManager, out EntityEntry existingEntry)
        {
            ...
            if (entityWithRelationships is not null)
            {
                var relManager = entityWithRelationships.RelationshipManager;
                if (relManager is null)
                {
            ...
            if (wrapper is null)
            {
                ...
                wrapper = CreateNewWrapper(entity, withKey is null ? null : withKey.EntityKey);
            }
            if (stateManager is not null
