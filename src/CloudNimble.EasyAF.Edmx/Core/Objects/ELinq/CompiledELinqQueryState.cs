...
namespace System.Data.Entity.Core.Objects.ELinq
{
    ...
    internal sealed class CompiledELinqQueryState : ELinqQueryState
    {
        ...
        internal override ObjectQueryExecutionPlan GetExecutionPlan(MergeOption? forMergeOption)
        {
            ...
            Debug.Assert(_cachedPlan is null, "Cached plan should not be set on compiled LINQ queries");
            ...
            else
            {
                ...
                if (plan is null)
                {
                    ...
                    if (cacheEntry is null)
                    {
                        ...
                        if (cacheManager.TryLookupAndAdd(cacheEntry, out var foundEntry))
                        {
            ...
            if (plan.CompiledQueryParameters is not null
            ...
            Debug.Assert(plan is not null, "Failed to produce an execution plan?");
            return plan;
        }
        ...
        protected override TypeUsage GetResultType()
        {
            var cacheEntry = _cacheEntry;
            if (cacheEntry is not null
                && cacheEntry.TryGetResultType(out var resultType))
            {
                return resultType;
            }
