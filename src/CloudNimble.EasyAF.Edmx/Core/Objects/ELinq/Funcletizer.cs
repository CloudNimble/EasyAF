...
namespace System.Data.Entity.Core.Objects.ELinq
{
    ...
    internal sealed class Funcletizer
    {
        ...
        private readonly HashSet<Expression> _linqExpressionStack = [];
        ...
        private sealed class FuncletizingVisitor : EntityExpressionVisitor
        {
            ...
            private readonly List<Func<bool>> _recompileRequiredDelegates = [];
            ...
            {
                exp = _funcletizer.Funcletize(exp, out var inlineExpressionRequiresRecompile);
