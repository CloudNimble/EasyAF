...
namespace System.Data.Entity.Core.Objects
{
    ...
    internal static class DelegateFactory
    {
        ...
        {
            return (clrType.Constructor ??= CreateConstructor(clrType.ClrType));
        }
        ...
        {
            return property.ValueGetter ??= CreatePropertyGetter(property.EntityDeclaringType, property.PropertyInfo);
        }
            ...
            AssociationEndMember sourceMember, AssociationEndMember targetMember)
        {
            ...
            Debug.Assert(genericCreateRelatedEndMethod is not null, "Could not find method DelegateFactory.CreateGetRelatedEndMethod");
            ...
            var getRelatedEndDelegate = createRelatedEndMethod.Invoke(
                null, [sourceMember, targetMember, sourceAccessor, targetAccessor]);
