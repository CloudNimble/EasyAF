...
namespace System.Data.Entity.Core.Objects.DataClasses
{
        ...
        where TEntity : class
    {
        ...
        internal override void OnAssociationChanged(CollectionChangeAction collectionChangeAction, object entity)
        {
            ...
            if (!_suppressEvents)
            {
                if (_onAssociationChangedforObjectView is not null)
                {
        ...
        public void Attach(IEnumerable<TEntity> entities)
        {
            ...
            CheckOwnerNull();
            IList<IEntityWrapper> wrappedEntities = [];
        ...
        internal virtual void Load(List<IEntityWrapper> collection, MergeOption mergeOption)
        {
            ...
            var sourceQuery = ValidateLoad<TEntity>(mergeOption, "EntityCollection", out var hasResults);
                ...
                && null != ObjectContext)
            {
                ...
                else
                {
                    ...
                    foreach (var wrappedEntity in values)
                    {
                        ...
                        Debug.Assert(otherEnd is not null, "Other end of FK from a collection should be a reference.");
        ...
        {
            if (_wrappedRelatedEntities is not null)
            {
                _wrappedRelatedEntities.Clear();
            }
            if (_relatedEntities is not null)
            {
        ...
        {
            return _wrappedRelatedEntities is null || (_wrappedRelatedEntities.Count == 0);
        }
        ...
        internal override bool ContainsEntity(IEntityWrapper wrappedEntity)
        {
            ...
            return _wrappedRelatedEntities is not null && _wrappedRelatedEntities.ContainsKey((TEntity)wrappedEntity.Entity);
        }
        ...
        {
            DeferredLoad();
            return _wrappedRelatedEntities is null ? false : _wrappedRelatedEntities.ContainsKey(item);
        }
        ...
        public void OnSerializing(StreamingContext context)
        {
            ...
            _relatedEntities = _wrappedRelatedEntities is null ? null : new HashSet<TEntity>(_wrappedRelatedEntities.Keys, ObjectReferenceEqualityComparer.Default);
        }
