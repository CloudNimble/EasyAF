...
namespace System.Data.Entity.Core.Objects.DataClasses
{
    ...
    public abstract class ComplexObject : StructuralObject
    {
            ...
            string parentPropertyName)
        {
            ...
            Debug.Assert(_parentPropertyName is null);
        ...
        internal void DetachFromParent()
        {
            ...
            Debug.Assert(_parent is not null, "Attempt to detach from a null _parent");
            Debug.Assert(_parentPropertyName is not null, "Null _parentPropertyName on a non-null _parent");
        ...
        {
            get { return _parent is null ? false : _parent.IsChangeTracked; }
        }
