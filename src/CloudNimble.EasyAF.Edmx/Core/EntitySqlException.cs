    ...
    public sealed class EntitySqlException : EntityException
    {
            ...
            Exception innerException)
        {
            var errorContext = FormatErrorContext(
                commandText, errorPosition, errorContextInfo, loadErrorContextInfoFromResource, out var line, out var column);
        ...
        {
            return FormatErrorContext(commandText, position, EntityRes.GenericSyntaxError, true, out var lineNumber, out var colNumber);
        }
            ...
            out int columnNumber)
        {
            ...
            commandText = sb.ToString().TrimEnd(['\n']);

            //
            // Compute line and column
            //
            var queryLines = commandText.Split(['\n'], StringSplitOptions.None);
