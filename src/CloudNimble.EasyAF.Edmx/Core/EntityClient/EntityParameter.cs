...
namespace System.Data.Entity.Core.EntityClient
{
    ...
    public class EntityParameter : DbParameter, IDbDataParameter
    {
        ...
        public virtual new byte Precision
        {
            get
            {
        ...
        {
            if (_dbType is not null
                || _edmType is not null)
            {
                PropertyChanging();
            }
        ...
        internal virtual TypeUsage GetTypeUsage()
        {
            ...
            else if (!DbTypeMap.TryGetModelTypeUsage(DbType, out typeUsage))
            {
                ...
                if (DbType == DbType.Object
                    && Value is not null
                    && ClrProviderManifest.Instance.TryGetPrimitiveType(Value.GetType(), out var primitiveParameterType)
            ...
            Debug.Assert(typeUsage is not null, "DbType.TryGetModelTypeUsage returned true for null TypeUsage?");
            return typeUsage;
        }
        ...
        private static DbType GetDbTypeFromEdm(EdmType edmType)
        {
            ...
            else if (DbCommandDefinition.TryGetDbTypeFromPrimitiveType(primitiveType, out var dbType))
            {
                return dbType;
            }
