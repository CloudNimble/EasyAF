...
namespace System.Data.Entity.Core.EntityClient
{
    ...
    public class EntityConnection : DbConnection
    {
        ...
        private static readonly DbConnectionOptions _emptyConnectionOptions = new(String.Empty, []);
        ...
        public override string ConnectionString
        {
            get
            {
                ...
                if (_userConnectionOptions is null)
                {
                    Debug.Assert(_storeConnection is not null);
        ...
        {
            if (_metadataWorkspace is not null)
            {
        ...
        internal virtual bool EnlistedInUserTransaction
        {
            get
            {
                try
                {
                    return _enlistedTransaction is not null && _enlistedTransaction.TransactionInformation.Status == TransactionStatus.Active;
                }
        ...
        {
            if (_fakeConnectionState is not null)
            {
        ...
        internal virtual EntityTransaction UseStoreTransaction(DbTransaction storeTransaction)
        {
            ...
            else
            {
                ...
                if (transactionConnection is null)
                {
        ...
        public override void EnlistTransaction(Transaction transaction)
        {
            ...
            try
            {
                ...
                Debug.Assert(
                    transaction is not null || !EnlistedInUserTransaction,
        ...
        private void ChangeConnectionString(string newConnectionString)
        {
            ...
            if (!userConnectionOptions.IsEmpty)
            {
                ...
                try
                {
                    ...
                    if (providerConnectionString is not null)
                    {
