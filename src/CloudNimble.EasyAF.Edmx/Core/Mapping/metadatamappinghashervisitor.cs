...
namespace System.Data.Entity.Core.Mapping
{
    internal class MetadataMappingHasherVisitor : BaseMetadataMappingVisitor
    {
        ...
        private Dictionary<Object, int> m_itemsAlreadySeen = [];
        ...
        protected override void Visit(EntityContainerMapping entityContainerMapping)
        {
            ...
            if (!AddObjectToSeenListAndHashBuilder(entityContainerMapping, out var index))
            {
        ...
        {
            if (!AddObjectToSeenListAndHashBuilder(entityContainer, out var index))
            {
                return;
            }
        ...
        {
            if (!AddObjectToSeenListAndHashBuilder(setMapping, out var index))
            {
                return;
            }
        ...
        {
            if (!AddObjectToSeenListAndHashBuilder(typeMapping, out var index))
            {
                return;
            }
        ...
        {
            if (!AddObjectToSeenListAndHashBuilder(mappingFragment, out var index))
            {
                return;
            }
        ...
        {
            if (!AddObjectToSeenListAndHashBuilder(complexPropertyMapping, out var index))
            {
                return;
            }
        ...
        {
            if (!AddObjectToSeenListAndHashBuilder(complexTypeMapping, out var index))
            {
                return;
            }
        ...
        {
            if (!AddObjectToSeenListAndHashBuilder(conditionPropertyMapping, out var index))
            {
                return;
            }
        ...
        {
            if (!AddObjectToSeenListAndHashBuilder(scalarPropertyMapping, out var index))
            {
                return;
            }
        ...
        {
            if (!AddObjectToSeenListAndHashBuilder(entitySet, out var index))
            {
                return;
            }
        ...
        {
            if (!AddObjectToSeenListAndHashBuilder(associationSet, out var index))
            {
                return;
            }
        ...
        {
            if (!AddObjectToSeenListAndHashBuilder(entityType, out var index))
            {
                return;
            }
        ...
        {
            if (!AddObjectToSeenListAndHashBuilder(associationSetEnd, out var index))
            {
                return;
            }
        ...
        {
            if (!AddObjectToSeenListAndHashBuilder(associationType, out var index))
            {
                return;
            }
        ...
        {
            if (!AddObjectToSeenListAndHashBuilder(edmProperty, out var index))
            {
                return;
            }
        ...
        {
            if (!AddObjectToSeenListAndHashBuilder(edmMember, out var index))
            {
                return;
            }
        ...
        {
            if (!AddObjectToSeenListAndHashBuilder(associationEndMember, out var index))
            {
                return;
            }
        ...
        {
            if (!AddObjectToSeenListAndHashBuilder(referentialConstraint, out var index))
            {
                return;
            }
        ...
        {
            if (!AddObjectToSeenListAndHashBuilder(relationshipEndMember, out var index))
            {
                return;
            }
        ...
        {
            if (!AddObjectToSeenListAndHashBuilder(typeUsage, out var index))
            {
                return;
            }
        ...
        {
            if (!AddObjectToSeenListAndHashBuilder(enumType, out var index))
            {
                return;
            }
        ...
        {
            if (!AddObjectToSeenListAndHashBuilder(enumMember, out var index))
            {
                return;
            }
        ...
        {
            if (!AddObjectToSeenListAndHashBuilder(collectionType, out var index))
            {
                return;
            }
        ...
        {
            if (!AddObjectToSeenListAndHashBuilder(refType, out var index))
            {
                return;
            }
        ...
        protected override void Visit(Facet facet)
        {
            ...
            if (!AddObjectToSeenListAndHashBuilder(facet, out var index))
            {
                return;
            }
        ...
        {
            if (!AddObjectToSeenListAndHashBuilder(complexType, out var index))
            {
                return;
            }
        ...
        {
            if (!AddObjectToSeenListAndHashBuilder(primitiveType, out var index))
            {
                return;
            }
        ...
        {
            if (!AddObjectToSeenListAndHashBuilder(functionParameter, out var index))
            {
                return;
            }
