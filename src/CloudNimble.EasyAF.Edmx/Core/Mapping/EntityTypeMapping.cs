...
namespace System.Data.Entity.Core.Mapping
{
    ...
    public class EntityTypeMapping : TypeMapping
    {
        ...
        // </summary>
        private readonly Dictionary<string, EntityType> m_entityTypes = new(StringComparer.Ordinal);

        // <summary>
        // Types for which the mapping holds true for not only the type specified but the sub-types of that type as well.
        // </summary>
        private readonly Dictionary<string, EntityType> m_isOfEntityTypes = new(StringComparer.Ordinal);
        ...
        {
            get { return _entityType ??= m_entityTypes.Values.SingleOrDefault(); }
        }
