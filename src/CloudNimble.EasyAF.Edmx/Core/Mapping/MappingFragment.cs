...
namespace System.Data.Entity.Core.Mapping
{
    ...
    {
        private readonly List<ColumnMappingBuilder> _columnMappings = [];
        ...
        internal void AddColumnMapping(ColumnMappingBuilder columnMappingBuilder)
        {
            ...
            for (; i < columnMappingBuilder.PropertyPath.Count - 1; i++)
            {
                ...
                if (complexPropertyMapping is null)
                {
            ...
            if (scalarPropertyMapping is null)
            {
        ...
        private readonly Dictionary<EdmProperty, ConditionPropertyMapping> m_conditionProperties =
            new(EqualityComparer<EdmProperty>.Default);

        // <summary>
        // All the other properties .
        // </summary>
        private readonly List<PropertyMapping> m_properties = [];
        ...
        {
            get { return GetFlattenedProperties(m_properties, []); }
        }
            ...
            IEnumerable<PropertyMapping> propertyMappings, List<EdmProperty> propertyPath)
        {
            ...
            foreach (var propertyMapping in propertyMappings)
            {
                ...
                if (storageComplexPropertyMapping is not null)
                {
                ...
                else
                {
                    ...
                    if (storageScalarPropertyMapping is not null)
                    {
            ...
            ConditionPropertyMapping conditionPropertyMap, Action<EdmMember> duplicateMemberConditionError)
        {
            ...
            Debug.Assert(conditionMember is not null);
