...
namespace System.Data.Entity.Core.Mapping.Update.Internal
{
    ...
    internal class ViewLoader
    {
        ...
        private readonly Set<EdmMember> m_serverGenProperties = [];
        private readonly Set<EdmMember> m_isNullConditionProperties = [];

        private readonly Dictionary<EntitySetBase, ModificationFunctionMappingTranslator> m_functionMappingTranslators = new(
            EqualityComparer<EntitySetBase>.Default);

        private readonly ReaderWriterLockSlim m_readerWriterLock = new();
        ...
        private static IEnumerable<EdmMember> FindIsNullConditionColumns(MappingFragment mappingFragment)
        {
            ...
            {
                if (conditionPropertyMapping.Column is not null
                    &&
