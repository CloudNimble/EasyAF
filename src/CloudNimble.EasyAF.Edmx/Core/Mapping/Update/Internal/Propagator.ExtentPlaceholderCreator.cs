    ...
    internal partial class Propagator
    {
        ...
        internal class ExtentPlaceholderCreator
        {
            ...
            private static readonly Lazy<Dictionary<PrimitiveTypeKind, object>> _spatialTypeDefaultMap =
                new(InitializeSpatialTypeDefaultMap);
            ...
            private static Dictionary<PrimitiveTypeKind, object> InitializeTypeDefaultMap()
            {
                    ...
                    EqualityComparer<PrimitiveTypeKind>.Default)
                {
                    ...
                    [PrimitiveTypeKind.Boolean] = default(Boolean),
                    [PrimitiveTypeKind.Byte] = default(Byte),
                    ...
                    [PrimitiveTypeKind.Decimal] = default(Decimal),
                    [PrimitiveTypeKind.Double] = default(Double),
                    [PrimitiveTypeKind.Guid] = default(Guid),
                    [PrimitiveTypeKind.Int16] = default(Int16),
                    [PrimitiveTypeKind.Int32] = default(Int32),
                    [PrimitiveTypeKind.Int64] = default(Int64),
                    [PrimitiveTypeKind.Single] = default(Single),
                    [PrimitiveTypeKind.SByte] = default(SByte),
            ...
            {
                if (!TryGetDefaultValue(primitiveType, out var value))
                {
