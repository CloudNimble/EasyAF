    ...
    public class AssociationTypeMapping : TypeMapping
    {
        ...
        public MappingFragment MappingFragment
        {
            ...
            internal set
            {
                ...
                Debug.Assert(_mappingFragment is null);
        ...
        internal override ReadOnlyCollection<MappingFragment> MappingFragments
        {
            ...
            {
                return
                    _mappingFragment is null
                        ? new ReadOnlyCollection<MappingFragment>([])
                        : new ReadOnlyCollection<MappingFragment>([_mappingFragment]);
            }
        }
        ...
        {
            get { return new ReadOnlyCollection<EntityTypeBase>([m_relation]); }
        }
        ...
        {
            get { return new ReadOnlyCollection<EntityTypeBase>([]); }
        }
