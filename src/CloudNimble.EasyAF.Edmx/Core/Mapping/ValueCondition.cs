...
namespace System.Data.Entity.Core.Mapping
{
    ...
    internal class ValueCondition : IEquatable<ValueCondition>
    {
        ...
        internal static readonly ValueCondition IsNull = new(IsNullDescription, true);
        internal static readonly ValueCondition IsNotNull = new(IsNotNullDescription, true);
        internal static readonly ValueCondition IsOther = new(IsOtherDescription, true);
