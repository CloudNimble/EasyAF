...
namespace System.Data.Entity.Core.Mapping
{
    ...
    public class ComplexTypeMapping : StructuralTypeMapping
    {
        ...
        private readonly Dictionary<string, ComplexType> m_types = new(StringComparer.Ordinal);
        //Types for which the mapping holds true for.

        private readonly Dictionary<string, ComplexType> m_isOfTypes = new(StringComparer.Ordinal);
        //Types for which the mapping holds true for
            ...
            ConditionPropertyMapping conditionPropertyMap, Action<EdmMember> duplicateMemberConditionError)
        {
            ...
            //same Complex Type.
            var conditionMember = (conditionPropertyMap.Property is not null)
        ...
        internal ComplexType GetOwnerType(string memberName)
        {
            ...
            {
                if ((type.Members.TryGetValue(memberName, false, out var tempMember))
