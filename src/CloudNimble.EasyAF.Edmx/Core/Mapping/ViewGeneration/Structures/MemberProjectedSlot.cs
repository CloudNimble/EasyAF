...
namespace System.Data.Entity.Core.Mapping.ViewGeneration.Structures
{
    ...
    internal sealed class MemberProjectedSlot : ProjectedSlot
    {
        ...
        {
            if (NeedToCastCqlValue(outputMember, out var outputMemberStoreTypeUsage))
            {
                builder.Append("CAST(");
        ...
        {
            if (remap.TryGetValue(MemberPath, out var remappedNode))
            {
        ...
        internal static List<MemberProjectedSlot> GetKeySlots(IEnumerable<MemberProjectedSlot> slots, MemberPath prefix)
        {
            ...
            Debug.Assert(entitySet is not null, "Prefix must have associated entity set");
