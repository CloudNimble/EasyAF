...
namespace System.Data.Entity.Core.Mapping.ViewGeneration.Structures
{
    ...
    internal partial class BoolExpression : InternalBase
    {
        ...
        {
            return new BoolExpression(ExprType.Not, [expression]);
        }
        ...
        private BoolExpression(ExprType opType, IEnumerable<BoolExpression> children)
        {
            ...
            {
                if (child.m_memberDomainMap is not null)
                {
        ...
        internal static readonly BoolExpression True = new(true);
        internal static readonly BoolExpression False = new(false);
        ...
        internal IEnumerable<MemberRestriction> MemberRestrictions
        {
            get
            {
                foreach (var var in Variables)
                {
                    ...
                    if (variableCondition is not null)
                    {
        ...
        internal BoolExpression RemapLiterals(Dictionary<BoolLiteral, BoolLiteral> remap)
        {
            var rewriter = new BooleanExpressionTermRewriter<BoolDomainConstraint, BoolDomainConstraint>(
                ...
                delegate(DomainTermExpr term)
                    {
                        return remap.TryGetValue(GetBoolLiteral(term), out var newLiteral)
        ...
        private static readonly CopyVisitor _copyVisitorInstance = new();
        ...
        private bool IsFinal()
        {
            ...
            return (m_memberDomainMap is not null && IsFinalVisitor.IsFinal(m_tree));
        }
