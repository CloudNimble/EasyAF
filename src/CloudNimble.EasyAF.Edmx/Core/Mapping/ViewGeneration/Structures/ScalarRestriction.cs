        ...
        internal override DbExpression AsCqt(DbExpression row, bool skipIsNotNull)
        {
            ...
            AsCql(
                ...
                (negated, domainValues) =>
                    {
                        Debug.Assert(cqt is null, "unexpected construction order - cqt must be null");
                ...
                () =>
                    {
                        ...
                        cqt = cqt is not null ? cqt.And(varIsNotNull) : varIsNotNull;
                    },
                // varIsNull action
                () =>
                    {
                        ...
                        cqt = cqt is not null ? varIsNull.Or(cqt) : varIsNull;
                    },
                skipIsNotNull);
