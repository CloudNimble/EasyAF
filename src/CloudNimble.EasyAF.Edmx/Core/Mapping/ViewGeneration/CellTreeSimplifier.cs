...
namespace System.Data.Entity.Core.Mapping.ViewGeneration
{
    ...
    internal class CellTreeSimplifier : InternalBase
    {
        ...
        private CellTreeNode RestructureTreeForMerges(CellTreeNode rootNode)
        {
            ...
            if (commonGrandChildren is null)
            {
                return rootNode;
            }
            ...
            CellTreeNode node2)
        {
            ...
            Debug.Assert(leaf1 is not null, "Merge only possible on leaf nodes (1)");
            Debug.Assert(leaf2 is not null, "Merge only possible on leaf nodes (2)");

            if (
                !TryMergeTwoCellQueries(
                    leaf1.LeftCellWrapper.RightCellQuery, leaf2.LeftCellWrapper.RightCellQuery, opType, out var mergedRightCellQuery))
            {
                return false;
            }
            ...
            if (
                !TryMergeTwoCellQueries(
                    leaf1.LeftCellWrapper.LeftCellQuery, leaf2.LeftCellWrapper.LeftCellQuery, opType, out var mergedLeftCellQuery))
            {
                return false;
            }
            ...
            out CellQuery mergedQuery)
        {
            ...
            switch (opType)
            {
                case CellTreeOpType.IJ:
                    ...
                    Debug.Assert(g1 is null && g2 is null, "IJ does not affect g1 and g2");
                ...
                case CellTreeOpType.LOJ:
                    ...
                    Debug.Assert(g1 is null, "LOJ does not affect g1");
                ...
                case CellTreeOpType.LASJ:
                    ...
                    Debug.Assert(g1 is null, "LASJ does not affect g1");
                    conjunct2 = BoolExpression.CreateAnd(query2.WhereClause, g2);
            ...
            if (false == ProjectedSlot.TryMergeRemapSlots(query1.ProjectedSlots, query2.ProjectedSlots, out var mergedSlots))
            {
        ...
        // null and query2's bools[i] is not null
