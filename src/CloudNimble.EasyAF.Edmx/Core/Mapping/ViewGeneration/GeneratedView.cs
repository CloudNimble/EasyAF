...
namespace System.Data.Entity.Core.Mapping.ViewGeneration
{
    ...
    internal sealed class GeneratedView : InternalBase
    {
            ...
            out GeneratedView generatedView)
        {
            ...
            if (
                !TryParseView(
                    eSQL, true, setMapping.Set, mappingItemCollection, config, out var commandTree, out var discriminatorMap, out var parserException))
            {
            ...
            {
                Debug.Assert(commandTree is not null, "commandTree not set after parsing the view");
            ...
            ConfigViewGenerator config)
        {
            ...
            Debug.Assert(commandTree is not null || !String.IsNullOrEmpty(eSQL), "commandTree or eSQL must be specified");
        ...
        internal DbQueryCommandTree GetCommandTree()
        {
            if (m_commandTree is null)
            {
                ...
                if (TryParseView(
                    ...
                    out var parserException))
                {
                    Debug.Assert(m_commandTree is not null, "m_commandTree not set after parsing the view");
            ...
            out Exception parserException)
        {
            ...
            Debug.Assert(commandTree is not null || parserException is not null, "Either commandTree or parserException is expected.");
            ...
            return parserException is null;
        }
