...
namespace System.Data.Entity.Core.Mapping.ViewGeneration
{
    ...
    internal sealed class CqlGenerator : InternalBase
    {
        ...
        internal DbQueryCommandTree GenerateCqt()
        {
            ...
            Debug.Assert(query is not null, "Null CQT generated for query/update view.");
        ...
        private void GetRequiredSlotsForCaseMember(MemberPath caseMemberPath, bool[] requiredSlots)
        {
            ...
            else
            {
                ...
                Debug.Assert(refType is not null, "What other non scalars do we have? Relation end must be a reference type");
