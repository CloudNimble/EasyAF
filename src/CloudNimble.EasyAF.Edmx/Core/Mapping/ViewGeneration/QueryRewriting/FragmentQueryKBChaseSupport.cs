...
using DomainBoolExpr =
        System.Data.Entity.Core.Common.Utils.Boolean.BoolExpr
            <System.Data.Entity.Core.Common.Utils.Boolean.DomainConstraint<System.Data.Entity.Core.Mapping.ViewGeneration.Structures.BoolLiteral, System.Data.Entity.Core.Mapping.ViewGeneration.Structures.Constant>>;
...
namespace System.Data.Entity.Core.Mapping.ViewGeneration.QueryRewriting
{
    ...
    internal class FragmentQueryKBChaseSupport : FragmentQueryKB
    {
        ...
        private Set<DomainBoolExpr> _residualFacts = [];
        private int _kbSize;
        ...
        {
            Implications.TryGetValue(expression, out var implication);
        ...
        private static class Normalizer
        {
            ...
            {
                internal static readonly NonNegatedTreeVisitor Instance = new();
                ...
                internal override DomainBoolExpr VisitTerm(TermExpr<DomainConstraint> expression)
                {
                    ...
                    {
                        split.Add(new DomainConstraint(variable, new Set<Constant>([element], Constant.EqualityComparer)));
                    }
            ...
            {
                internal static readonly NegatedTreeVisitor Instance = new();
            ...
            {
                internal static readonly NonNegatedNnfSplitCounter Instance = new();
            ...
            {
                internal static readonly NegatedNnfSplitCountEstimator Instance = new();
            ...
            {
                internal static readonly DnfTreeVisitor Instance = new();
                ...
                internal override DomainBoolExpr VisitAnd(AndExpr<DomainConstraint> expression)
                {
                    ...
                    IEnumerable<IEnumerable<DomainBoolExpr>> emptyProduct = [Enumerable.Empty<DomainBoolExpr>()];
                    var product =
                        buckets.Aggregate(
                            emptyProduct,
                            (accumulator, bucket) =>
