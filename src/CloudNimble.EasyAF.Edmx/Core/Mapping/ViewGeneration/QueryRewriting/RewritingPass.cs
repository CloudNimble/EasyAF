...
namespace System.Data.Entity.Core.Mapping.ViewGeneration.QueryRewriting
{
        ...
        where T_Tile : class
    {
        ...
        private bool RewriteQuery(out T_Tile rewriting)
        {
            ...
            if (false == FindRewritingByIncludedAndDisjoint(out var rewritingSoFar))
            {
            ...
            if (!m_qp.IsEmpty(missingTuples))
            {
                if (false
                    ...
                    RewriteQueryInternal(
                        missingTuples, m_toAvoid, out var rewritingForMissingTuples, m_views, m_qp))
                {
        ...
        private bool FindRewritingByIncludedAndDisjoint(out T_Tile rewritingSoFar)
        {
            ...
            return rewritingSoFar is not null;
        }
