...
using System.Linq;
using System.Text;
using ViewSet = System.Data.Entity.Core.Common.Utils.KeyToListMap<System.Data.Entity.Core.Metadata.Edm.EntitySetBase, System.Data.Entity.Core.Mapping.ViewGeneration.GeneratedView>;
using CellGroup = System.Data.Entity.Core.Common.Utils.Set<System.Data.Entity.Core.Mapping.ViewGeneration.Structures.Cell>;
...
namespace System.Data.Entity.Core.Mapping.ViewGeneration
{
    ...
    internal class ViewGenerator : InternalBase
    {
        ...
        {
            if (!m_queryRewriterCache.TryGetValue(extent, out var queryRewriter))
            {
        ...
        private void CheckForeignKeyConstraints(ErrorLog errorLog)
        {
            ...
            {
                m_queryRewriterCache.TryGetValue(constraint.ChildTable, out var childRewriter);
                m_queryRewriterCache.TryGetValue(constraint.ParentTable, out var parentRewriter);
