...
namespace System.Data.Entity.Core.Mapping.ViewGeneration.CqlGeneration
{
    ...
    internal sealed class CaseCqlBlock : CqlBlock
    {
        ...
        internal CaseCqlBlock(
            ...
            : base(slots, new List<CqlBlock>([child]), whereClause, identifiers, blockAliasNum)
        {
        ...
        internal override StringBuilder AsEsql(StringBuilder builder, bool isTopLevel, int indentLevel)
        {
            ...
            Debug.Assert(m_caseSlotInfo.OutputMember is not null, "We only construct member slots, not boolean slots.");
        ...
        {
            Debug.Assert(m_caseSlotInfo.OutputMember is not null, "We only construct real slots not boolean slots");
