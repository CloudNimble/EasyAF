...
namespace System.Data.Entity.Core.Mapping.ViewGeneration.CqlGeneration
{
    ...
    internal sealed class SlotInfo : InternalBase
    {
        ...
        internal SlotInfo(bool isRequiredByParent, bool isProjected, ProjectedSlot slotValue, MemberPath outputMember, bool enforceNotNull)
        {
            ...
            Debug.Assert(false == m_isRequiredByParent || m_slotValue is not null, "Required slots cannot be null");
            Debug.Assert(
                m_slotValue is QualifiedSlot ||
                (m_slotValue is null && m_outputMember is null) || // unused boolean slot
                (m_slotValue is BooleanProjectedSlot) == (m_outputMember is null),
        ...
        {
            get { return m_slotValue is not null ? m_slotValue.GetCqlFieldAlias(m_outputMember) : null; }
        }
