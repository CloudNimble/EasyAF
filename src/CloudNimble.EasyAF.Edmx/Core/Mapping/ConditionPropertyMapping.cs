...
namespace System.Data.Entity.Core.Mapping
{
    ...
    public class ConditionPropertyMapping : PropertyMapping
    {
        ...
        internal ConditionPropertyMapping(EdmProperty propertyOrColumn, object value, bool? isNull)
        {
            ...
            Debug.Assert((isNull.HasValue) || (value is not null), "Either Value or IsNull has to be specified on Condition Mapping");
            Debug.Assert(!(isNull.HasValue) || (value is null), "Both Value and IsNull can not be specified on Condition Mapping");
        ...
        internal ConditionPropertyMapping(
            ...
            : base(property)
        {
            Debug.Assert(column is null || column.TypeUsage.EdmType.DataSpace == DataSpace.SSpace);
            Debug.Assert(
                (property is not null) || (column is not null), "Either CDM or Column Members has to be specified for Condition Mapping");
            Debug.Assert(
                (property is null) || (column is null), "Both CDM and Column Members can not be specified for Condition Mapping");
            Debug.Assert((isNull.HasValue) || (value is not null), "Either Value or IsNull has to be specified on Condition Mapping");
            Debug.Assert(!(isNull.HasValue) || (value is null), "Both Value and IsNull can not be specified on Condition Mapping");
