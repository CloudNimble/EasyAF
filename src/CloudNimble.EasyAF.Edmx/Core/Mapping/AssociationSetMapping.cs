    ...
    public class AssociationSetMapping : EntitySetBaseMapping
    {
        ...
        public AssociationTypeMapping AssociationTypeMapping 
        {
            ...
            internal set
            {
                ...
                Debug.Assert(_associationTypeMapping is null);
        ...
        {
            get { return (SingleFragment is not null) ? SingleFragment.StoreEntitySet : null; }

            internal set
            {
                DebugCheck.NotNull(value);
                Debug.Assert(SingleFragment is not null);
                Debug.Assert(!IsReadOnly);
        ...
        {
            get { return (StoreEntitySet is not null ? StoreEntitySet.ElementType : null); }
        }
        ...
        public EndPropertyMapping TargetEndMapping
        {
            get
            {
                return (SingleFragment is not null)
        ...
        private MappingFragment SingleFragment
        {
            get
            {
                return (_associationTypeMapping is not null)
                           ? _associationTypeMapping.MappingFragment
                           : null;
            }
        }
