...
namespace System.Data.Entity.Core.Metadata.Edm
{
    ...
    public class EntityType : EntityTypeBase
    {
        ...
        private readonly List<ForeignKeyBuilder> _foreignKeyBuilders = [];
        ...
        private readonly object _navigationPropertiesCacheLock = new();
        ...
        public ReadOnlyMetadataCollection<NavigationProperty> NavigationProperties
        {
            get
            {
                ...
                if (navigationProperties is null)
                {
                    ...
                    {
                        if (_navigationPropertiesCache is null)
                        {
        ...
        {
            if (_navigationPropertiesCache is not null)
            {
                lock (_navigationPropertiesCacheLock)
                {
                    if (_navigationPropertiesCache is not null)
