...
namespace System.Data.Entity.Core.Metadata.Edm
{
    ...
    public sealed class AssociationSet : RelationshipSet
    {
        ...
        private readonly ReadOnlyMetadataCollection<AssociationSetEnd> _associationSetEnds
            = new(new MetadataCollection<AssociationSetEnd>());
        ...
        internal EntitySet SourceSet
        {
            get
            {
                ...
                return (associationSetEnd is not null)
            ...
            set
            {
                ...
                Debug.Assert(ElementType.SourceEnd is not null);
        ...
        internal EntitySet TargetSet
        {
            ...
            set
            {
                ...
                Debug.Assert(ElementType.TargetEnd is not null);
            ...
            IEnumerable<MetadataProperty> metadataProperties)
        {
            ...
            if (metadataProperties is not null)
            {
        ...
        {
            return (entitySet is null && endMember is null)
                || (entitySet is not null && endMember is not null && entitySet.ElementType == endMember.GetEntityType());
        }
    }
}
