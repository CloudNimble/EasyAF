    ...
    internal static class Converter
    {
            ...
            ConversionCache convertedItemCache, Dictionary<SchemaElement, GlobalItem> newGlobalItems)
        {
            ...
            else
            {
                ...
                if (storeCollection is not null)
                {
            ...
            Dictionary<SchemaElement, GlobalItem> newGlobalItems)
        {
            ...
            Debug.Assert(
                !convertedItemCache.ItemCollection.TryGetValue(element.FQName, false, out var item),
            ...
            if (entityContainer is not null)
            {
            ...
            Dictionary<SchemaElement, GlobalItem> newGlobalItems)
        {
            ...
            if (element.BaseType is not null)
            {
            ...
            Dictionary<SchemaElement, GlobalItem> newGlobalItems)
        {
            ...
            foreach (RelationshipEnd end in element.Ends)
            {
                ...
                if (end.Documentation is not null)
                {
            ...
            EntityType endMemberType)
        {
            ...
            if (!associationType.Members.TryGetValue(end.Name, false /*ignoreCase*/, out var member))
            {
            ...
            if (relationshipEnd is not null
                && (relationshipEnd.Documentation is not null))
            {
            ...
            Dictionary<SchemaElement, GlobalItem> newGlobalItems)
        {
            ...
            // Extract the optional Documentation
            if (set.Documentation is not null)
            {
            ...
            Dictionary<SchemaElement, GlobalItem> newGlobalItems)
        {
            ...
            // Extract the optional Documentation
            if (relationshipSet.Documentation is not null)
            {
            ...
            Dictionary<SchemaElement, GlobalItem> newGlobalItems)
        {
            ...
            else
            {
                ...
                {
                    var enumType = scalarType is null ? somProperty.Type as SchemaEnumType : null;
                    ...
                    if (somProperty.TypeUsage is not null)
                    {
            ...
            // Extract the optional Documentation
            if (somProperty.Documentation is not null)
            {
            ...
            Dictionary<SchemaElement, GlobalItem> newGlobalItems)
        {
            ...
            somNavigationProperty.Relationship.TryGetEnd(somNavigationProperty.ToEnd.Name, out var somRelationshipEnd);
            ...
            // Extract the optional Documentation
            if (somNavigationProperty.Documentation is not null)
            {
            ...
            Dictionary<SchemaElement, GlobalItem> newGlobalItems)
        {
            ...
            if (!somFunction.IsFunctionImport
                && newGlobalItems.TryGetValue(somFunction, out var globalItem))
            {
            ...
            if (somFunction.ReturnTypeList is not null)
            {
                var i = 0;
            ...
            else if (somFunction.Type is not null)
            {
                var returnType = GetFunctionTypeUsage(
                    somFunction is ModelFunction,
                    somFunction,
            ...
            if (somFunction.IsFunctionImport)
            {
                ...
                if (null != somFunctionImport.EntitySet)
                {
                    ...
                    Debug.Assert(
                        somFunctionImport.ReturnTypeList is null || somFunctionImport.ReturnTypeList.Count == 1,
                        "EntitySet cannot be specified on a FunctionImport if there are multiple ReturnType children");

                    Debug.Assert(
                        functionImportEntityContainer is not null,
                        "functionImportEntityContainer must be specified during function import conversion");
                    entityContainer = functionImportEntityContainer;
                    entitySets = [GetEntitySet(somFunctionImport.EntitySet, entityContainer)];
                }
            ...
            foreach (var somParameter in somFunction.Parameters)
            {
                ...
                if (somParameter.Documentation is not null)
                {
            ...
            Debug.Assert(
                !convertedItemCache.ItemCollection.TryGetValue(function.Identity, false, out var returnFunction),
                "Function duplicates must be checked by som");

            // Extract the optional Documentation
            if (somFunction.Documentation is not null)
            {
        ...
        private static EnumType ConvertToEnumType(SchemaEnumType somEnumType, Dictionary<SchemaElement, GlobalItem> newGlobalItems)
        {
            ...
            {
                Debug.Assert(somEnumMember.Value is not null, "value must not be null at this point");
                ...
                if (somEnumMember.Documentation is not null)
                {
            ...
            if (somEnumType.Documentation is not null)
            {
            ...
            Dictionary<SchemaElement, GlobalItem> newGlobalItems)
        {
            ...
            if (!areConvertingForProviderManifest)
            {
                ...
                if (null != scalarType)
                {
                    if (isModelFunction && somParameter is not null)
                    {
                        if (somParameter.TypeUsage is null)
                        {
                    ...
                    else if (isModelFunction)
                    {
                        ...
                        if (modelFunction.TypeUsage is null)
                        {
                ...
                else
                {
                    ...
                    if (isModelFunction && type is SchemaEnumType)
                    {
                        ...
                        if (somParameter is not null)
                        {
                            somParameter.ValidateAndSetTypeUsage(edmType);
                            return somParameter.TypeUsage;
                        }
                        else if (somFunction is not null)
                        {
            ...
            else
            {
                ...
                if (entityType is not null && isRefType)
                {
        ...
        private static void ApplyTypePropertyFacets(TypeUsage sourceType, ref TypeUsage targetType)
        {
            ...
            {
                if (newFacets.TryGetValue(sourceFacet.Name, out var targetFacet))
                {
            ...
            ref TypeUsage propertyTypeUsage)
        {
            ...
            if (somProperty.Default is not null)
            {
            ...
            DbProviderManifest providerManifest)
        {
            ...
            Debug.Assert(scalarType is not null, "Som scalar type should always resolve to a primitive type");
            return returnValue;
        }
        ...
        internal class ConversionCache
        {
            ...
            internal TypeUsage GetTypeUsageWithNullFacets(EdmType edmType)
            {
                ...
                if (_nullFacetsTypeUsage.TryGetValue(edmType, out var result))
                {
                    return result;
                }
            ...
            {
                // check for cached result
                if (_nullFacetsCollectionTypeUsage.TryGetValue(edmType, out var result))
                {
                    return result;
                }
