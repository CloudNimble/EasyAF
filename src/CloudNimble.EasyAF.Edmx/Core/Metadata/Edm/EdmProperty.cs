    ...
    public class EdmProperty : EdmMember
    {
        ...
        internal bool IsKeyMember
        {
            get
            {
                ...
                return (parentEntityType is not null) && parentEntityType.KeyMembers.Contains(this);
            }
        }
        ...
        public PrimitiveType PrimitiveType
        {
            ...
            internal set
            {
                ...
                {
                    if (TypeUsage.Facets.TryGetValue(facetDescription.FacetName, false, out var facet)
                        && ((facet.Value is null && facet.Description.DefaultValue is not null)
                            || (facet.Value is not null && !facet.Value.Equals(facet.Description.DefaultValue))))
                    {
        ...
        public CollectionKind CollectionKind
        {
            get
            {
                return TypeUsage.Facets.TryGetValue(EdmConstants.CollectionKind, false, out var facet)
        ...
        public bool IsMaxLengthConstant
        {
            ...
            {
                return
                    TypeUsage.Facets.TryGetValue(DbProviderManifest.MaxLengthFacetName, false, out var facet)
        ...
        public int? MaxLength
        {
            get
            {
                return TypeUsage.Facets.TryGetValue(DbProviderManifest.MaxLengthFacetName, false, out var facet)
                           ? facet.Value as int?
                           : null;
            }
            set
        ...
        public bool IsFixedLengthConstant
        {
            ...
            {
                return
                    TypeUsage.Facets.TryGetValue(DbProviderManifest.FixedLengthFacetName, false, out var facet)
                    && facet.Description.IsConstant;
            }
        }
        ...
        public bool? IsFixedLength
        {
            get
            {
                return TypeUsage.Facets.TryGetValue(DbProviderManifest.FixedLengthFacetName, false, out var facet)
                           ? facet.Value as bool?
                           : null;
            }
            set
        ...
        public bool IsUnicodeConstant
        {
            ...
            {
                return
                    TypeUsage.Facets.TryGetValue(DbProviderManifest.UnicodeFacetName, false, out var facet)
                    && facet.Description.IsConstant;
            }
        }
        ...
        public bool? IsUnicode
        {
            get
            {
                return TypeUsage.Facets.TryGetValue(DbProviderManifest.UnicodeFacetName, false, out var facet)
                           ? facet.Value as bool?
                           : null;
            }
            set
        ...
        public bool IsPrecisionConstant
        {
            ...
            {
                return
                    TypeUsage.Facets.TryGetValue(DbProviderManifest.PrecisionFacetName, false, out var facet)
                    && facet.Description.IsConstant;
            }
        }
        ...
        public byte? Precision
        {
            get
            {
                return TypeUsage.Facets.TryGetValue(DbProviderManifest.PrecisionFacetName, false, out var facet)
                           ? facet.Value as byte?
                           : null;
            }
            set
        ...
        public bool IsScaleConstant
        {
            ...
            {
                return
                    TypeUsage.Facets.TryGetValue(DbProviderManifest.ScaleFacetName, false, out var facet)
                    && facet.Description.IsConstant;
            }
        }
        ...
        public byte? Scale
        {
            get
            {
                return TypeUsage.Facets.TryGetValue(DbProviderManifest.ScaleFacetName, false, out var facet)
                           ? facet.Value as byte?
                           : null;
            }
            set
