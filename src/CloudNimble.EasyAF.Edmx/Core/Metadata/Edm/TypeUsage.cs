...
namespace System.Data.Entity.Core.Metadata.Edm
{
    ...
    public class TypeUsage : MetadataItem
    {
        ...
        /// <summary>
        /// Creates a <see cref="T:System.Data.Entity.Core.Metadata.Edm.TypeUsage" /> object to describe a DateOnly type.
        /// </summary>
        /// <returns>
        /// A <see cref="T:System.Data.Entity.Core.Metadata.Edm.TypeUsage" /> object describing a DateOnly type.
        /// </returns>
        /// <param name="primitiveType">
        /// A <see cref="T:System.Data.Entity.Core.Metadata.Edm.PrimitiveType" /> for which the
        /// <see cref="T:System.Data.Entity.Core.Metadata.Edm.TypeUsage" /> object is created.
        /// </param>
        public static TypeUsage CreateDateOnlyTypeUsage(PrimitiveType primitiveType)
        {
            Check.NotNull(primitiveType, "primitiveType");

            if (primitiveType.PrimitiveTypeKind != PrimitiveTypeKind.DateOnly)
            {
                throw new ArgumentException("Type usage is not a DateOnly type");
            }
        ...
        /// <summary>
        /// Creates a <see cref="T:System.Data.Entity.Core.Metadata.Edm.TypeUsage" /> object to describe a TimeOnly type with optional precision.
        /// </summary>
        /// <returns>
        /// A <see cref="T:System.Data.Entity.Core.Metadata.Edm.TypeUsage" /> object describing a TimeOnly type.
        /// </returns>
        /// <param name="primitiveType">
        /// A <see cref="T:System.Data.Entity.Core.Metadata.Edm.PrimitiveType" /> for which the
        /// <see cref="T:System.Data.Entity.Core.Metadata.Edm.TypeUsage" /> object is created.
        /// </param>
        /// <param name="precision">
        /// The degree of granularity of the TimeOnly in fractions of a second, based on the number of decimal places supported.
        /// </param>
        public static TypeUsage CreateTimeOnlyTypeUsage(PrimitiveType primitiveType, byte? precision = null)
        {
            Check.NotNull(primitiveType, "primitiveType");

            if (primitiveType.PrimitiveTypeKind != PrimitiveTypeKind.TimeOnly)
            {
                throw new ArgumentException("Type usage is not a TimeOnly type");
            }
        ...
        // </remarks>
        private static readonly string[] _identityFacets =
            [
            ...
            FacetValues values)
        {
            ...
            foreach (var thing in facetThings)
            {
                ...
                if (!description.IsConstant
                    && values.TryGetFacet(description, out var facet))
                {
                    yield return facet;
                }
                else
        ...
        internal override bool EdmEquals(MetadataItem item)
        {
            ...
            {
                if (!other.Facets.TryGetValue(thisFacet.Name, false, out var otherFacet))
                {
