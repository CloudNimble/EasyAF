    ...
    internal static class EdmModelSemanticValidationRules
    {
        ...
        internal static readonly EdmModelValidationRule<EntityContainer> EdmEntityContainer_InvalidEntitySetNameReference =
            new(
                (context, edmEntityContainer) =>
                    {
                        if (edmEntityContainer.AssociationSets is not null)
                        {
                            foreach (var associationSet in edmEntityContainer.AssociationSets)
                            {
                                if (associationSet.SourceSet is not null
                                    && associationSet.ElementType is not null
                                    && associationSet.ElementType.SourceEnd is not null)
                                {
                                ...
                                if (associationSet.TargetSet is not null
                                    && associationSet.ElementType is not null
                                    && associationSet.ElementType.TargetEnd is not null)
                                {
                ...
                (context, edmEntityContainer) =>
                    {
                        ...
                        foreach (var entitySet in edmEntityContainer.EntitySets)
                        {
                            if (entitySet is not null
                                && entitySet.ElementType is not null
                        ...
                        {
                            if (TypeIsSubTypeOf(entityType, baseEntitySetTypes, out var set)
        ...
        internal static readonly EdmModelValidationRule<EntitySet> EdmEntitySet_EntitySetTypeHasNoKeys =
            new(
                (context, edmEntitySet) =>
                    {
                        if (edmEntitySet.ElementType is not null)
                        {
        ...
        internal static readonly EdmModelValidationRule<AssociationSet> EdmAssociationSet_DuplicateEndName =
            new(
                (context, edmAssociationSet) =>
                    {
                        if (edmAssociationSet.ElementType is not null
                            && edmAssociationSet.ElementType.SourceEnd is not null
                            && edmAssociationSet.ElementType.TargetEnd is not null)
                        {
        ...
        internal static readonly EdmModelValidationRule<EntityType> EdmEntityType_InvalidKeyKeyDefinedInBaseClass =
            new(
                (context, edmEntityType) =>
                    {
                        if (edmEntityType.BaseType is not null
                            &&
        ...
        internal static readonly EdmModelValidationRule<EntityType> EdmEntityType_KeyMissingOnEntityType =
            new(
                (context, edmEntityType) =>
                    {
                        if (edmEntityType.BaseType is null
        ...
        internal static readonly EdmModelValidationRule<NavigationProperty> EdmNavigationProperty_BadNavigationPropertyUndefinedRole =
            new(
                (context, edmNavigationProperty) =>
                    {
                        if (edmNavigationProperty.Association is not null
                            && edmNavigationProperty.Association.SourceEnd is not null
                            && edmNavigationProperty.Association.TargetEnd is not null
                            && edmNavigationProperty.Association.SourceEnd.Name is not null
                            && edmNavigationProperty.Association.TargetEnd.Name is not null)
                        {
                ...
                (context, edmNavigationProperty) =>
                    {
                        ...
                        if (edmNavigationProperty.Association is not null
                            && (fromEnd = edmNavigationProperty.GetFromEnd()) is not null)
                        {
        ...
        internal static readonly EdmModelValidationRule<AssociationType> EdmAssociationType_InvalidOperationMultipleEndsInAssociation =
            new(
                (context, edmAssociationType) =>
                    {
                        if ((edmAssociationType.SourceEnd is not null
                             && edmAssociationType.SourceEnd.DeleteBehavior != OperationAction.None)
                            &&
                            (edmAssociationType.TargetEnd is not null
                    ...
                    (context, edmAssociationType) =>
                        {
                            ...
                            if (edmAssociationType.TargetEnd is not null)
                            {
                ...
                (context, edmAssociationType) =>
                    {
                        if (IsReferentialConstraintReadyForValidation(edmAssociationType))
                        {
                            ...
                            IsKeyProperty(
                                ...
                                dependentRoleEnd,
                                out var isPrincipalRoleKeyProperty,
                                out var areAllDependentRolePropertiesNullable,
                                out var isAnyDependentRolePropertyNullable,
                                out var isDependentRolePropertiesSubsetofKeyProperties);
                            ...
                            IsKeyProperty(
                                ...
                                principalRoleEnd,
                                out var isDependentRoleKeyProperty,
                                out var areAllPrinicipalRolePropertiesNullable,
                                out var isAnyPrinicipalRolePropertyNullable,
                                out var isPrinicipalRolePropertiesSubsetofKeyProperties);
                            ...
                            else
                            {
                                ...
                                for (var i = 0; i < count; i++)
                                {
                                    ...
                                    if (principalProperty is not null
                                        && dependentProperty is not null
                                        && principalProperty.TypeUsage is not null
                                        && dependentProperty.TypeUsage is not null
        ...
        internal static readonly EdmModelValidationRule<AssociationType> EdmAssociationType_InvalidPropertyInRelationshipConstraint =
            new(
                (context, edmAssociationType) =>
                    {
                        if (edmAssociationType.Constraint is not null
                            &&
                            edmAssociationType.Constraint.ToRole is not null
                            &&
                            edmAssociationType.Constraint.ToRole.GetEntityType() is not null)
                        {
        ...
        internal static readonly EdmModelValidationRule<ComplexType> EdmComplexType_InvalidIsPolymorphic =
            new(
                (context, edmComplexType) =>
                    {
                        if (edmComplexType.BaseType is not null)
                        {
                            context.AddError(
                                edmComplexType,
                ...
                (context, edmProperty) =>
                    {
                        if (edmProperty.CollectionKind != CollectionKind.None
                            &&
                            edmProperty.TypeUsage is not null
        ...
        internal static readonly EdmModelValidationRule<EdmProperty> EdmProperty_NullableComplexType =
            new(
                (context, edmProperty) =>
                    {
                        if (edmProperty.TypeUsage is not null)
                        {
                            if (edmProperty.ComplexType is not null)
                            {
        ...
        internal static readonly EdmModelValidationRule<EdmProperty> EdmProperty_InvalidPropertyType =
            new(
                (context, edmProperty) =>
                    {
                        if (edmProperty.TypeUsage.EdmType is not null)
                        {
                ...
                (context, edmProperty) =>
                    {
                        if (edmProperty.TypeUsage is not null
                            &&
                            edmProperty.TypeUsage.EdmType is not null)
                        {
                            if (!edmProperty.IsPrimitiveType
                                &&
                                !edmProperty.IsComplexType
        ...
        private static bool IsReferentialConstraintReadyForValidation(AssociationType association)
        {
            ...
            if (constraint.FromRole is null
                || constraint.ToRole is null)
            {
                return false;
            }

            if (constraint.FromRole.GetEntityType() is null
                || constraint.ToRole.GetEntityType() is null)
            {
                return false;
            }
            ...
            if (constraint.ToProperties.Any())
            {
                foreach (var propRef in constraint.ToProperties)
                {
                    ...
                    if (propRef.TypeUsage is null
                        || propRef.TypeUsage.EdmType is null)
                    {
                        return false;
                    }
                }
            ...
            {
                return keyList.All(
                    propRef => propRef is not null
                               && propRef.TypeUsage is not null
                               && propRef.TypeUsage.EdmType is not null);
            }
        ...
        {
            return entityType.DeclaredProperties.Where(property => property.TypeUsage is not null)
                             .Any(
                                 property => property.PrimitiveType is not null
        ...
        private static bool IsForeignKey(this AssociationType association, double version)
        {
            if (version >= XmlConstants.EdmVersionForV2
                && association.Constraint is not null)
            {
