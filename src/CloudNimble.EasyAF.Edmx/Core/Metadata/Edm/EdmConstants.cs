...
namespace System.Data.Entity.Core.Metadata.Edm
{
    internal static class EdmConstants
    {
        ...
        internal const int NumPrimitiveTypes = (int)Edm.PrimitiveTypeKind.TimeOnly + 1;
        ...
        {
            private static readonly Unbounded _instance = new();
        ...
        {
            private static readonly Variable _instance = new();
