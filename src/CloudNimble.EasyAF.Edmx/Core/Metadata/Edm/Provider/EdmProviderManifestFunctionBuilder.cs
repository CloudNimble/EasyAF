...
namespace System.Data.Entity.Core.Metadata.Edm.Provider
{
    ...
    {
        private readonly List<EdmFunction> functions = [];
        ...
        {
            Debug.Assert(edmPrimitiveTypes is not null, "Primitive types should not be null");
            ...
            foreach (var edmType in edmPrimitiveTypes)
            {
                ...
                Debug.Assert(
                    primitiveTypeUsages[(int)edmType.PrimitiveTypeKind] is null, "Duplicate PrimitiveTypeKind value in EDM primitive types?");
        ...
        {
            AddFunction(returnType, functionName, []);
        }
        ...
        {
            AddFunction(returnType, functionName, [new KeyValuePair<string, PrimitiveTypeKind>(argumentName, argumentTypeKind)]);
        }
