...
namespace System.Data.Entity.Core.Metadata.Edm
{
    ...
    internal class MetadataArtifactLoaderCompositeResource : MetadataArtifactLoader
    {
        ...
        internal static string[] GetManifestResourceNamesForAssembly(Assembly assembly)
        {
            ...
            return !assembly.IsDynamic ? assembly.GetManifestResourceNames() : [];
        }
            ...
            MetadataArtifactAssemblyResolver resolver)
        {
            ...
            ParseResourcePath(path, out var assemblyName, out var resourceName);
            createCompositeResLoader = (assemblyName is not null) && (resourceName is null || assemblyName.Trim() == wildcard);
