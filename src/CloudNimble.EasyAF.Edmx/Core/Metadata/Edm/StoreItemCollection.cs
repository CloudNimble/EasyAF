...
namespace System.Data.Entity.Core.Metadata.Edm
{
    ...
    public partial class StoreItemCollection : ItemCollection
    {
        ...
        internal ReadOnlyCollection<EdmFunction> GetCTypeFunctions(string functionName, bool ignoreCase)
        {
            ...
            if (FunctionLookUpTable.TryGetValue(functionName, out var functionOverloads))
            {
        ...
        internal static EdmFunction ConvertFunctionSignatureToCType(EdmFunction sTypeFunction)
        {
            ...
            if (sTypeFunction.ReturnParameter is not null)
            {
            ...
            var returnParameters =
                returnParameter is null ? new FunctionParameter[0] : [returnParameter];
            ...
            out IList<EdmSchemaError> errors)
        {
            ...
            return errors is not null && errors.Count > 0 ? null : storeItemCollection;
        }
    }
}
