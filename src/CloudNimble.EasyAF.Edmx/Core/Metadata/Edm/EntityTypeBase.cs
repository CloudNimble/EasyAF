...
namespace System.Data.Entity.Core.Metadata.Edm
{
    ...
    public abstract class EntityTypeBase : StructuralType
    {
        ...
        private readonly object _keyPropertiesSync = new();
        ...
        public void AddKeyMember(EdmMember member)
        {
            ...
            Debug.Assert(
                BaseType is null || ((EntityTypeBase)BaseType).KeyMembers.Count == 0,
        ...
        internal void CheckAndAddKeyMembers(IEnumerable<String> keyMembers)
        {
            foreach (var keyMember in keyMembers)
            {
                ...
                if (!Members.TryGetValue(keyMember, false, out var member))
                {
