    ...
    public abstract partial class MetadataItem
    {
        ...
        static MetadataItem()
        {
            ...
            InitializeEnumType(
                ...
                [EdmConstants.None, EdmConstants.Cascade]);

            InitializeEnumType(
                BuiltInTypeKind.RelationshipMultiplicity,
                EdmConstants.RelationshipMultiplicity,
                [EdmConstants.One, EdmConstants.ZeroToOne, EdmConstants.Many]);

            InitializeEnumType(
                BuiltInTypeKind.ParameterMode,
                EdmConstants.ParameterMode,
                [EdmConstants.In, EdmConstants.Out, EdmConstants.InOut]);

            InitializeEnumType(
                BuiltInTypeKind.CollectionKind,
                EdmConstants.CollectionKind,
                [EdmConstants.NoneCollectionKind, EdmConstants.ListCollectionKind, EdmConstants.BagCollectionKind]);
            ...
            AddBuiltInTypeProperties(
                ...
                [new EdmProperty(EdmConstants.EnumMembers, stringTypeUsage)]);
            ...
            AddBuiltInTypeProperties(
                ...
                [new EdmProperty(EdmConstants.Members, TypeUsage.Create(GetBuiltInType(BuiltInTypeKind.EdmMember)))]);

            AddBuiltInTypeProperties(
                BuiltInTypeKind.EntityTypeBase,
                [new EdmProperty(EdmConstants.KeyMembers, TypeUsage.Create(GetBuiltInType(BuiltInTypeKind.EdmMember)))]);
