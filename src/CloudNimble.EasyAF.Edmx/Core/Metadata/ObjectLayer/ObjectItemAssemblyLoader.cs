...
namespace System.Data.Entity.Core.Metadata.Edm
{
    internal abstract class ObjectItemAssemblyLoader
    {
        ...
        internal static ObjectItemAssemblyLoader CreateLoader(Assembly assembly, ObjectItemLoadingSessionData sessionData)
        {
            ...
            else if (sessionData.LockedAssemblyCache.TryGetValue(assembly, out var cacheEntry))
            {
                if (sessionData.ObjectItemAssemblyLoaderFactory is null)
                {
            ...
            else if (sessionData.EdmItemCollection is not null
                     &&
            ...
            else if (sessionData.ObjectItemAssemblyLoaderFactory is null)
            {
            ...
            if (sessionData.ObjectItemAssemblyLoaderFactory is not null)
            {
        ...
        {
            Debug.Assert(
                loaderCookie is null || loaderCookie is Func<Assembly, ObjectItemLoadingSessionData, ObjectItemAssemblyLoader>,
        ...
        protected virtual void AddToKnownAssemblies()
        {
            ...
            _sessionData.KnownAssemblies.Add(_assembly, new KnownAssemblyEntry(CacheEntry, SessionData.EdmItemCollection is not null));
        }
