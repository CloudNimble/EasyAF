...
namespace System.Data.Entity.Core.Query.InternalTrees
{
    ...
    internal sealed class RelPropertyHelper
    {
            ...
            AssociationEndMember fromEnd, AssociationEndMember toEnd)
        {
            ...
            if (_interestingRelProperties is null
                ||
            ...
            if (!_relPropertyMap.TryGetValue(entityType, out var propList))
            {
                propList = [];
        ...
        {
            if (_relPropertyMap.TryGetValue(entityType, out var relProperties))
            {
