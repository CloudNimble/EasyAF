...
namespace System.Data.Entity.Core.Query.InternalTrees
{
    ...
    internal class Command
    {
        ...
        internal Node CreateVarDefNode(Node definingExpr, out Var computedVar)
        {
            ...
            Debug.Assert(scalarOp is not null);
            ...
            out Node resultNode, out Var resultVar)
        {
            ...
            BuildUnionAllLadder(inputNodes, inputVars, out resultNode, out IList<Var> varList);
            if (varList is not null
                && varList.Count > 0)
            {
                resultVar = varList[0];
            }
        ...
        {
            var projectNode = BuildProject(input, [], [computedExpression]);
        ...
        internal Node BuildComparison(OpType opType, Node arg0, Node arg1, bool useDatabaseNullSemantics = false)
        {
            if (!EqualTypes(arg0.Op.Type, arg1.Op.Type))
            {
                ...
                Debug.Assert(commonType is not null, "No common type for " + arg0.Op.Type + " and " + arg1.Op.Type);
