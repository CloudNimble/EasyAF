...
using PCompiler = System.Data.Entity.Core.Query.PlanCompiler.PlanCompiler;
...
namespace System.Data.Entity.Core.Query.InternalTrees
{
    ...
    internal class ColumnMapCopier : ColumnMapVisitorWithResults<ColumnMap, VarMap>
    {
        ...
        // </summary>
        private static readonly ColumnMapCopier _instance = new();
        ...
        internal override ColumnMap Visit(MultipleDiscriminatorPolymorphicColumnMap columnMap, VarMap replacementVarMap)
        {
            ...
            // the plan compiler.
            PCompiler.Assert(false, "unexpected MultipleDiscriminatorPolymorphicColumnMap in ColumnMapCopier");
            return null;
        }
