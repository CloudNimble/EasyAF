...
namespace System.Data.Entity.Core.Query.PlanCompiler
{
    ...
    internal static class GroupByOpRules
    {
        ...
        internal static readonly SimpleRule Rule_GroupByOpWithSimpleVarRedefinitions = new(
        ...
        internal static readonly SimpleRule Rule_GroupByOpOnAllInputColumnsWithAggregateOperation = new(
        ...
        private static bool ProcessGroupByOpOnAllInputColumnsWithAggregateOperation(RuleProcessingContext context, Node n, out Node newNode)
        {
            ...
            if (n.Child2 is null
                || n.Child2.Child0 is null
                || n.Child2.Child0.Child0 is null
            ...
            var varDefListNode = command.CreateVarDefListNode(command.CreateNode(command.CreateVarRefOp(groupByOp.Outputs.First)), out var newVar);
        ...
        internal class VarRefReplacer : BasicOpVisitorOfNode
        {
            ...
            {
                if (m_varReplacementTable.TryGetValue(op.Var, out var replacementNode))
                {
