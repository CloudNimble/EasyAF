...
namespace System.Data.Entity.Core.Query.PlanCompiler
{
    ...
    internal class AggregatePushdown
    {
            ...
            GroupAggregateVarInfo groupAggregateVarInfo)
        {
            ...
            FindPathsToLeastCommonAncestor(candidate.Key, definingGroupNode, out var functionAncestors, out var groupByAncestors);
            ...
            {
                { groupAggregateVarInfo.GroupAggregateVar, inputVar }
            };
            ...
            var varDefNode = m_command.CreateVarDefNode(newFunctionDefiningNode, out var newFunctionVar);
        ...
        private IList<Node> FindAncestors(Node node)
        {
            ...
            while (m_tryGetParent(currentNode, out var ancestor))
            {
