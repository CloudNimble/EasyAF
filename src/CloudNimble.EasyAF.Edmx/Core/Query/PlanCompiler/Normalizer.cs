...
namespace System.Data.Entity.Core.Query.PlanCompiler
{
    ...
    internal class Normalizer : SubqueryTrackingVisitor
    {
        ...
        private Node BuildUnnest(Node collectionNode)
        {
            ...
            var varDefNode = m_command.CreateVarDefNode(collectionNode, out var newVar);
        ...
        private Node VisitCollectionAggregateFunction(FunctionOp op, Node n)
        {
            ...
            var aggVarDefListNode = m_command.CreateVarDefListNode(aggExprNode, out var aggVar);
        ...
        public override Node Visit(FunctionOp op, Node n)
        {
            ...
            PlanCompiler.Assert(newNode is not null, "failure to construct a functionOp?");
            return newNode;
        }
