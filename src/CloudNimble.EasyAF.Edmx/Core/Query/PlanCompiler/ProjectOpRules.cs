...
namespace System.Data.Entity.Core.Query.PlanCompiler
{
    ...
    internal static class ProjectOpRules
    {
        ...
        internal static readonly SimpleRule Rule_ProjectOpWithSimpleVarRedefinitions = new(
        ...
        internal static readonly SimpleRule Rule_ProjectOpWithNullSentinel = new(
        ...
        private static bool ProcessProjectOpWithNullSentinel(RuleProcessingContext context, Node n, out Node newNode)
        {
            ...
            if (!canChangeNullSentinelValue
                || !TransformationRulesContext.TryGetInt32Var(relOpInputNodeInfo.NonNullableDefinitions, out var inputSentinel))
            {
