...
namespace System.Data.Entity.Core.Query.PlanCompiler
{
    ...
    internal class TypeInfo
    {
        ...
        {
            get { return RootType.EntitySetIdProperty is not null; }
        }
        ...
        {
            get { return RootType.NullSentinelProperty is not null; }
        }
        ...
        {
            get { return RootType.TypeIdProperty is not null; }
        }
        ...
        {
            var result = TryGetNewProperty(propertyRef, true, out var property);
        ...
        internal IEnumerable<PropertyRef> GetKeyPropertyRefs()
        {
            ...
            if (TypeHelpers.TryGetEdmType(m_type, out md.RefType refType))
            {
