...
namespace System.Data.Entity.Core.Query.PlanCompiler
{
    ...
    internal static class ScalarOpRules
    {
        ...
        internal static readonly SimpleRule Rule_SimplifyCase = new(OpType.Case, ProcessSimplifyCase);
        internal static readonly SimpleRule Rule_FlattenCase = new(OpType.Case, ProcessFlattenCase);
        ...
        private static bool ProcessLogOpOverConstant(
            ...
            out Node newNode)
        {
            PlanCompiler.Assert(constantPredicateNode is not null, "null constantPredicateOp?");
            ...
            switch (node.Op.OpType)
            {
                ...
                case OpType.Or:
                    ...
                    break;
                case OpType.Not:
                    PlanCompiler.Assert(otherNode is null, "Not Op with more than 1 child. Gasp!");
        ...
        internal static readonly PatternMatchRule Rule_NullCast = new(
            new Node(
                CastOp.Pattern,
                new Node(NullOp.Pattern)),
            ProcessNullCast);
