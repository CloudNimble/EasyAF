...
### <Icon icon="puzzle-piece" iconType="duotone" color="#E0EC32" size={24} style={{ paddingRight: '8px' }} /> AddConfigurationBase <DocsBadge text="Extension" variant="success" />
...
### <Icon icon="puzzle-piece" iconType="duotone" color="#E0EC32" size={24} style={{ paddingRight: '8px' }} /> AddHttpClients <DocsBadge text="Extension" variant="success" />
