...
tag: "STATIC"
keywords: ['EasyAF_Http_IServiceCollectionExtensions', 'Microsoft.Extensions.DependencyInjection.EasyAF_Http_IServiceCollectionExtensions', 'Microsoft.Extensions.DependencyInjection', 'class', 'System.Object', '# Related APIs', '- API 1', '- API 2']
---
...
Describe how to use `EasyAF_Http_IServiceCollectionExtensions` here.

<!-- TODO: REMOVE THIS COMMENT AFTER YOU CUSTOMIZE THIS CONTENT -->
# Examples

Provide examples of using `EasyAF_Http_IServiceCollectionExtensions` here.
...
Document best practices for `EasyAF_Http_IServiceCollectionExtensions` here.

<!-- TODO: REMOVE THIS COMMENT AFTER YOU CUSTOMIZE THIS CONTENT -->
# Patterns

Document common patterns for `EasyAF_Http_IServiceCollectionExtensions` here.

<!-- TODO: REMOVE THIS COMMENT AFTER YOU CUSTOMIZE THIS CONTENT -->
# Considerations

Document considerations for `EasyAF_Http_IServiceCollectionExtensions` here.
