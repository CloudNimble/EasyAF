...
### <Icon icon="tag" iconType="duotone" color="#E0EC32" size={24} style={{ paddingRight: '8px' }} />  StateTypes
...
### <Icon icon="code-fork" iconType="duotone" color="#E0EC32" size={24} style={{ paddingRight: '8px' }} />  SetCancelledAsync <DocsBadge text="Virtual" variant="warning" />
...
### <Icon icon="code-fork" iconType="duotone" color="#E0EC32" size={24} style={{ paddingRight: '8px' }} />  SetCompletedAsync <DocsBadge text="Virtual" variant="warning" />
...
### <Icon icon="function" iconType="duotone" color="#E0EC32" size={24} style={{ paddingRight: '8px' }} />  SetCreatedAsync
...
### <Icon icon="code-fork" iconType="duotone" color="#E0EC32" size={24} style={{ paddingRight: '8px' }} />  SetFailedAsync <DocsBadge text="Virtual" variant="warning" />
...
### <Icon icon="function" iconType="duotone" color="#E0EC32" size={24} style={{ paddingRight: '8px' }} />  UpdateStateAsync
