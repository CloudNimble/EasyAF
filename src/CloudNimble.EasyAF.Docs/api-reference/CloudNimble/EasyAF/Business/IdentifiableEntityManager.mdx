...
icon: code-branch
tag: "ABSTRACT"
keywords: ['IdentifiableEntityManager', 'CloudNimble.EasyAF.Business.IdentifiableEntityManager<TContext, TEntity, TId>', 'CloudNimble.EasyAF.Business', 'class', 'CloudNimble.EasyAF.Business.EntityManager<TContext, TEntity>']
---
