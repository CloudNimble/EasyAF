...
icon: code-branch
tag: "ABSTRACT"
keywords: ['EntityManager', 'CloudNimble.EasyAF.Business.EntityManager<TContext, TEntity>', 'CloudNimble.EasyAF.Business', 'class', 'CloudNimble.EasyAF.Business.ManagerBase<TContext>']
---
...
**Inheritance:** CloudNimble.EasyAF.Business.ManagerBase&lt;TContext&gt;
...
This manager provides comprehensive entity lifecycle management including:
            - Automatic audit trail creation for entities implementing [ICreatedAuditable](/api-reference/CloudNimble/EasyAF/Core/ICreatedAuditable), [IUpdatedAuditable](/api-reference/CloudNimble/EasyAF/Core/IUpdatedAuditable)
            - User tracking for entities implementing `ICreatorTrackable`1`, `IUpdaterTrackable`1`
...
### <Icon icon="function" iconType="duotone" color="#E0EC32" size={24} style={{ paddingRight: '8px' }} /> DeleteAsync
...
### <Icon icon="function" iconType="duotone" color="#E0EC32" size={24} style={{ paddingRight: '8px' }} /> DirectDelete
...
### <Icon icon="function" iconType="duotone" color="#E0EC32" size={24} style={{ paddingRight: '8px' }} /> DirectDeleteAsync
...
### <Icon icon="function" iconType="duotone" color="#E0EC32" size={24} style={{ paddingRight: '8px' }} /> DirectUpdate
...
### <Icon icon="function" iconType="duotone" color="#E0EC32" size={24} style={{ paddingRight: '8px' }} /> DirectUpdateAsync
...
### <Icon icon="function" iconType="duotone" color="#E0EC32" size={24} style={{ paddingRight: '8px' }} /> InsertAsync
...
### <Icon icon="code-fork" iconType="duotone" color="#E0EC32" size={24} style={{ paddingRight: '8px' }} /> OnDeletedAsync <DocsBadge text="Virtual" variant="warning" />
...
### <Icon icon="code-fork" iconType="duotone" color="#E0EC32" size={24} style={{ paddingRight: '8px' }} /> OnDeletingAsync <DocsBadge text="Virtual" variant="warning" />
...
### <Icon icon="code-fork" iconType="duotone" color="#E0EC32" size={24} style={{ paddingRight: '8px' }} /> OnInsertedAsync <DocsBadge text="Virtual" variant="warning" />
...
### <Icon icon="code-fork" iconType="duotone" color="#E0EC32" size={24} style={{ paddingRight: '8px' }} /> OnInsertingAsync <DocsBadge text="Virtual" variant="warning" />
...
### <Icon icon="function" iconType="duotone" color="#E0EC32" size={24} style={{ paddingRight: '8px' }} /> OnInsertingAsync
...
### <Icon icon="code-fork" iconType="duotone" color="#E0EC32" size={24} style={{ paddingRight: '8px' }} /> OnUpdatedAsync <DocsBadge text="Virtual" variant="warning" />
...
### <Icon icon="code-fork" iconType="duotone" color="#E0EC32" size={24} style={{ paddingRight: '8px' }} /> OnUpdatingAsync <DocsBadge text="Virtual" variant="warning" />
...
### <Icon icon="function" iconType="duotone" color="#E0EC32" size={24} style={{ paddingRight: '8px' }} /> ResetAuditProperties
...
### <Icon icon="function" iconType="duotone" color="#E0EC32" size={24} style={{ paddingRight: '8px' }} /> UpdateAsync
