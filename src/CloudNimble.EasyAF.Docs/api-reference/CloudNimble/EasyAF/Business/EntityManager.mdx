...
icon: code-branch
tag: "ABSTRACT"
keywords: ['EntityManager', 'CloudNimble.EasyAF.Business.EntityManager<TContext, TEntity>', 'CloudNimble.EasyAF.Business', 'class', 'CloudNimble.EasyAF.Business.ManagerBase<TContext>', '# Related APIs', '- API 1', '- API 2']
---
...
Describe how to use `EntityManager` here.
...
Provide examples of using `EntityManager` here.
...
Document best practices for `EntityManager` here.

<!-- TODO: REMOVE THIS COMMENT AFTER YOU CUSTOMIZE THIS CONTENT -->
# Patterns

Document common patterns for `EntityManager` here.

<!-- TODO: REMOVE THIS COMMENT AFTER YOU CUSTOMIZE THIS CONTENT -->
# Considerations

Document considerations for `EntityManager` here.
...
### <Icon icon="code-fork" iconType="duotone" color="#0D9373" size={24} style={{ paddingRight: '8px' }} />  OnDeletedAsync
...
### <Icon icon="code-fork" iconType="duotone" color="#0D9373" size={24} style={{ paddingRight: '8px' }} />  OnDeletingAsync
...
### <Icon icon="code-fork" iconType="duotone" color="#0D9373" size={24} style={{ paddingRight: '8px' }} />  OnInsertedAsync
...
### <Icon icon="code-fork" iconType="duotone" color="#0D9373" size={24} style={{ paddingRight: '8px' }} />  OnInsertingAsync
...
### <Icon icon="code-fork" iconType="duotone" color="#0D9373" size={24} style={{ paddingRight: '8px' }} />  OnUpdatedAsync
...
### <Icon icon="code-fork" iconType="duotone" color="#0D9373" size={24} style={{ paddingRight: '8px' }} />  OnUpdatingAsync
