...
description: "Represents the base class for OData v4.0 single entity responses containing entity-specific metadata. Provides properties for entity type information, identi..."
...
### <Icon icon="tag" iconType="duotone" color="#E0EC32" size={24} className="mr-2" /> ODataIdType
