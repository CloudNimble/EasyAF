...
description: "Represents the base class for OData v4.0 responses containing common OData metadata properties. Provides the foundation for strongly-typed OData response han..."
