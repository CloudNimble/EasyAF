---
title: ODataV401List
description: "Represents an OData v4.01 collection response containing a list of entities with optional pagination metadata. Uses simplified OData v4.01 notation for conte..."
icon: code-branch
