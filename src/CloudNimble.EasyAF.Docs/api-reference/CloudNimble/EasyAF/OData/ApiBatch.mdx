...
keywords: ['ApiBatch', 'CloudNimble.EasyAF.OData.ApiBatch', 'CloudNimble.EasyAF.OData', 'class', 'Simple.OData.Client.ODataBatch', '# Related APIs', '- API 1', '- API 2']
---
...
Describe how to use `ApiBatch` here.

<!-- TODO: REMOVE THIS COMMENT AFTER YOU CUSTOMIZE THIS CONTENT -->
# Examples

Provide examples of using `ApiBatch` here.
...
Document best practices for `ApiBatch` here.

<!-- TODO: REMOVE THIS COMMENT AFTER YOU CUSTOMIZE THIS CONTENT -->
# Patterns

Document common patterns for `ApiBatch` here.

<!-- TODO: REMOVE THIS COMMENT AFTER YOU CUSTOMIZE THIS CONTENT -->
# Considerations

Document considerations for `ApiBatch` here.
...
### <Icon icon="thumbtack" iconType="duotone" color="#0D9373" size={24} style={{ paddingRight: '8px' }} />  Add
