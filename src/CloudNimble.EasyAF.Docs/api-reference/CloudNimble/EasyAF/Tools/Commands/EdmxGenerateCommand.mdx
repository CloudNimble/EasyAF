...
### <Icon icon="tag" iconType="duotone" color="#E0EC32" size={24} className="mr-2" /> Context
...
### <Icon icon="tag" iconType="duotone" color="#E0EC32" size={24} className="mr-2" /> Environment
...
### <Icon icon="tag" iconType="duotone" color="#E0EC32" size={24} className="mr-2" /> StartupProject
