...
description: "Specifies the type of operation being performed in Restier for logging and tracking purposes. Used by RestierHelpers to provide consistent operation logging ..."
icon: list-ol
tag: "ENUM"
