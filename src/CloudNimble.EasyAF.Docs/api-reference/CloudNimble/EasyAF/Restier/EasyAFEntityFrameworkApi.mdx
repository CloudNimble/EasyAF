...
description: "Provides a base implementation of an Entity Framework API for EasyAF,  integrating SimpleMessageBus event publishing and logging capabilities.  This class ex..."
icon: code-branch
tag: "ABSTRACT"
