...
icon: code-branch
tag: "ABSTRACT"
keywords: ['EasyAFEntityFrameworkApi', 'CloudNimble.EasyAF.Restier.EasyAFEntityFrameworkApi<TContext>', 'CloudNimble.EasyAF.Restier', 'class', 'Microsoft.Restier.EntityFramework.EntityFrameworkApi<TContext>']
---
...
### <Icon icon="tag" iconType="duotone" color="#E0EC32" size={24} style={{ paddingRight: '8px' }} /> HttpContextAccessor
...
### <Icon icon="tag" iconType="duotone" color="#E0EC32" size={24} style={{ paddingRight: '8px' }} /> Logger
