...
### <Icon icon="code-fork" iconType="duotone" color="#0D9373" size={24} style={{ paddingRight: '8px' }} />  PerDay <DocsBadge text="Virtual" variant="warning" />
...
### <Icon icon="code-fork" iconType="duotone" color="#0D9373" size={24} style={{ paddingRight: '8px' }} />  PerHour <DocsBadge text="Virtual" variant="warning" />
...
### <Icon icon="code-fork" iconType="duotone" color="#0D9373" size={24} style={{ paddingRight: '8px' }} />  PerMinute <DocsBadge text="Virtual" variant="warning" />
...
### <Icon icon="code-fork" iconType="duotone" color="#0D9373" size={24} style={{ paddingRight: '8px' }} />  PerMonth <DocsBadge text="Virtual" variant="warning" />
...
### <Icon icon="code-fork" iconType="duotone" color="#0D9373" size={24} style={{ paddingRight: '8px' }} />  PerWeek <DocsBadge text="Virtual" variant="warning" />
...
### <Icon icon="code-fork" iconType="duotone" color="#0D9373" size={24} style={{ paddingRight: '8px' }} />  PerYear <DocsBadge text="Virtual" variant="warning" />
