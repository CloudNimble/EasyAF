---
title: Interval
description: "Describes an interval of time to be used in time-based calculations. Provides methods to calculate rates and frequencies based on the interval value and type."
icon: code-branch
