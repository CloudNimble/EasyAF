...
icon: code-branch
keywords: ['MoneyInterval', 'CloudNimble.EasyAF.Core.MoneyInterval<T>', 'CloudNimble.EasyAF.Core', 'class', 'CloudNimble.EasyAF.Core.Interval<T>', '# Related APIs', '- API 1', '- API 2']
---
...
Describe how to use `MoneyInterval` here.
...
Provide examples of using `MoneyInterval` here.
...
Document best practices for `MoneyInterval` here.

<!-- TODO: REMOVE THIS COMMENT AFTER YOU CUSTOMIZE THIS CONTENT -->
# Patterns

Document common patterns for `MoneyInterval` here.

<!-- TODO: REMOVE THIS COMMENT AFTER YOU CUSTOMIZE THIS CONTENT -->
# Considerations

Document considerations for `MoneyInterval` here.
