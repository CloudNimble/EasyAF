...
### <Icon icon="tag" iconType="duotone" color="#E0EC32" size={24} style={{ paddingRight: '8px' }} />  Money
...
### <Icon icon="code-merge" iconType="duotone" color="#E0EC32" size={24} style={{ paddingRight: '8px' }} />  PerDay <DocsBadge text="Override" variant="info" />
...
### <Icon icon="code-merge" iconType="duotone" color="#E0EC32" size={24} style={{ paddingRight: '8px' }} />  PerHour <DocsBadge text="Override" variant="info" />
...
### <Icon icon="code-merge" iconType="duotone" color="#E0EC32" size={24} style={{ paddingRight: '8px' }} />  PerMinute <DocsBadge text="Override" variant="info" />
...
### <Icon icon="code-merge" iconType="duotone" color="#E0EC32" size={24} style={{ paddingRight: '8px' }} />  PerMonth <DocsBadge text="Override" variant="info" />
...
### <Icon icon="code-merge" iconType="duotone" color="#E0EC32" size={24} style={{ paddingRight: '8px' }} />  PerWeek <DocsBadge text="Override" variant="info" />
...
### <Icon icon="code-merge" iconType="duotone" color="#E0EC32" size={24} style={{ paddingRight: '8px' }} />  PerYear <DocsBadge text="Override" variant="info" />
...
### <Icon icon="function" iconType="duotone" color="#E0EC32" size={24} style={{ paddingRight: '8px' }} />  ToString
