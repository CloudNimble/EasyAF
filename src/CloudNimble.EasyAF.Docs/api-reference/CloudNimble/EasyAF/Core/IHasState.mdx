...
### <Icon icon="tag" iconType="duotone" color="#0D9373" size={24} style={{ paddingRight: '8px' }} />  StateType <DocsBadge text="Abstract" variant="warning" />
...
### <Icon icon="tag" iconType="duotone" color="#0D9373" size={24} style={{ paddingRight: '8px' }} />  StateTypeId <DocsBadge text="Abstract" variant="warning" />
