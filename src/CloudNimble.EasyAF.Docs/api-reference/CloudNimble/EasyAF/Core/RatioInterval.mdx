...
icon: code-branch
keywords: ['RatioInterval', 'CloudNimble.EasyAF.Core.RatioInterval<T>', 'CloudNimble.EasyAF.Core', 'class', 'CloudNimble.EasyAF.Core.Interval<T>', '# Related APIs', '- API 1', '- API 2']
---
...
Describe how to use `RatioInterval` here.
...
Provide examples of using `RatioInterval` here.
...
Document best practices for `RatioInterval` here.

<!-- TODO: REMOVE THIS COMMENT AFTER YOU CUSTOMIZE THIS CONTENT -->
# Patterns

Document common patterns for `RatioInterval` here.

<!-- TODO: REMOVE THIS COMMENT AFTER YOU CUSTOMIZE THIS CONTENT -->
# Considerations

Document considerations for `RatioInterval` here.
