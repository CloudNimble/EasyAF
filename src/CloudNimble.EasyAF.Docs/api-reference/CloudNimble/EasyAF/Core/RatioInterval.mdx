---
title: RatioInterval
description: "Represents a ratio value that occurs at regular time intervals, enabling conversion between different time periods. This class combines a base time interval ..."
icon: code-branch
