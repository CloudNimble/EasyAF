...
description: "Provides an equality comparer for objects that implement `IIdentifiable`1`. Compares objects based on their Id property values for equality and hash code gen..."
icon: code-branch
