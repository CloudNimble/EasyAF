...
icon: bolt
tag: "STATIC"
keywords: ['NameOf', 'CloudNimble.EasyAF.Core.NameOf', 'CloudNimble.EasyAF.Core', 'class', 'System.Object', '# Related APIs', '- API 1', '- API 2']
---
...
Describe how to use `NameOf` here.
...
Provide examples of using `NameOf` here.
...
Document best practices for `NameOf` here.

<!-- TODO: REMOVE THIS COMMENT AFTER YOU CUSTOMIZE THIS CONTENT -->
# Patterns

Document common patterns for `NameOf` here.

<!-- TODO: REMOVE THIS COMMENT AFTER YOU CUSTOMIZE THIS CONTENT -->
# Considerations

Document considerations for `NameOf` here.

## Methods

### <Icon icon="thumbtack" iconType="duotone" color="#0D9373" size={24} style={{ paddingRight: '8px' }} />  Full
