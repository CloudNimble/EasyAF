...
keywords: ['EasyAFSqlAzureConfiguration', 'CloudNimble.EasyAF.Data.EasyAFSqlAzureConfiguration', 'CloudNimble.EasyAF.Data', 'class', 'System.Data.Entity.DbConfiguration', '# Related APIs', '- API 1', '- API 2']
---
...
Describe how to use `EasyAFSqlAzureConfiguration` here.

<!-- TODO: REMOVE THIS COMMENT AFTER YOU CUSTOMIZE THIS CONTENT -->
# Examples

Provide examples of using `EasyAFSqlAzureConfiguration` here.
...
Document best practices for `EasyAFSqlAzureConfiguration` here.

<!-- TODO: REMOVE THIS COMMENT AFTER YOU CUSTOMIZE THIS CONTENT -->
# Patterns

Document common patterns for `EasyAFSqlAzureConfiguration` here.

<!-- TODO: REMOVE THIS COMMENT AFTER YOU CUSTOMIZE THIS CONTENT -->
# Considerations

Document considerations for `EasyAFSqlAzureConfiguration` here.
