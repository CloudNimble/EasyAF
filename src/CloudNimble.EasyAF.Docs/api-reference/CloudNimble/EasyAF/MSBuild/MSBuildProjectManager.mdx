...
keywords: ['MSBuildProjectManager', 'CloudNimble.EasyAF.MSBuild.MSBuildProjectManager', 'CloudNimble.EasyAF.MSBuild', 'class', 'System.Object', '# Related APIs', '- API 1', '- API 2']
---
...
Describe how to use `MSBuildProjectManager` here.
...
Provide examples of using `MSBuildProjectManager` here.
...
Document best practices for `MSBuildProjectManager` here.

<!-- TODO: REMOVE THIS COMMENT AFTER YOU CUSTOMIZE THIS CONTENT -->
# Patterns

Document common patterns for `MSBuildProjectManager` here.

<!-- TODO: REMOVE THIS COMMENT AFTER YOU CUSTOMIZE THIS CONTENT -->
# Considerations

Document considerations for `MSBuildProjectManager` here.
