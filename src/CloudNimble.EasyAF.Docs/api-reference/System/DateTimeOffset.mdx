...
### <Icon icon="puzzle-piece" iconType="duotone" color="#E0EC32" size={24} style={{ paddingRight: '8px' }} />  DaysInMonth <DocsBadge text="Extension" variant="success" />
...
### <Icon icon="puzzle-piece" iconType="duotone" color="#E0EC32" size={24} style={{ paddingRight: '8px' }} />  FirstDayOfMonth <DocsBadge text="Extension" variant="success" />
...
### <Icon icon="puzzle-piece" iconType="duotone" color="#E0EC32" size={24} style={{ paddingRight: '8px' }} />  GetQuarter <DocsBadge text="Extension" variant="success" />
...
### <Icon icon="puzzle-piece" iconType="duotone" color="#E0EC32" size={24} style={{ paddingRight: '8px' }} />  LastDayOfMonth <DocsBadge text="Extension" variant="success" />
