...
tag: "STATIC"
keywords: ['EasyAF_ClaimsPrincipalExtensions', 'System.Security.Claims.EasyAF_ClaimsPrincipalExtensions', 'System.Security.Claims', 'class', 'System.Object', '# Related APIs', '- API 1', '- API 2']
---
...
Describe how to use `EasyAF_ClaimsPrincipalExtensions` here.

<!-- TODO: REMOVE THIS COMMENT AFTER YOU CUSTOMIZE THIS CONTENT -->
# Examples

Provide examples of using `EasyAF_ClaimsPrincipalExtensions` here.
...
Document best practices for `EasyAF_ClaimsPrincipalExtensions` here.

<!-- TODO: REMOVE THIS COMMENT AFTER YOU CUSTOMIZE THIS CONTENT -->
# Patterns

Document common patterns for `EasyAF_ClaimsPrincipalExtensions` here.

<!-- TODO: REMOVE THIS COMMENT AFTER YOU CUSTOMIZE THIS CONTENT -->
# Considerations

Document considerations for `EasyAF_ClaimsPrincipalExtensions` here.
