...
### <Icon icon="puzzle-piece" iconType="duotone" color="#E0EC32" size={24} style={{ paddingRight: '8px' }} /> GetAllClaims <DocsBadge text="Extension" variant="success" />
...
### <Icon icon="puzzle-piece" iconType="duotone" color="#E0EC32" size={24} style={{ paddingRight: '8px' }} /> GetClaimGuid <DocsBadge text="Extension" variant="success" />
...
### <Icon icon="puzzle-piece" iconType="duotone" color="#E0EC32" size={24} style={{ paddingRight: '8px' }} /> GetClaimValue <DocsBadge text="Extension" variant="success" />
...
### <Icon icon="puzzle-piece" iconType="duotone" color="#E0EC32" size={24} style={{ paddingRight: '8px' }} /> GetIdClaim <DocsBadge text="Extension" variant="success" />
