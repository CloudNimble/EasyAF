...
### <Icon icon="puzzle-piece" iconType="duotone" color="#0D9373" size={24} style={{ paddingRight: '8px' }} />  AcceptChanges <DocsBadge text="Extension" variant="success" />
...
### <Icon icon="puzzle-piece" iconType="duotone" color="#0D9373" size={24} style={{ paddingRight: '8px' }} />  ChangedCount <DocsBadge text="Extension" variant="success" />
...
### <Icon icon="puzzle-piece" iconType="duotone" color="#0D9373" size={24} style={{ paddingRight: '8px' }} />  ContainsId <DocsBadge text="Extension" variant="success" />
...
### <Icon icon="puzzle-piece" iconType="duotone" color="#0D9373" size={24} style={{ paddingRight: '8px' }} />  ContentsAreChanged <DocsBadge text="Extension" variant="success" />
...
### <Icon icon="puzzle-piece" iconType="duotone" color="#0D9373" size={24} style={{ paddingRight: '8px' }} />  FilterForChanges <DocsBadge text="Extension" variant="success" />
...
### <Icon icon="puzzle-piece" iconType="duotone" color="#0D9373" size={24} style={{ paddingRight: '8px' }} />  None <DocsBadge text="Extension" variant="success" />
...
### <Icon icon="puzzle-piece" iconType="duotone" color="#0D9373" size={24} style={{ paddingRight: '8px' }} />  RejectChanges <DocsBadge text="Extension" variant="success" />
...
### <Icon icon="puzzle-piece" iconType="duotone" color="#0D9373" size={24} style={{ paddingRight: '8px' }} />  ToTrackedList <DocsBadge text="Extension" variant="success" />
