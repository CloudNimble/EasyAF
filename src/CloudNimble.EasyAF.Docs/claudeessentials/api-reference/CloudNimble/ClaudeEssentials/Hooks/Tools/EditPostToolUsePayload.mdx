---
title: EditPostToolUsePayload
description: "Represents the complete payload delivered to a PostToolUse hook after the Edit tool has executed."
icon: lock
tag: "SEALED"
keywords: ['EditPostToolUsePayload', 'CloudNimble.ClaudeEssentials.Hooks.Tools.EditPostToolUsePayload', 'CloudNimble.ClaudeEssentials.Hooks.Tools', 'class', 'CloudNimble.ClaudeEssentials.Hooks.Inputs.PostToolUseHookInput<CloudNimble.ClaudeEssentials.Hooks.Tools.Inputs.EditToolInput, CloudNimble.ClaudeEssentials.Hooks.Tools.Responses.EditToolResponse>']
---
...
**Inheritance:** CloudNimble.ClaudeEssentials.Hooks.Inputs.PostToolUseHookInput&lt;CloudNimble.ClaudeEssentials.Hooks.Tools.Inputs.EditToolInput, CloudNimble.ClaudeEssentials.Hooks.Tools.Responses.EditToolResponse&gt;

## Syntax

```csharp
CloudNimble.ClaudeEssentials.Hooks.Tools.EditPostToolUsePayload
```
...
## Remarks
            ...
            type for strongly-typed deserialization of PostToolUse hook payloads when `tool_name` is "Edit".
...
```csharp
public EditPostToolUsePayload()
```

### <Icon icon="hammer" iconType="duotone" color="#419AC5" size={24} className="mr-2" /> .ctor <Badge color="gray">Inherited</Badge>

<Note>Inherited from `CloudNimble.ClaudeEssentials.Hooks.Inputs.PostToolUseHookInput<CloudNimble.ClaudeEssentials.Hooks.Tools.Inputs.EditToolInput, CloudNimble.ClaudeEssentials.Hooks.Tools.Responses.EditToolResponse>`</Note>
...
<Note>Inherited from `CloudNimble.ClaudeEssentials.Hooks.Inputs.ToolHookInputBase<CloudNimble.ClaudeEssentials.Hooks.Tools.Inputs.EditToolInput>`</Note>
...
```csharp
public CloudNimble.ClaudeEssentials.Hooks.Tools.Inputs.EditToolInput ToolInput { get; set; }
```

#### Property Value

Type: `CloudNimble.ClaudeEssentials.Hooks.Tools.Inputs.EditToolInput?`
...
```csharp
public CloudNimble.ClaudeEssentials.Hooks.Tools.Responses.EditToolResponse ToolResponse { get; set; }
```

#### Property Value

Type: `CloudNimble.ClaudeEssentials.Hooks.Tools.Responses.EditToolResponse?`
