---
title: WebSearchPostToolUsePayload
description: "Represents the complete payload delivered to a PostToolUse hook after the WebSearch tool has executed."
icon: lock
tag: "SEALED"
keywords: ['WebSearchPostToolUsePayload', 'CloudNimble.ClaudeEssentials.Hooks.Tools.WebSearchPostToolUsePayload', 'CloudNimble.ClaudeEssentials.Hooks.Tools', 'class', 'CloudNimble.ClaudeEssentials.Hooks.Inputs.PostToolUseHookInput<CloudNimble.ClaudeEssentials.Hooks.Tools.Inputs.WebSearchToolInput, CloudNimble.ClaudeEssentials.Hooks.Tools.Responses.WebSearchToolResponse>']
---
...
**Inheritance:** CloudNimble.ClaudeEssentials.Hooks.Inputs.PostToolUseHookInput&lt;CloudNimble.ClaudeEssentials.Hooks.Tools.Inputs.WebSearchToolInput, CloudNimble.ClaudeEssentials.Hooks.Tools.Responses.WebSearchToolResponse&gt;

## Syntax

```csharp
CloudNimble.ClaudeEssentials.Hooks.Tools.WebSearchPostToolUsePayload
```
...
## Remarks
            ...
            type for strongly-typed deserialization of PostToolUse hook payloads when `tool_name` is "WebSearch".
...
```csharp
public WebSearchPostToolUsePayload()
```

### <Icon icon="hammer" iconType="duotone" color="#419AC5" size={24} className="mr-2" /> .ctor <Badge color="gray">Inherited</Badge>

<Note>Inherited from `CloudNimble.ClaudeEssentials.Hooks.Inputs.PostToolUseHookInput<CloudNimble.ClaudeEssentials.Hooks.Tools.Inputs.WebSearchToolInput, CloudNimble.ClaudeEssentials.Hooks.Tools.Responses.WebSearchToolResponse>`</Note>
...
<Note>Inherited from `CloudNimble.ClaudeEssentials.Hooks.Inputs.ToolHookInputBase<CloudNimble.ClaudeEssentials.Hooks.Tools.Inputs.WebSearchToolInput>`</Note>
...
```csharp
public CloudNimble.ClaudeEssentials.Hooks.Tools.Inputs.WebSearchToolInput ToolInput { get; set; }
```
...
```csharp
public CloudNimble.ClaudeEssentials.Hooks.Tools.Responses.WebSearchToolResponse ToolResponse { get; set; }
```
