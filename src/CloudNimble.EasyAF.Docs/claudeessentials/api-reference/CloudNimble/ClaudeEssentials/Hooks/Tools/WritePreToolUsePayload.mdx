---
title: WritePreToolUsePayload
description: "Represents the complete payload delivered to a PreToolUse hook when the Write tool is about to be invoked."
icon: lock
tag: "SEALED"
keywords: ['WritePreToolUsePayload', 'CloudNimble.ClaudeEssentials.Hooks.Tools.WritePreToolUsePayload', 'CloudNimble.ClaudeEssentials.Hooks.Tools', 'class', 'CloudNimble.ClaudeEssentials.Hooks.Inputs.PreToolUseHookInput<CloudNimble.ClaudeEssentials.Hooks.Tools.Inputs.WriteToolInput>']
---
