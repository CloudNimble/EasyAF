---
title: StopHookInput
description: "Represents the input received by a Stop hook.             This hook runs when Claude Code finishes responding."
icon: file-brackets-curly
keywords: ['StopHookInput', 'CloudNimble.ClaudeEssentials.Hooks.Inputs.StopHookInput', 'CloudNimble.ClaudeEssentials.Hooks.Inputs', 'class', 'CloudNimble.ClaudeEssentials.Hooks.Inputs.HookInputBase']
---
...
```csharp
CloudNimble.ClaudeEssentials.Hooks.Inputs.StopHookInput
```
