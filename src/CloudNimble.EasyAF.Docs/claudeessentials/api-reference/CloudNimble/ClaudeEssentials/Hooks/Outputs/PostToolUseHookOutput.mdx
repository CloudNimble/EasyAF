...
Gets or sets the decision for the post-tool-use operation.
            Set to [HookDecision.Block](/claudeessentials/api-reference/CloudNimble/ClaudeEssentials/Hooks/Enums/HookDecision#block) to block further processing.
...
Gets or sets the reason for the decision.
            Required when [PostToolUseHookOutput.Decision](/claudeessentials/api-reference/CloudNimble/ClaudeEssentials/Hooks/Outputs/PostToolUseHookOutput#decision) is set to explain the rationale.
