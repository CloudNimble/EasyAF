...
Gets or sets the decision for the user prompt submission.
            Set to [HookDecision.Block](/claudeessentials/api-reference/CloudNimble/ClaudeEssentials/Hooks/HookDecision#block) to block the prompt from being processed.
