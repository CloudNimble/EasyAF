...
Initializes a new instance of the [EdmNavigationPropertyBinding](/odata-mcp/api-reference/Microsoft/OData/Mcp/Core/Models/EdmNavigationPropertyBinding) class.
