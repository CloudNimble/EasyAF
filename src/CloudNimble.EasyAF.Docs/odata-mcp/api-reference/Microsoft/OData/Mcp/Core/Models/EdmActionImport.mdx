...
import { DocsBadge } from '/snippets/odata-mcp/DocsBadge.jsx';
...
Initializes a new instance of the [EdmActionImport](/odata-mcp/api-reference/Microsoft/OData/Mcp/Core/Models/EdmActionImport) class.
...
Initializes a new instance of the [EdmActionImport](/odata-mcp/api-reference/Microsoft/OData/Mcp/Core/Models/EdmActionImport) class with the specified name and action.
