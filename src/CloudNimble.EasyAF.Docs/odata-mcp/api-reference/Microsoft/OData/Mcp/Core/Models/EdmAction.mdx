...
Initializes a new instance of the [EdmAction](/odata-mcp/api-reference/Microsoft/OData/Mcp/Core/Models/EdmAction) class.
...
Initializes a new instance of the [EdmAction](/odata-mcp/api-reference/Microsoft/OData/Mcp/Core/Models/EdmAction) class with the specified name and namespace.
