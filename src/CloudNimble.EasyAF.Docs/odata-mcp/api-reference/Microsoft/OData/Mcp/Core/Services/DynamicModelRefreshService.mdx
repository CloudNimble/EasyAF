...
Initializes a new instance of the [DynamicModelRefreshService](/odata-mcp/api-reference/Microsoft/OData/Mcp/Core/Services/DynamicModelRefreshService) class.
