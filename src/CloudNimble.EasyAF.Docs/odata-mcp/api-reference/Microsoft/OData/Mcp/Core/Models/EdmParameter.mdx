...
Initializes a new instance of the [EdmParameter](/odata-mcp/api-reference/Microsoft/OData/Mcp/Core/Models/EdmParameter) class.
...
Initializes a new instance of the [EdmParameter](/odata-mcp/api-reference/Microsoft/OData/Mcp/Core/Models/EdmParameter) class with the specified name and type.
