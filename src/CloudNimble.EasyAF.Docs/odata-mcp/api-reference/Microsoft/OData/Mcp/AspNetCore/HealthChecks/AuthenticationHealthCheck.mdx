...
Initializes a new instance of the [AuthenticationHealthCheck](/odata-mcp/api-reference/Microsoft/OData/Mcp/AspNetCore/HealthChecks/AuthenticationHealthCheck) class.
