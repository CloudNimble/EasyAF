...
Initializes a new instance of the [DynamicToolGeneratorService](/odata-mcp/api-reference/Microsoft/OData/Mcp/Tools/Services/DynamicToolGeneratorService) class.
