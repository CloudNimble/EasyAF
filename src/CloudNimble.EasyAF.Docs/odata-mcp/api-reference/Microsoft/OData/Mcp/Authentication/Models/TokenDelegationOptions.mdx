...
Initializes a new instance of the [TokenDelegationOptions](/odata-mcp/api-reference/Microsoft/OData/Mcp/Authentication/Models/TokenDelegationOptions) class.
