---
title: 'MSBuild Integration for .NET 10'
sidebarTitle: '.NET 10 Changes'
description: 'Critical changes to EasyAF.MSBuild integration for compatibility across .NET 8, 9, and 10'
icon: 'hammer'
---
