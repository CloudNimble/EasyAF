...
description: "A base class for testing that provides an MSTest [BreakdanceMSTestBase.TestContext](/breakdance/api-reference/CloudNimble/Breakdance/Extensions/MSTest2/BreakdanceMSTest..."
