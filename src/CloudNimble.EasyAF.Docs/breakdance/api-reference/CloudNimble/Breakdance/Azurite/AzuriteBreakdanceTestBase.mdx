...
description: "Base class for tests that require an Azurite instance.              Each derived class must declare its own static [AzuriteInstance](/breakdance/api-reference/CloudNimb..."
icon: shapes
tag: "ABSTRACT"
