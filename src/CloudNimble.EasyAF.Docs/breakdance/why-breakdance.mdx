...
<CardGroup cols={2}>
  <Card title="I call external APIs" icon="globe" href="/breakdance/guides/web/snapshots/responses">
    Learn how Response Snapshots capture and replay real HTTP responses.
  </Card>
  <Card title="I build ASP.NET APIs" icon="server" href="/breakdance/guides/web/aspnet-core-rest">
    Test your controllers with in-memory TestServer - no deployment needed.
  </Card>
  <Card title="I use Azure Storage" icon="cloud" href="/breakdance/guides/testing-azure-storage">
    Test against real Azurite instead of mocking storage operations.
  </Card>
  <Card title="I want the full picture" icon="book" href="/breakdance/guides/web/snapshots/index">
