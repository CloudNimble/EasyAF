...
<Steps>
  <Step title="Install" titleSize="h2" iconType="duotone">
    ...
    <Note>The CLI automatically queries NuGet.org for the latest SDK version. See more options in the [CLI Reference](/breakdance/guides/cli-reference) docs.</Note>
    ...
    <Note>You can see more of how to configure your .docsproj file in the [.docsproj Reference](/breakdance/guides/docsproj) docs.</Note>
