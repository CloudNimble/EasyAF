...
|------|------|-------------|
| `builder` | `Microsoft.AspNetCore.Routing.IRouteBuilder` | The [IRouteBuilder](/restier/api-reference/Microsoft/AspNetCore/Routing/IRouteBuilder) to add the route to. |
