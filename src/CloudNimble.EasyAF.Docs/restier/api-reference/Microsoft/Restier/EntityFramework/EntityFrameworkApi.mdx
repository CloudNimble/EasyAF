...
|------|------|-------------|
| `serviceProvider` | `System.IServiceProvider` | An [IServiceProvider](/restier/api-reference/System/IServiceProvider) containing all services of this [EntityFrameworkApi`1](https://learn.microsoft.com/dotnet/api/microsoft.restier.entityframework.entityframeworkapi-1). |
