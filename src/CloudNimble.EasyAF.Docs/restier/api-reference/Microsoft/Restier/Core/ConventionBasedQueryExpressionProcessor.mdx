...
Initializes a new instance of the [ConventionBasedQueryExpressionProcessor](/restier/api-reference/Microsoft/Restier/Core/ConventionBasedQueryExpressionProcessor) class.
