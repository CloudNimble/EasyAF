...
Initializes a new instance of the [ConventionBasedOperationAuthorizer](/restier/api-reference/Microsoft/Restier/Core/ConventionBasedOperationAuthorizer) class.
