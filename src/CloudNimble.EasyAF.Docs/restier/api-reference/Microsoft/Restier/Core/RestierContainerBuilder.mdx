...
Builds a container which implements [IServiceProvider](/restier/api-reference/System/IServiceProvider) and contains all the services registered for a specific route.
...
The [IServiceProvider](/restier/api-reference/System/IServiceProvider)dependency injection container&lt;/see&gt; for the registered services.
