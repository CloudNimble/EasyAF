...
Initializes a new instance of the [ConventionBasedChangeSetItemAuthorizer](/restier/api-reference/Microsoft/Restier/Core/ConventionBasedChangeSetItemAuthorizer) class.
