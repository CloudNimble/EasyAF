...
Initializes a new instance of the [QueryResult](/restier/api-reference/Microsoft/Restier/Core/Query/QueryResult) class with an Exception.
...
Initializes a new instance of the [QueryResult](/restier/api-reference/Microsoft/Restier/Core/Query/QueryResult) class with in-memory results.
