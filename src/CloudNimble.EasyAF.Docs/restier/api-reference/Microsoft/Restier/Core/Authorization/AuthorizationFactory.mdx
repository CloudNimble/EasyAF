...
description: "Maintains a Dictionary of [AuthorizationEntry](/restier/api-reference/Microsoft/Restier/Core/Authorization/AuthorizationEntry)AuthorizationEntries&lt;/see&gt; for ea..."
icon: bolt
tag: "STATIC"
