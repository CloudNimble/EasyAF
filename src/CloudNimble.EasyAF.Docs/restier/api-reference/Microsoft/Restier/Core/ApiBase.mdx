...
| Name | Type | Description |
|------|------|-------------|
| `api` | `Microsoft.Restier.Core.ApiBase` | The [ApiBase](/restier/api-reference/Microsoft/Restier/Core/ApiBase) instance to process. |
| `markdown` | `bool` | - |
...
Retrieves the [IEdmModel](/restier/api-reference/Microsoft/OData/Edm/IEdmModel) used by this [ApiBase](/restier/api-reference/Microsoft/Restier/Core/ApiBase) instance.
...
The [IEdmModel](/restier/api-reference/Microsoft/OData/Edm/IEdmModel) used by this [ApiBase](/restier/api-reference/Microsoft/Restier/Core/ApiBase) instance.
...
| Name | Type | Description |
|------|------|-------------|
| `api` | `Microsoft.Restier.Core.ApiBase` | The [ApiBase](/restier/api-reference/Microsoft/Restier/Core/ApiBase) instance to build the Visibility Matrix for. |
