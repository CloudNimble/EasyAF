...
description: "A fluent configuration helper that maps [ApiBase](/restier/api-reference/Microsoft/Restier/Core/ApiBase) instances to ASP.NET OData routes."
...
A fluent configuration helper that maps [ApiBase](/restier/api-reference/Microsoft/Restier/Core/ApiBase) instances to ASP.NET OData routes.
...
The [RestierRouteBuilder](/restier/api-reference/Microsoft/Restier/Core/RestierRouteBuilder) instance to allow for fluent method chaining.
