...
description: "Default implementation of [ISubmitExecutor](/restier/api-reference/Microsoft/Restier/Core/Submit/ISubmitExecutor)."
...
Default implementation of [ISubmitExecutor](/restier/api-reference/Microsoft/Restier/Core/Submit/ISubmitExecutor).
