...
Initializes a new instance of the [SubmitResult](/restier/api-reference/Microsoft/Restier/Core/Submit/SubmitResult) class with an error.
...
Initializes a new instance of the [SubmitResult](/restier/api-reference/Microsoft/Restier/Core/Submit/SubmitResult) class
