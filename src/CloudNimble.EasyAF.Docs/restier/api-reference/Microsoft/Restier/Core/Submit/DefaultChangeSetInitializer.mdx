...
description: "Provides a default implementation of the [IChangeSetInitializer](/restier/api-reference/Microsoft/Restier/Core/Submit/IChangeSetInitializer) interface."
...
Provides a default implementation of the [IChangeSetInitializer](/restier/api-reference/Microsoft/Restier/Core/Submit/IChangeSetInitializer) interface.
