...
Initializes a new instance of the [RestierResourceSetSerializer](/restier/api-reference/Microsoft/Restier/AspNet/Formatter/RestierResourceSetSerializer) class.
