...
<img
  ...
  src="/images/simplemessagebus/hero-light.png"
  alt="SimpleMessageBus Hero Light"
/>
<img
  className="hidden dark:block"
  src="/images/simplemessagebus/hero-dark.png"
...
<CardGroup cols={2}>
  <Card
    ...
    icon="cloud"
    href="/simplemessagebus/providers/overview"
  >
  ...
  <Card
    title="Simple API"
    icon="code"
    href="/simplemessagebus/quickstart"
  >
  ...
  <Card
    ...
    icon="globe"
    href="/simplemessagebus/concepts/overview"
  >
  ...
  <Card
    title="Extensible"
    icon="puzzle-piece"
    href="/simplemessagebus/guides/configuration"
  >
...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="download"
    href="/simplemessagebus/installation"
  >
