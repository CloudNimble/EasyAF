...
Creates a new instance of the [AmazonSQSProcessor](/simplemessagebus/api-reference/CloudNimble/SimpleMessageBus/Dispatch/Amazon/AmazonSQSProcessor).
...
|------|------|-------------|
| `dispatcher` | `CloudNimble.SimpleMessageBus.Dispatch.IMessageDispatcher` | The [IMessageDispatcher](/simplemessagebus/api-reference/CloudNimble/SimpleMessageBus/Dispatch/IMessageDispatcher) to use for processing messages. |
