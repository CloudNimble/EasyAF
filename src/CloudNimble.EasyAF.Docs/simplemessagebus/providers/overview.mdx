...
<CardGroup cols={2}>
  <Card
    ...
    icon="microsoft"
    href="/simplemessagebus/providers/azure-storage-queue"
  >
  ...
  <Card
    title="Amazon SQS"
    icon="aws"
    href="/simplemessagebus/providers/amazon-sqs"
  >
  ...
  <Card
    title="File System"
    icon="folder"
    href="/simplemessagebus/providers/filesystem"
  >
  ...
  <Card
    title="IndexedDB"
    icon="globe"
    href="/simplemessagebus/providers/indexeddb"
  >
